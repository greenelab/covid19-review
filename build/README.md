...
If the `BUILD_HTML` or `BUILD_PDF` environment variables are not false or the `BUILD_DOCX` environment variable is set to `true`, the build script will produce a merged manuscript

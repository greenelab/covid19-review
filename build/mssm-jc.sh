...
curl -fSL https://github.com/ismms-himc/covid-19_sinai_reviews/archive/master.zip > output/MSSM.zip

unzip output/MSSM.zip covid-19_sinai_reviews-master/markdown_files/*

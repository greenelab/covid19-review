...
Additionally, an up-to-date version of the content was available at all times online at \url{https://greenelab.github.io/covid19-review/} or as a pdf at \url{https://greenelab.github.io/covid19-review/manuscript.pdf}.
...
\centering
\includegraphics{(images/ebmdatalab-trials-original.png)https://github.com/greenelab/covid19-review/raw/17e7edfce01821237d3c1c5b514652373c0b7219/ebmdatalab/ebmdatalab-trials.png}
...
These manuscripts cover a wide range of topics including the fundamental biology of SARS-CoV-2 (pathogenesis \citep{r366f5T3} and evolution \citep{individual-evolution}), biomedical advances in responding to the virus and COVID-19 (pharmaceutical therapeutics \citep{cifK9B8t}, nutraceutical therapeutics \citep{wgAGKcBj}, vaccines \citep{individual-vaccines}, and diagnostic technologies \citep{individual-diagnostics}), and biological and social factors influencing disease transmission and outcomes \citep{individual-inequality}.
...
The current project was managed through GitHub in the repository greenelab/covid19-review using Manubot \citep{YuJbg3zO} to continuously generate a version of the manuscript online (\url{https://greenelab.github.io/covid19-review} or \url{https://greenelab.github.io/covid19-review/manuscript.pdf}).
...
In the case of the seven manuscripts produced by the COVID-19 Review Consortium, Manubot will allow for continuous updating of the manuscripts as the pandemic enters its second year and the landscape shifts with the emergence of promising therapeutics and vaccines \citep{cifK9B8t, individual-vaccines}.
...
%{Author funding. HMR: the Gordon and Betty Moore Foundation (GBMF 4552). DSH: GBMF4552. CSG: the Gordon and Betty Moore Foundation (GBMF 4552); the National Human Genome Research Institute (R01 HG010067). AG: John W. and Jeanne M. Rowe Center for Research in Virology.}

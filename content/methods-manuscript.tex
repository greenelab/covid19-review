...
This resource was developed by querying several sources for terms related to SARS-CoV-2 and COVID-19, as well as the coronaviruses SARS-CoV-1 and MERS-CoV and their associated viruses \citep{CiOwklc6} and contained 544406 manuscripts as of 2021-04-26.
...
As of 2021-04-26, there are 544406 in the CORD-19 dataset.
...
At present, it contains 23932 preprints from \emph{arXiv}, \emph{bioRxiv}, and \emph{medRxiv}.
...
%{]}(https://github.com/greenelab/covid19-review/raw/a16ce24174183742eb078db42973b4bb427aa9d6/CORD-19/cord19-growth.png ``CORD-19 dataset growth'')\{\#fig:cord19-growth secno=1\}
\begin{figure}
...
These efforts include newsletters \citetext{\citealp{d204tUzq}; \citealp{JdWiPJCL}}, web portals (such as \citep{m4B8roc9, 1CBWvhTdy} or the now-defunct http://covidpreprints.com/, which was described in \citep{paRLhIdE}), comments on preprint servers \citep{YZ4cHNuH, 12JmNCBWc}, and even a journal \citep{oBoqEGzZ}.
...
We also used gitter \citep{iXfPU3Cy} to promote informal questions and sharing of information among collaborators.
...
Clinical trials that are registered with clinicaltrials.gov \citep{vbD9t39A} receive a unique clinical trial identifier, or ``NCT ID.''
...
Manubot uses the Zotero translation server \citep{snhvVGmP, oUPcPgk9} to extract metadata for some types of citations.
...
We integrated an existing Pandoc \citep{zShYOJj} spell-check extension with AppVeyor CI to automatically post spelling errors as comments in a GitHub pull request.
...
The actual spell-checking was implemented using GNU Aspell \citep{1AmG84eh8} and the Pandoc spellcheck filter \citep{nTjoZqSQ}.
...
\centering
  ...
  \caption{\textbf{Project stats over time.}
  }
...
Appendix A contains summaries written by the students, post-docs, and faculty of the Immunology Institute at the Mount Sinai School of Medicine \citep{cYo4O2qX, YZ4cHNuH}.
Additionally, two of the consortium authors were undergraduate students recruited through the American Physician Scientist Association's Virtual Summer Research Program \citep{DGTDsJZy}.
...
Information about vaccine distribution was extracted from Our World In Data \citep{CNufCYOy}.
...
\centering
\includegraphics[width=\textwidth]{../content/images/ebmdatalab-trials-original.png}%)https://github.com/greenelab/covid19-review/raw/a801297aa7dc9c0c7b92ad6e38a8c0f23911d492/ebmdatalab/ebmdatalab-trials.png}

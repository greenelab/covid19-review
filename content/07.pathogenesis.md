...
In response to injury or to signaling by PRRs upon detection of a pathogen, the immune system stimulates leukocytes that travel to the site of the threat, where they then produce cytokines [@doi:10.18632/oncotarget.23208].
...
Cytokines can be both pro- and anti-inflammatory, which means they can either stimulate or inhibit the production of additional cytokines [@doi:10.1097/AIA.0b013e318034194e].
Dysregulation is typically discussed in terms of excessive pro-inflammatory cytokine activity unchecked by the anti-inflammatory counterparts, which can therefore cause a cascade of the inflammatory response [@doi:10.1159/000087104].
...
The shift from local to systemic inflammation is a phenomenon often referred to broadly as a cytokine storm [@doi:10.1128/MMBR.05015-11] or a more precisely as cytokine release syndrome (CRS) [@doi:10.1186/s40425-018-0343-9].
...
Among patients hospitalized with COVID-19 in Wuhan, China, 59% developed sepsis, including 100% of the non-survivors [@doi:10.1016/S0140-6736(20)30566-3].

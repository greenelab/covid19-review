...
Other general complexities to consider include the following: disease symptoms can be due to a pathogen or due to the reaction of the immune system to the pathogen; the host immune system can defend against or fight infection but it can also sometimes cause too much damage to the host [@isbn: 9780815332183; @isbn: 9780071283663].
...
For acquired immunity, there is a review on the levels of different SARS-CoV-2-specific antibodies (as well as viral RNA) detected over the course of an infection [@doi: 10.3389/fimmu.2020.00879].

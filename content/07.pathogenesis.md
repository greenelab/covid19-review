...
The current COVID-19 pandemic, caused by the SARS-CoV-2 virus, represents an acute global health crisis.
...
Outcomes of the disease can include acute respiratory distress and acute lung injury, as well as damage to other organ systems [@doi:10.23750/abm.v91i1.9397; @doi:10.1002/ctm2.16].
...
Additionally, the fundamental biology of the virus can provide insisghts into how it is transmitted among people, which are in turn critical to efforts to control its spread.
...
However, in order to draw a more complete picture of pathogenesis, it is also necessary to examine how infection manifests clinically and identify systems-level interactions between the virus and the human body.
Though coronaviruses that infect humans (HCoV) are not common and the SARS-CoV-2 virus emerged only recently, prior research into other HCoV such as _Severe acute respiratory syndrome-related coronavirus 1_ (SARS-CoV-1) and _Middle East respiratory syndrome-related coronavirus_ (MERS-CoV) as well as other viruses infecting humans such as influenza species established a strong foundation for SARS-CoV-2 research that allowed for an accelerated understanding of the virus.
Additionally, the rapid identification and release of the genomic sequence of the virus in January 2020 [@doi:10.46234/ccdcw2020.017] provided early insight into the virus in a comparative genomic context.
The identification of the virus as a coronavirus was especially imporltant because many mechanisms of pathogenicity are conserved among coronaviruses, thereby providing a basis for forming hypotheses about how the virus interacts with hosts.

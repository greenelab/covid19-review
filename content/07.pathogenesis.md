...
Coronaviruses are readily transmitted across species, with known transmission from bats or birds to intermediate hosts such as palm civets, and then to humans [@doi:10.1038/nrmicro2147].
Here, we provide descriptions of known hosts and transmission mechanisms for coronaviruses and what we know of SARS-CoV-2 in specific.


#### Zoonotic Host to Human Transmission
...
### Mechanisms of Viral Entry, Replication and Spreading within the Host

#### Viral Entry to Host Cells
...
In infections cuased by coronaviruses, disease severity increases drastically during viral clearance, suggesting that the host immune system may be contributing to both protective and pathogenic outcomes within the host.
Thus, understanding the host immune response to SARS-CoV-2 is crucial in predicting potential therapeutic and preventive measures.

## Genomic and Viral Structure of SARS-CoV-2 in the Context of Pathogenesis, Symptomatology, and Transmission
...
The ACE2 receptor is expressed in numerous organs, such as the heart, kidney, and intestine, but it is most prominently expressed in alveolar epithelial cells; this pattern of expression is expected to contribute to the virus's association with lung pathology [@doi:10.1101/2020.02.24.963348; @doi:10.1007/s00134-020-05985-9].
...
This field integrates the "omics" fields (genomics, transcriptomics, proteomics, metabolomics, etc.) with bioinformatics and other computational approaches.
...
Using such databases, the systems-level reconstruction of the protein-protein interaction (PPI) network will enable the generation of hypotheses about the mechanism of action of SARS-CoV-2 and suggest potential drug targets.
...
Accurate estimates are crucial to understanding the dynamics of infection and to predicting the effects of different interventions.
...
As with other HCoVs, the immune response to SARS-CoV-2 is likely driven by detection of its spike protein, which allows it to enter cells through the ACE2 receptor.
...
For example, analysis of PPI networks using publicly available data identified some similarities between COVID-19 and tuberculosis infection [@doi:10.1101/2020.03.22.002386].

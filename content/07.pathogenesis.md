...
Based on a combination of existing research in SARS-CoV and new research in SARS-CoV-2, the SARS-CoV-2 virus was hypothesized early on to enter target cells by binding, via the viral spike (S) protein, to a specific cellular receptor.
Subsequently the S protein is primed and cleavaged by cellular proteases [@doi:10/cf8chz; @doi:10.1016/j.antiviral.2020.104792].
...
Based on a combination of existing research in SARS-CoV and new research in SARS-CoV-2, these insights have helped to identify which tissues and organs are most prone to SARS-CoV-2 infection.
<!-- Needs more work, but goal is to address the questions:
1. How does it get in a cell?
2. How doe it get away with replicating and evading the host immune response?
3. Where/how does it spread?
-->

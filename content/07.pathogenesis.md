...
Modeling approaches are typically based upon a classic epidemiological model structure: the susceptible-infected-recovered (SIR) model and its extensions [@doi:10.1098/rspa.1927.0118; @doi:10.1038/280361a0].
...
While these may be valuable resources, it is important to note that they should be met with caution: the estimates arise from models containing many assumptions; and rely on the data quality, which varies widely by region.

...
Pathogens infect hosts and hosts have immune defenses and responses; furthermore, pathogens have developed ways to evade the immune system as well as, in general, various ways to manipulate the host.
Other general complexities to consider include the following: disease symptoms can be due to a pathogen or due to the reaction of the immune system to the pathogen; the host immune system can defend against or fight infection but it can also sometimes cause too much damage to the host [doi: 978-0815332183; doi: 9780071283663].
...
There is a review on interferon-mediated innate antiviral responses which are initiated by the virus-infected cells themselves but can also sometimes have inflammatory and systemic effects [doi: 10.1016/j.chom.2020.05.008].
...
For acquired immunity, there is a review on the levels of different SARS-CoV-2-specific Immunoglobulins (as well as viral RNA) detected over the course of an infection [doi: 10.3389/fimmu.2020.00879].
For another aspect of acquired immunity, a review of T-cell mediated responses to respiratory coronaviruses notes a large reduction in T-cells associated with the acute phase of SARS (from SARS-CoV-1) [doi: 10.1007/s12026-014-8534-z].
So far, some articles and reviews on SARS-CoV-2 also mention some evidence for reduction in the number of certain T-cells as well as NK-cells [doi: 10.1016/j.chom.2020.04.009; doi: 10.1016/j.chom.2020.05.009].
...
Vaccines are in general attenuated or inactivated pathogens or antigen parts of pathogens which are meant to generate long-term memory of a pathogen or antigens of a pathogen so that if or when a person is exposed to the actual pathogen in the future they will have a strong acquired immunity memory response similar to what occurs upon second exposure to a pathogen; we will describe specific research into vaccines in detail later.
Other immune system features and pathogen-immune system interactions which are related to particular diagnostics and therapeutics are also described for context within the Diagnostics and Therapeutics sections.

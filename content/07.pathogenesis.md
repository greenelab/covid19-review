...
Pathogenesis is typically broken down into three major components: entry, replication, and spread [@isbn:0-9631172-1-1 {chap. 45}].
Though HCoV are not common and the SARS-CoV-2 virus appears to have only recently emerged, the rapid release of the genomic sequence of the virus in January 2020 provided early insights into its phylogenetic position and genomic structure.
...
Genomes structure is highly concerned among coronaviruses, meaning that the relationship between the SARS-CoV-2 genome and its pathogenesis can be inferred from prior research in other viral species.
...
### SARS-CoV-2 Infection and the Human Immune Response

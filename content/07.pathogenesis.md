...
Variation in R~0~ is expected between different populations and the estimated values of R~0~ discussed below are for specific populations at specific times, therefore the different estimates of R~0~ should not necessarily be interpreted as a range of estimates of the same underlying parameter.

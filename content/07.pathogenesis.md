...
Though too low of an inflammatory response is a concern because it will fail to eliminate the immune threat [@doi:10.1111/imr.12671], excessive pro-inflammatory cytokine activity can cascade [@doi:10.1159/000087104] and cause cell damage, among other problems [@doi:10.18632/oncotarget.23208].
...
Damage to the capillary endothelium can cause leaks that disrupt the balance between pro-inflammatory cytokines and their regulators [@doi:10.1164/ajrccm.164.10.2104013].
Heightened inflammation in the lungs can also serve as a source for systemic inflammation, or sepsis, and potentially multi-organ failure [@doi:10.1128/MMBR.05015-11].
...
<!--To do: add summary sentence-->

Sepsis also poses a significant risk for hospitalized COVID-19 patients.
...
Regardless, inflammation has received significant interest both in regards to the pathology of COVID-19 as well as potential avenues for treatment, as the relationship between the cytokine storm and the pathophysiology of COVID-19 has led to the suggestion that a number of immunomodulatory pharmaceutical interventions could hold therapeutic value for the treatment of COVID-19 [@doi:10.1016/j.jaut.2020.102452; @individual-pharmaceuticals].
...
Efforts vary widely by country: the UK has coordinated a national database of viral genomes [@doi:10/d5mg], but efforts to collect this type of data in the United States have been more limited [@url:https://www.cdc.gov/coronavirus/2019-ncov/variants/spheres.html].

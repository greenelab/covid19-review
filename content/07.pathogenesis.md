...
Considering the paucity of omics-level big data sets for SARS-CoV-2 currently available, existing data hubs that contain information for other coronaviruses such as UniProt, NCBI Genome Database, The Immune Epitope Database and Analysis Resource (IEDB), and The Virus Pathogen Resource (ViPR) will serve as useful resources comparative bioinformatics research of SARS-CoV-2.
...
R~0~ is the average number of new (secondary) infections caused by one infected person, assuming a wholly susceptible population [@doi:10.1111/j.1467-9574.1996.tb01482.x] and is one of the most important epidemiological parameters [171].
...
Efforts vary widely by country: the UK has coordinated has coordinated a national database of viral genomes [@doi:10.1016/s2666-5247(20)30054-9]; no such coordination has been achieved in the USA.
...
For example, analysis of protein-protein interaction networks using publicly available data identified some similarities between COVID-19 and tuberculosis infection [@doi:10.1101/2020.03.22.002386].

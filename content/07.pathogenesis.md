...
Symptoms of a disease can be caused by an infection or pathogen, but they can also be caused by the immune system's reaction to the infection or pathogen.
Although the immune system aims to defend a host against infection, a dysregulated response can cause significant damage to the host [@isbn:9780815332183; @isbn:9780071283663; @doi:10.1016/j.chom.2020.05.009].
...
Inflammation is one of the most visible components of the immune repsonse, as it is responsible for hallmarks of injury such as pain, swelling, etc. [@doi:10.18632/oncotarget.23208].
...
<!--What are pro vs anti-->

There is significant evidence that the inflammatory response is critical to understanding COVID-19 outcomes.

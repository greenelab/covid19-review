...
Many current efforts to model R~t~ have led to tools that assist the visualization of estimates in real time (or over recent intervals) [@url:https://epiforecasts.io/covid/; @rt.live].

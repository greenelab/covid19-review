...
Evidence suggests that SARS-CoV-2 may utliize additional mechanisms to enter cells within the circulatory system via endothelial cells.
These cells are specialized epithelial cells [@doi:10.1055/s-0030-1253446] that facilitate exchange between the blood and the tissue of the circulatory system [@PMID:362947].
The endothelium is lined with glycocalyx, which is a soluble network of proteins and carbohydrates, primarily glycans and glycoconjugates [@doi:10.1007/s00424-007-0212-8; @doi:10.1016/j.cell.2020.09.033].
An analysis of the interactions between SARS-CoV-2 and the glycocalyx revealed that the SARS-CoV-2 spike protein can bind to 

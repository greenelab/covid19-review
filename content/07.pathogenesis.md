...
In general, the interferons (IFNs) activate intracellular antimicrobial programmes and are the major first line of defense against viruses [@doi:10.1016/j.chom.2020.05.008].
IFNs are a type of cytokines along with chemokines, interleukins (IL), lymphokines and tumor necrosis factor (TNF).
Cytokines can be clssified based on the nature of the immune response or based on their specific roles [@doi:10.1016/j.bbamcr.2014.05.014].

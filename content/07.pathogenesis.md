...
Notably, this study suggested the interaction of SARS-CoV-2 with innate immuty pathways, with a similarity to Mycobacterium Tuberculosis host-pathogen interactome.
In addition, it was suggested that the envelope protein E could disrupt the host bromodomain-containing protein BRD binding to histone.
The Spike protein S could likely intervene in the virus fusion through modualing the GOLGA7-ZDHHC5 acyl-transferase complex to increase palmitoylation.

Another study [@doi:10.1101/2020.03.31.019216], used patient-derived Peripheral Blood Mononuclear cells (PBMCs) to identify 251 host proteins directly targeted by SARS-CoV-2 and the disruption of 200 host proteins following the infection.
The network analysis showed in partiuclar that non-structural proteins 9 and 10 (nsp9 and nsp10) interacted with NKRF that usually represses NFKB. 

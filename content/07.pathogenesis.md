...
Notably, this study suggested the interaction of SARS-CoV-2 with innate immunity pathways, with a similarity to *Mycobacterium tuberculosis* host-pathogen interactome.
...
Another study [@doi:10.1101/2020.03.31.019216], used patient-derived peripheral blood mononuclear cells (PBMCs) to identify 251 host proteins directly targeted by SARS-CoV-2 and the disruption of more than 200 host proteins following the infection.

...
The quantities of basic reproduction (or reproductive) number and the timescale of infection have a large influence on the population level dynamics of epidemics.
...
Data and empirically determined biological mechanisms informs models, while models can be used to try to understand data and systems of interest or to try to make predictions on possible future dynamics, such as for capacity needs or for the comparison of predicted possible outcomes of different prevention and control strategies.

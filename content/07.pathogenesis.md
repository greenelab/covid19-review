...
While, like most viruses, it is possible that SARS-CoV-1 and SARS-CoV-2 can enter cells through endocytosis, coronaviruses are also able to target cells for entry through fusion with the plasma membrane [@doi:10.1038/cr.2008.15; @doi:10.1146/annurev-biochem-060208-104626], a process conserved among coronaviruses.
...
This finding suggests that IFN induction is dependent on the of exposure.
...
For example, the coordinated sequencing efforts in the U.K. were instrumental in detecting B.1.1.7/VOC 202012/01, a variant of concern (VOC) that is associated with approximately 50% increased transmission with an estimated R0 of 1.4 due to alterations of the spike protein as a result of genetic mutations [@url:https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/955239/NERVTAG_paper_on_variant_of_concern__VOC__B.1.1.7.pdf; @doi:10.1101/2020.12.24.20248822; @doi:10.1016/j.cell.2021.01.044].
Since spreading to at least 93 other countries [@url:https://cov-lineages.org/global_report_B.1.1.7.html], other studies investigating its transmission have occured.
In the U.S. it was estimated that B.1.1.7 had an increased transmission of 35-45% versus the common SARS-CoV-2 variants at the time between December 2020 and January 2021, and B.1.1.7 is on its way to become the dominant SARS-CoV-2 variant in the U.S. [@doi:10.1101/2021.02.06.21251159].
Notably, the latest analyses in the U.K. reports that there may be an increased risk of disease severity associated with B.1.1.7 [@url:https://www.gov.uk/government/publications/nervtag-paper-on-covid-19-variant-of-concern-b117] and potentially a 35% increased risk of death [@doi:10.1101/2021.02.01.21250959] versus common variants of SARS-CoV-2. 
However, further studies are required to confirm these associations. 
Other variants have been identified including the P.1 lineage associated with outbreaks in Brazil and B.1.351 a variant first identified in South Africa.
...
Indeed, these novel variants are being investigated for their potential resistance to vaccines and antibody treatments such as Bamlanivimab, but to date it seems that these agents are still effective, albeit with reduced efficacy in the case of the Pfizer-BioNTech vaccine [@doi:10.1101/2021.02.02.428884]. 
As a consequence of our reliance on targeting the SARS-CoV-2 Spike protein, increased surveillance is required to rapidly identify and prevent the spread of novel SARS-CoV-2 variants with alterations to the Spike protein.
...
The to which aerosol and fomite transmission contribute to the spread of SARS-CoV-2 remains a question: in general, much like SARS-CoV-1 and MERS-CoV, this virus seems to be spread primarily by droplet transmission.

...
In Europe, analysis of 11 countries inferred the dynamics of R~t~ over a time range from the beginning of the outbreak (before interventions were put into place), until March 28, 2020, by which point most countries studied had implemented major interventions (e.g. school closures and public gathering bans).
Across all countries, the mean R~t~ before interventions began was estimated as 3.87; though R~t~ varied considerably, from below 3 in Norway to above 4.5 in Spain.
After interventions, R~t~ decreased considerably across all countries, with mean R~t~=1.43.
...
The study concludes that it is too early to tell whether the interventions put into place are sufficient to decrease R~t~ below 1.

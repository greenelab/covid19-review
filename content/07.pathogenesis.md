...
In Iran, estimates of R~t~ declined from 4.86 in the first week to 2.1 by the fourth week after the first cases were reported [@doi:10.1101/2020.03.20.20038422]. In Europe, analysis of 11 countries inferred the dynamics of R~t~ over a time range from the beginning of the outbreak (before interventions were put into place), until March 28, 2020, by which point most countries studied had implemented major interventions (e.g. school closures and public gathering bans). Across all countries, the mean R~t~ before interventions began was estimated as 3.87; though with considerable variation: in Norway, below 3; in Spain, above 4.5. After interventions, R~t~ decreased considerably across all countries, with mean R~t~=1.43. The lowest predicted value was 0.97 for Norway and the highest was 2.64 for Sweden (note that this is in part because sweden did not implement social distancing measures on the same scale as other countries). The study concludes that it is too early to tell whether the interventions put into place are sufficient to decrease R~t~ below 1.

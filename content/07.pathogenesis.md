...
Contextualizing SARS-CoV-2 alongside other viruses serves not only to provide insights that can be immediately useful for combatting this virus itself, but may also prove valuable in the face of future viral threats.

Host-pathogen intereractions provide a basis not only for understanding COVID-19, but also for developing a response.

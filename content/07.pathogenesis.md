...
However, patients with severe ARDS were excluded from this study, and their results suggest that an increase in pro-inflammatory cytokines such as interleukin-6 (IL-6) may signal the onset of ARDS, but recovery depends on an increased anti-inflammatory response [@doi:10.1164/ajrccm.164.10.2104013].
Acute phase response to the infection can also cause damage to the capillary endothelium, allowing leaks that disrupt the balance between cytokines and their regulators [@doi:10.1164/ajrccm.164.10.2104013].
...
The shift from local to systemic inflammation is a phenomenon known as a cytokine storm [@doi:10.1128/MMBR.05015-11] or a more specific set of characteristics known as cytokine release syndrome (CRS) [@doi:10.1186/s40425-018-0343-9].
...
Prior work therefore makes it clear that pulmonary infection and injury are associated with systemic inflammation through sepsis.
...
The inflammatory response is thought to be an important driver of COVID-19 outcomes due to research in SARS and emerging research in COVID-19.
...
Among patients hospitalized with COVID-19 in Wuhan, China, 59% developed sepsis, including 100% of patients who deceased as a result of COVID-19 [@doi:10.1016/S0140-6736(20)30566-3].
...
Regardless, inflammation has received significant interest both in regards to the pathology of COVID-19 as well as its potential treatment.
The similarities between the cytokine storm and the pathophysiology of COVID-19 has led to the suggestion that a number of immunomodulatory pharmaceutical interventions could hold therapeutic value for the treatment of COVID-19 [@doi:10.1016/j.jaut.2020.102452].

...
The two immunoglobulin classes most pertinent to these areas of interest are immunoglobulin M (IgM), which are the first antibodies produced in response to an infection, and immunoglobulin G (IgG), which are the most common antibodies found in the blood.
...
The longevity of antibodies to SARS-CoV-2 remains an ongoing question.

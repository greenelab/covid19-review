...
ntry and replication are described above; in brief, during entry into a host cell, a virion must first bind to a receptor on the host cell surface, and in enveloped viruses such as coronaviruses, the viral membrane then fuses to the cellular membrame.
...
hrough innate immunity, also known as humoral or antibody-mediated immunity, the body can eliminate pathogens in circulation that have not yet entered cells.

...
New information is emerging daily about the impact of the disease around the world.

COVID-19 is caused by the newly identified severe acute respiratory syndrome coronavirus 2 (SARS-CoV-2), which was initially called 2019 novel Coronavirus (19-nCov).
SARS-CoV-2 belongs to coronavirus, a family of RNA viruses known to cause respiratory and intestinal infections in humans and other species.
...
Members of this family include the species Middle East respiratory syndrome-related coronavirus (MERS-CoV) and Severe acute respiratory syndrome coronavirus (SARS-CoV) [@url:https://en.wikipedia.org/wiki/Coronaviridae#Taxonomy].
...
Phylogenetic analysis of a PCR amplicon fragment from five patients along with the total virus genome of 29.8 kilobases indicates that SARS-CoV-2 is a novel betacoronavirus belonging to the B lineage, also known as sarbecovirus.
The sarbecovirus lineage also includes the human SARS coronavirus [@doi:10/ggjs7j]. 

#### 2.2.b Virion, morphology, structure
...
#### 2.2.c Genome structure and replication
...
### 2.3 SARS-CoV-2: Origin, Phylogenetics, and Evolution

#### 2.3.a Origin of SARS-CoV-2
The origin of the SARS-CoV-2 virus is not yet fully understood.
...
### 2.4 COVID-19: Mechanisms and Presentation

#### 2.4.a Mechanisms of Coronavirus-driven Disease in Humans
...
#### 2.4.b Presentation of COVID-19
...
### 2.5 Approaches to Understanding COVID-19
...
Accurate diagnoses on a large scale is necessary for collected the data needed to develop epidemiological models.
...
We include information from both traditional peer-reviewed scientific literature and from preprints, which typically have not undergone peer review.

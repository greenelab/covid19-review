...
{## Only include WHO death statistics and figure if the information was provided via a template variables file ##}
{% if who_deaths is defined -%}
As of {{who_update_date_pretty}}, {{who_deaths}} deaths had been reported due to COVID-19 worldwide (Figure @fig:who-deaths).

![
**A test image to be replaced with a graph of cumulative COVID-19 deaths per WHO.**
Description here.
]({{who_deaths_figure}} "WHO deaths"){#fig:who-deaths}
{% endif -%}

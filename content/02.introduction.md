...
As the viral receptor ACE2 has low expression in A549 cells, authors supplemented A549 cells with a vector expressing mCherry or ACE2 (A549-ACE2). 
...
However, the low IFN induction in ACE2-expressing A549 cells could be overcome by using a 10-fold increase in virus (MOI, 2), suggesting a SARS-CoV-2 antagonist that is rendered ineffective under high-MOI conditions. 
This speculation was further supported by a recent study [@doi.org/10.1101/2020.05.11.088179], showing that the SARS-CoV-2 ORF3b gene, whose length is considerably smaller as compared to the SARS-CoV-1 ORF3b gene, suppress IFNB1 promoter activity (IFN-I induction) more efficiently than SARS-CoV-1.

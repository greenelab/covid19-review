...
The innate immune response allows cells to collect information about the pathogen to prime the adaptive immune response, which can target specific protein sequences associated with individual pathogens (e.g., a specific viral species or even strain). 

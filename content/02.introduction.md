...
There are two domains: the N-terminal (S1 )domain used for binding and the C-terminal (S2) domain for fusion [@doi:10.3390/v4061011].
...
Through innate immunity, the body can rapidly recognize and attack pathogens and infected cells. Cells from innate immunity also pass critical information to prime the adaptive immune response.
Adaptive immunity can be broadly classified into humoral and cell-mediated responses. 
These are unique from innate immune responses because they target specific protein sequences from pathogens. 

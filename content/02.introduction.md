...
{{csse_deaths}} deaths had been reported due to COVID-19 worldwide as of {{csse_update_date_pretty}} (Figure @fig:csse-deaths).

![
**A test image to be replaced with a graph of cumulative COVID-19 deaths per JHU CSSE.**
Data from [@https://github.com/CSSEGISandData/COVID-19/tree/master/csse_covid_19_data/csse_covid_19_time_series].
Update caption and citation per [terms of use](https://github.com/CSSEGISandData/COVID-19).

...
Differential expression analysis between infected and mock (control) cell conditions revealed that the transcriptional response of the cells with efficient SARS-CoV-2 replication is significantly different from the host response of all other viruses tested. 

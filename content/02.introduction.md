...
A great diversity of symptom profiles has been observed for COVID-19, although fever and cough are very common and were initially reported to be the two most common symptoms on admission [@doi:10.1056/NEJMoa2002032].
Recent data from the New York City region have showed variable rates of fever as a presenting symptom [@doi:10.1001/jama.2020.6775][@doi:10.1056/NEJMc2010419].
Of note, low oxygen saturation (<90% on room air) was noted in a significant percentage of patients on presentation [@doi:10.1001/jama.2020.6775], while others have noted cough, fever, and dyspnea as the most common presenting symptoms [@doi:10.1056/NEJMc2010419].

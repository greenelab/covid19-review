...
As international attention remains focused on the ongoing public health crisis, the scientific community has reponded in kind by turning much of its attention to the virus and disease.
...
While having information available is valuable to efforts to understand and combat COVID-19, many contributions come from reearchers across a wide range of fields who have varying degrees of experience working on coronaviruses and other highly relevant topics.
...
We used another open publishing framework,  Manubot [@doi:10.1371/journal.pcbi.1007128], to manage hundreds of contributions from the community to create a living, scholarly document.

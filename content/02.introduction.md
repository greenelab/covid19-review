...
This polypeptide is translated into 16 non-structural proteins (nsp1-16, except in Gammacoronaviruses, where nsp1 is absent), which form replication machinery to synthesize viral RNA [@doi:10.1002/jmv.25681].
...
Replication of the coronavirus initiates with the binding of the virus to a host cell via the S protein.
...
The viral spike protein, _S_, plays a critical role in viral replication and is the viral structure that is typically considered to induce the host immune response [@doi:10.1146/annurev-virology-110615-042301]. 
The coronavirus spike protein belongs to the same class of viral membrane fusion proteins as the spike proteins of influenza, HIV, and ebola [@doi:10.1146/annurev-virology-110615-042301].
It is made up of two functional domains, known as the S1 and S2 subunits.
Many coronaviruses are cleaved at the S1-S2 boundary and remain covalently bound until fusion to the host cell is achieved, with the S1 subunit, which is responsible for binding to the host cell, stabilizing the S2 subunit, which guides the fusion process [@doi:10.1016/j.cell.2020.02.058].
...
The S1 domain evolves more rapidly than the S2 domain, and different coronaviruses bind to different host receptors [@doi:10.3390/v4061011; @doi:10.1016/j.jmb.2020.04.009].
Within the S1 domain, the receptors in the N-terminal domain (NTD) are less conserved than those in the C-terminal domain (CTD) [@doi:10.1016/j.jmb.2020.04.009]. 
...
Viral receptors show higher affinity with protein receptors than sugar receptors [@doi:10.1146/annurev-virology-110615-042301], which suggests that purifying selection might be relaxed in the NTD relative to the CTD.
This difference would account for the variable rates of conservation observed within the S1 domain and has led to the idea that coronaviruses such as SARS-CoV, SARS-CoV-2, and MERS-CoV may be engaged in an evolutionary arms race with the human immune systems [@doi:110.1101/2020.05.13.093658; @doi:10.1101/2020.05.14.09613; @doi:10.1186/1743-422X-10-304].
Coronaviruses are able to bind to a wide range of receptors, with binding conserved only at the genus level [@doi:10.1146/annurev-virology-110615-042301].
Betacoronaviruses are known to bind to CEACAM1, Neu 5,9 Ac2, and ACE2 [@doi:10.3390/v4061011].

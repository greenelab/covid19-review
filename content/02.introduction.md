...
Innate immunity includes barriers (such as skin and other epithelial surfaces, and mucus), innate defenses by most cells (such as through membrane-bound pattern-recognition receptors, and the interferon response), the soluble proteins of the complement system which have roles in innate defense, and immune cells which have roles in innate defense (such as macrophages and natural killer cells).
Through innate immunity, the body can rapidly recognize and attack pathogens and infected cells. 
Through the innate immune response, cells can also pass along critical information to prime the adaptive immune response.
In this phase, the immune response recognizes and reacts to a set of signatures broadly associated with the presence of foreign particles that are likely to be pathogenic, e.g., double-stranded RNA (dsRNA) is never produced endogenously and thus its presence indicates viral replication is likely occurring. 
The adaptive immune response targets specific protein sequences associated with specific pathogens. 
This branch of the immune response can be broadly classified into the humoral and cell-mediated responses. 

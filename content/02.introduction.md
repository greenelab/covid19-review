...
As of {{who-update-date-pretty}}, over {{deaths}} deaths had been reported due to COVID-19 worldwide (Figure @fig:who-deaths).

![
**A test image to be replaced with a graph of cumulative COVID-19 deaths per WHO.**
Description here.
]({{who-deaths-figure}} "WHO deaths"){#fig:who-deaths}

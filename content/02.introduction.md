...
Other aspects of transmission to investigate is the relationship of infectiousness or virus shedding to disease period or symptoms and also which types of transmission events are commonly responsible for cases (such as transmission between relatives, nosocomial transmissions, and other possible types of interactions).
Some information about these aspects is available for the highly pathogenic coronaviruses SARS (or SARS-CoV-1) and MERS [doi:10.1016/B978-0-12-385885-6.00009-2; doi:10.1038/nrmicro.2016.81].

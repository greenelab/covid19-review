...
Below we summarize the existing transcriptome studies published after a peer-reviewed process as of May 2020 [Note to self (Vikas): change the date after some pre-prints are published]. 
Although we tried to cover all appropriate studies, we realize we may have missed some.

Two studies profiled expression response after SARS-CoV-2 infection in multiple human cell lines (Figure X1) [@pmid:32416070; @doi:10.1101/2020.05.05.079194]. 
First study by Blanco-Melo et al performed in-depth analysis of the transcriptional response to SARS-CoV-2 compared with other respiratory viruses, including MERS-CoV, SARS-CoV-1, human parainfluenza virus 3 (HPIV3), respiratory syncytial virus (RSV), and influenza A virus (IAV). 
In addition to human cell lines A549 (adenocarcinomic human alveolar basal epithelial cells), Calu-3 (human airway epithelial cells derived from human bronchial submucosal glands) and MRC-5 (human fetal lung fibroblast cells), authors measured the host transcriptional response to SARS-CoV-2 in primary normal human bronchial epithelial cells (HBEC or NHBE cells), in nasal washes of ferrets as an animal model and in lung samples of two COVID-19 patients. 
Differential expression analysis between infected and mock cell conditions revealed that the transcriptional response of the cells with efficient SARS-CoV-2 replication is significantly different from the host response of all other viruses tested. 
A unique proinflammatory cytokine signature is present in both high and low multiplicity of infections (MOI). 
However, in contrast to high-MOI, low-MOI SARS-CoV-2-infected cells showed no significant IFN-I or IFN-III expression suggesting that IFN induction is MOI dependent. 
Similarly, in NHBE cells, ferrets as well as COVID-19 patients, they found significant enrichment of chemokine signaling but no significant induction of IFN-I or IFN-III. 

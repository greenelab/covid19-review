...
No other coronaviruses infecting humans were identified until almost forty years later, when a new repiratory infection, which came to be known as Severe Acute Respiratory Syndrome (SARS), emerged [@doi:10.1038/nrmicro.2016.81].
The first case was reported in November 2002 in the Guangdong Province of China, and over teh following month, the disease spread more widely wthin China and then into several countries across multiple continents [@doi:10.1093/ajcp/aqaa029; @doi:10.1038/nrmicro.2016.81]].
SARS was both severe, with an estimated death rate of 9.5%, and highly contagious via droplet transmission, with a basic reproduction number of four (i.e., each person infected was estimated to infect four other people) [@doi:10.1093/ajcp/aqaa029].
...
The fatality rate associated with MERS is much higher than that of SARS, at almost 35%, but the disease is much less easily transmitted, with a basic reproduction number of one [@doi:10.1093/ajcp/aqaa029].
...
The COVID-19 pandemic is thus associated with the seventh hCoV to be identified and the fifth since the turn of the millenium, though additional hCoVs in circulation may remain undetected.
...
Therefore, only limited strategy for the pharmaeutical management of COVID-19 can be adopted from previous severe hCoV infections. 
Basic scienctific analysis, on the other hand, has revealed significant conservation among coronaviruses in their genome structure and viral functions.
Broader insights are available about information about the biology of the virus and the response of the human immune system.
This prior research can be used to form hypotheses and drive the development of diagnostic, prophylactic, and therapeutic approaches to treating and managing the SARS-CoV-2 virus.

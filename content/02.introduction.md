...
Overall, while it is evident that SARS-CoV-2 exhibits moderate potential for further evolution, much uncertainty remains about SARS-CoV-2's evolutionary trends and their consequences due to a limited number of studies addressing SARS-CoV-2 ongoing evolution.
...
The individual mutations observed in several patients may indicate that the patients belong to the same transmission group.
...
Several studies used phylogeny analysis to determine the source of local COVID-19 outbreaks in Connecticut (USA), [@doi:10.1016/j.cell.2020.04.021], the New York City area (USA) [@doi:10.1126/science.abc1917], and Iceland [@doi:10.1056/NEJMoa2006100].
There is ongoing effort about collecting SARS-CoV-2 genomes throughout the COVID-19 outbreak, and as for August 7, 2020, there are more than 78,000 genome sequences collected from the patients.

...
<!-- What has been found about humoral response?-->
Once the virus infiltrates a host cell, activation of T-cells through the cell-mediated immune response is necessary.
In the human immune response, B-cells and helper T-cells recognize antigens presented by phagocytes on major histocompatability complex (MHC) II molecules.
...
Research on SARS-CoV-1 has found that presentation by MHC I molecules plays a larger role in the response to the virus than MHC II molecules [@doi:10.1016/j.jpha.2020.03.001].

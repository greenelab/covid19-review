...
However, the use of angiotensin-converting enzyme inhibitors (ACEIs)/angiotensin receptor blockers (ARBs) for hypertension does not appear to be is dangerous in the context of COVID-19, despite the importance of the ACE2 receptor in COVID-19 infection, so patients using these medications have been advised to continue using them [@doi:10.1093/cvr/cvaa097][@doi:10.1001/jama.2020.11301][@doi:10.1001/jama.2020.4812][@doi:10.1161/HYPERTENSIONAHA.120.15082].

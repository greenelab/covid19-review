...
In particular, early research highlighted the similarity between SARS-CoV-2 and bat-derived SARS-like coronaviruses, namely bat-SL-CoVZC45 and bat-SL-CoVZXC21 [@doi:10/ggjr43].
...
This evidence therefore suggested that the virus may have emerged as a result of zoonotic transfer of a virus from bats to humans.
...
As a result, the risk of zoonotic disease is greater when there are substantial interactions between humans and wildlife [@doi:10.1016/j.pt.2016.04.007].
Many factors can influence this human/wildlife interface and therefore the risk of zoonotic transmission events [@doi:10.1016/j.pt.2016.04.007].
In the case of SARS-CoV-2, much interest has been placed on a "wet market" in Wuhan
...
A likely explanation has focused on an intermediate host between bats and humans.
SARS-CoV-2 is closely related to a pangolin coronavirus [@doi:10.1101/2020.02.19.950253], and the spike (_S_) region of SARS-CoV-2 in particular is highly similar to that of viruses found in pangolins [@doi:10.1101/2020.02.19.950253].
As a result, pangolins have been identified as potential intermediate host of SARS-CoV-2 between bats and humans.

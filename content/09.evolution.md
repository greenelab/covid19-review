...
There are several other domains in which significant human/animal interacations.
...
Interestingly, the two rodent species analyzed, which were the most phylogenetically similar to humans, showed the most sequence divergence in _ACE2_ [@doi:10.1016/j.jinf.2020.02.013.
...
The earliest observed animal-to-human transmission events were observed in housepets [@doi:10.3390/v13020185; @doi:10.1038/s41586-020-2334-5].
Comparing estimates in studies where cats (_Felis catus_) living with SARS-CoV-2-positive humans were tested for SARS-CoV-2 suggest that 6 to 15% of housecats may become infected [@doi:10.3390/v13020185].
...
Some of these SARS-CoV-2-positive domestic carnivores have also shown clinical symptoms [@doi:10.1016/j.virusres.2022.198673].

Cases have also been reported among livestock.
Livestock: 10.1111/xen.12621
However, experimental infection studies did not find pigs, chickens, or ducks to be susceptible to SARS-CoV-2 [@doi:10.1111/xen.12621].
...
Other studies using _in vivo_ challenge have similarly reported that livestock species in general do not develop clinical manifestations of SARS-CoV-2 and do not shed infectious virus [@doi:10.1080/22221751.2021.2003724].

One of species of domesticated animal was severely affected, however: the mink.
While fur farming has declined significantly after World War II, mink farming is still common in Russia, China, and the United States.

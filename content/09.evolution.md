...
For example, the first genome sequence of the pathogen was released on January 3, 2020, providing valuble information about the pathogen within a month and a half of the first known cases.
...
In the case of SARS-CoV-2, early interest for the emergence of the pathogen turned to live-animal markets in Wuhan [@doi:10.1038/d41586-020-00548-w; @url:https://www.thestandard.com.hk/sections-news-print/215457/Ill-husband-and-wife--add-to-Wuhan-riddle].
...
Additionally, SARS-CoV-2 is closely related (91.02%) to a novel coronaviruses identified in Malayan pangolins infected with a respiratory disease in October 2019 [@doi:10.1016/j.cub.2020.03.022].
...
Therefore, it is not clear whether the disease emerged in a different location and/or whether it is associated with a different species.
...
Such suspcions may also have been fueled, in part, by the lack of well-characterized bat coronaviruses which means that SARS-CoV-2 is still relatively derived from documented coronaviruses surveyed in bats [@doi:10.1016/j.tree.2020.12.002].
...
There are several other domains in which significant human/animal interacations occur.
Given the evidence for a zoonotic origin of SARS-CoV-2, another evolutionary question that received significant attention, especially early on, was whether humans could infect other species with SARS-CoV-2.
In the modern age, many human/animal interactions arise from interactions with companion animals, zoo animals, house pests, and livestock.
Historically, outbreaks of zoonotic diseases have been known to originate in environments such as zoos, farms, and petting zoos [@doi:10.2460/javma.2004.224.1105].
Many coronaviruses infect animals, and they have been the subject of veterinary medical investigations and vaccine development efforts due to their effect on the health of companion and agricultural animals [@doi:10/ckfn8b].
Concerns focused on two issues: first, if these species were susceptible to COVID-19-like infection, it could have significant effects on food supply chains (livestock) and veterinary care needs (companion animals, house pests, and zoo animals), and second, if pathology in these species was limited but they coudl serve as viral reservoirs, they would pose additional risk to humans.
...
The phylogeny of the initial species infected suggested that the host range of SARS-CoV-2 could encompass many species with a high level of interaction with humans.
Bats belong to the order Chiroptera and pangolins to Pholidota.
Therefore, two of the three species fall within the clade _Pegasoferae_ [@doi:10.1016/j.cub.2013.09.014; @doi:10.1073/pnas.0603797103; @doi:10.1101/gr.5918807], which also includes many species that have close relationships with humans, namely odd-toed ungulates (Euungulata) and carnivores (Carnivora) [@doi:10.1016/j.cub.2013.09.014; @doi:10.1073/pnas.0603797103; @doi:10.1101/gr.5918807; @url:http://www.timetree.org/public/data/pdf/Murphy2009Chap71.pdf].
Humans shared a least common ancestor with _Pegasoferae_ almost 100 million years ago [@doi:10.1073/pnas.1702012114].
...
This group could include both livestock, many of which are odd-toed ungulates, and companion animals, many of which are carnivores, and infection of these animals was identified as a major concern [@doi:10.1089/vbz.2020.2650].

Genomic analyses have focused specifically on the comparative genetics of angiotensin-converting enzyme 2 (ACE2).
...
Interestingly, the two rodent species analyzed, which were the most phylogenetically similar to humans aside from the other primates, showed the most sequence divergence in _ACE2_ [@doi:10.1016/j.jinf.2020.02.013].
This finding was supported by experimental evidence that SARS-CoV-2 cannot use mouse ACE2 for cell entry [@doi:10.1038/s41586-020-2012-7].
...
The earliest observed animal-to-human transmission events were observed in house pets, especially cats [@doi:10.3390/v13020185; @doi:10.1038/s41586-020-2334-5; @doi:10.3201/eid2707.204959].
Similarly, cases of SARS-CoV-2 infection have been reported in dogs (_Canis familiaris_).
Two of fifteen dogs monitored for SARS-CoV-2 by the Hong Kong Agriculture, Fisheries and Conservation Department during the owners' quarantine in March 2020 were found to be positive for SARS-CoV-2 [@doi:10.1038/s41586-020-2334-5]. 
...
Cases among livestock were a particular concern because of the potential effect on food supply.
...
_In vitro_ exposure to SARS-CoV-2 suggested that sheep, but not cattle, might be susceptible to infection, but _in vivo_ viral challenge suggested that sheep did not show notable susceptibility to infection [@doi:10.1080/22221751.2022.2037397].
...
Following viral challenge of several species, including cattle, sheep, and horses, none were found to shed culturable levels of virus [@doi:10.1080/22221751.2021.2003724].
...
Fur farms may be at risk from SARS-CoV-2 on multiple fronts, as the raccoon dog, a candidate intermediate host that is also farmed for its fur, was found to be susceptible to SARS-CoV-2 but to develop only mild clinical signs of infection [@doi:10.3201/eid2612.203733].
...
Viral shedding by minks was found to be viable in culture.
Concerns were amplified when novel variants of SARS-CoV-2 were identified as having emerged on Danish mink farms and spread into the human population [@doi:10.2807/1560-7917.ES.2021.26.5.210009; @doi:10.3201/eid2702.203794; @doi:10.1016/j.celrep.2021.109017; @doi:10.3201/eid2702.203794].
...
Introgression from fur farms into wild populations also resulted in the spread of SARS-CoV-2 into wild mink populations [@doi:10.1002/fee.2344; @doi:10.3390/ani11051422].
...
Zoo animals were also monitored to determine whether they were at risk.
...
Golden Syrian hamsters and Egyptian fruit bats have also been found to be highly susceptible to SARS-CoV-2 [@doi:10.1111/xen.12651].
[Ape infections?]
Additionally, given the susceptibility of housecats, the fact that felid species in contact with humans [Tiger King?] 

One argument holds that populations of non-human animals may need to be vaccinated to gain control over the spread of SARS-CoV-2 [@doi:10.1016/j.vaccine.2021.10.053].
Fortunately, there are established coronaviruses vaccines for animal diseases, and advances have been made in SARS-CoV-2 vaccination for non-human species.
Preclinical studies in non-human primates suggest that human mRNA vaccines may also provide protection to non-human primates [@doi:10.1056/NEJMoa2024671].
...
Great effort was taken to protect the world's 1063 wild Mountain Gorillas from exposure to SARS-CoV-2-positive humans [@doi:10.1002/ajp.23291].
Closing -- which taxa are most often affected? how severe are veterinary infections? are there animal vaccines?
Interestingly, studies quantifying ACE2 binding activity across species [@doi:10.1073/pnas.2025373118; @doi:10.1371/journal.pbio.3001016] found that this did not always map onto the species known to be susceptible to SARS-CoV-2 infection, suggesting other binding sites might also be important.

...
However, one of species of domesticated agricultural animal is severely affected by SARS-CoV-2: the mink.
While fur farming has declined significantly since the twentieth century, mink farming is still common in Russia, China, and the United States.
The raccoon dog, a candidate intermediate host that is also farmed for its fur, was found to be susceptible to SARS-CoV-2 but to develop only mild clinical signs of infection [@doi:10.3201/eid2612.203733].

Zoo animals were also monitored to determine whether they were at risk.
Several species closely related to humans (i.e., the Great Apes) are threatened with extinction, and therefore the potential for a virus to target these close relatives presented a major concern.
For the

...
Several factors could promote the evolution of SARS-CoV-2 including immunodeficiency and the transient exposure to antibodies directed against SARS-CoV-2 proteins. 
A single case study of SARS-CoV-2 infection in an immunocompromised female with chronic lymphocytic leukemia (CLL) and hypogammaglobulinemia [@doi:10.1016/j.cell.2020.10.049] suggested that an accelerated evolution of the virus could occur in conditions of immunodeficiency. 
...
A second administration of convalescent plasma was able to clear the virus from the host 105 days after the initial diagnosis. However, during the whole infection time, the patient was asymptomatic but contagious.

A second single case study in a 45-year old male with antiphospholipid syndrome [@doi:10.1056/NEJMc2031364], confirmed the earlier results of a persistent COVID-19 symptom in immunocompromised patients after 154 days of diagnosis leading to the death of patient. 
The treatment included Remdesivir and the Regeneron anti-spike protein antibody cocktail. 
Genomic analyses of the patient nasopharyngeal swabs confirmed an accelerated evolution of the virus through mutations in spike gene and the receptor-binding domain. 

In summary, these two cases studies suggested an accelerated evolution and persistent shedding of the virus in conditions of immunodeficiency. 
...
Similarly, N501Y mutation induces an increased affinity towards human ACE2 and has been involved in the dominance of B1.1.7 by outcompeting other variants [@doi:10.1101/2020.12.24.20248822].

Therefore, genomic surveillance is essential to prevent the emergence of super-spreaders [@doi:10.1126/science.abf2946].
In addition, novel machine learning methods were developed to predict the mutations in the sequence that promote viral escape.
While they preserve the pathogenicity of the virus, escape mutations change the virus sequence to evade detection by the immune system. 

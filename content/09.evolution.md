...
In particular, genomic research quickly highlighted the similarity between SARS-CoV-2 and bat-derived SARS-like coronaviruses, namely bat-SL-CoVZC45 and bat-SL-CoVZXC21 [@doi:10/ggjr43].
...
Additionally, SARS-CoV-2 is closely related to a pangolin coronavirus [@doi:10.1101/2020.02.19.950253], with high similarity in the receptor binding domain (RBD) of the spike (_S_) gene in particular between SARS-CoV-2 and pangolin coronaviruses [@doi:10.1101/2020.02.19.950253; @doi:10.1038/s41586-020-2169-0].
Pangolins were therefore identified as a potential intermediate host of SARS-CoV-2 between bats and humans.
The similarity of _S_ to that of pangolin viruses could arise from either recombination or coevolution [@doi:10.1093/nsr/nwaa036; @doi:10.1126/sciadv.abb9153].
...
There were 38 species observed at the market in the 2.5 years leading up to the emergence of SARS-CoV-2 [@doi:10.1038/s41598-021-91470-2]. 
...
Interest in this topic was fueled, in part, by the lack of well-characterized bat coronaviruses which means that SARS-CoV-2 is still relatively derived from documented coronaviruses surveyed in bats [@doi:10.1016/j.tree.2020.12.002].
...
There are several other domains in which human/animal interactions are significant.
...
<!--Evidence of bat or pangolin infection?-->
Given the evidence for a zoonotic origin of SARS-CoV-2, another evolutionary question that received significant attention early in the pandemic was which species could become infected by SARS-CoV-2.
In particular, concerns arose surrounding companion animals (e.g., dogs and cats) and livestock.
The phylogeny of the three species implicated suggested there could be cause for alarm.
...
The third species affected by SARS-CoV-2, humans, shared a least common ancestor with _Pegasoferae_ almost 100 million years ago [@doi:10.1073/pnas.1702012114].
Therefore, concerns were raised that other species closely related to bats and pangolins could be infected.
...
Many cases of anthroponotic transmission to housecats have been recorded [@doi:10.3390/v13020185].
Comparing estimates in studies where cats living with SARS-CoV-2-positive humans were tested for SARS-CoV-2 suggest that 6-15% of cats may become infected [@doi:10.3390/v13020185].<!--check these references and pull additional?-->
...
ACE2 comparative genetics: 10.1016/j.jinf.2020.02.013

...
Figure @fig:ebm-trials-map showcases two choropleths detailing COVID-19 clinical trial recruitment by country.
...
Especially with the global nature of COVID-19, equitable access to therapeutics and vaccines has been a concern at the forefront of many discussions about policy (e.g., [@doi:10/ggq7mf], yet data like that shown in Figure @fig:ebm-trials-map demonstrates that accessibility is likely to be a significant issue.
...
As of {{ebm_date_pretty}}, there are {{ebm_trials}} in the University of Oxford Evidence-Based Medicine Data Lab's COVID-19 TrialsTracker [@doi:10.5281/zenodo.3732709].
...
]({{ebm_trials_map}} "COVID-19 clinical trials"){#fig:ebm-map secno=1}
...
The data indicated that the mean word count of the entire visit was 1.5 more for white patients in comparison to Black patients.
...
A study from 2005 reported that Black asthma patients showed reduced responsiveness to dexamethsone in comparison to white patients and suggested Black patients might therefore require higher doses of the drug [@doi:10.1378/chest.127.2.571].

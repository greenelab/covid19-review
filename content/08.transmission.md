...
<!-- Merge with PR #638, which covers sex and age-->
...
Additionally, certain conditions are likely to be more prevalent under or exacerbated by social conditions such as poverty, as is discussed further below.

#### Ancestry-Related Associations

A number of studies in the United States and other countries have also identified correlations between racial and ethnic backgrounds and COVID-19 risk.
In particular, Black Americans are consistently identified as carrying a higher burden of COVID-19 [@doi:10.1377/hlthaff.2020.00598; @doi:10.15585/mmwr.mm6925e1]
...
, but the hierarchical structure of human genetic diversity combined with the diverse make-up of Black American communities means that the genetic diversity in this group is exceptionally high relative to the other groups used in these comparisons [citation].

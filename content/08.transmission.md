...
In some cases, these trends run counter to those expected given rates of exposure: for example, although women are more likely to be exposed, but men are more likely to be diagnosed with, hospitalized from, or die from COVID-19 [@doi:10.1371/journal.ppat.1008570].
...
In this case, the relationship between structural racism and COVID-19 risk becomes obvious.
People subjected to racism are more likely to live in poverty, be incarcerated, and face food an housing instability.

...
At present, the report prepared for the Director of the CDC by Ethic Subcommittee of the CDC fails to address the complexity of this ethical question given the state of structural racism in the United States, instead stating that "[p]rioritizing individuals according to their chances for short-term survival also avoids ethically irrelevant considerations, such as race or socioeconomic status" [@url:https://www.cdc.gov/about/advisory/pdf/VentDocument_Release.pdf].

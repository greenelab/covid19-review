...
As COVID-19 has spread into communities around the globe, it has become clear that the risks associated with this disesase are not equally shared by all individuals or all communities.
Significant disparities in outcomes have led to interest in the demographic, biomedical, and social factors that influence disease severity.
Untangling the factors influencing COVID-19 susceptibility is complex because the high frequency of asymptomatic and mild cases means that a large percentage of infections may not be documented, at least without universal testing procedures. 
Hospitalization rates themselves vary by location [@doi:10.15585/mmwr.mm6915e3], which could in turn be influenced by demographic (e.g., average age in the area), biomedical (e.g., the prevalence of comorbid conditions such as diabetes), and social (e.g., income or healthcare availability) factors.
...
Additionally, some of the same factors may influence both an individual's probability of exposure to SARS-CoV-2 and their risk of developing a more serious case of COVID-19.
As a result, quantifying or comparing susceptibility among individuals, communities, or other groups requires consideration of a number of complex phenomonena that intersect across many disciplines of research.
...
A retrospective study of Chinese patients [@doi:10/ggnxb3] found that a higher probability of mortality was associated with older age and higher Sequential Organ Failure Assessment scores, as well as high levels of d-dimer.

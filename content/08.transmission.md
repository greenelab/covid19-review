...
Several underlying health conditions were identified at high prevalence among hospitalized patients, including obesity, diabetes, hypertension, lung disesase, and cardiovascular disease [@doi:10.15585/mmwr.mm6915e3].
Higher Sequential Organ Failure Assessment (SOFA) scores have been associated with a higher probability of mortality [@doi:10/ggnxb3], and comorbid contitions such as cardiovascular and lung disease as well as obesity were also associated with an increased risk of hospitalization and death, even when correcting for age and sex [@doi:10.1136/bmj.m1985].

...
Therefore, the idea that African ancestry might convey some sort of genetic risk for severe COVID-19 seems unlikely given what is known about worldwide human genetic diversity [@doi:10.1126/science.abd4842], with some minor exceptions, such as that it's possible variants in the major histocompatability complex (MHC) could vary regionally and possibly convey some protective effect [@doi:10.1016/j.ijid.2020.07.016].
However, such variants are unlikely to explain the patterns that are appearing on a global scale.
...
While several possible hypotheses for the apparent reduced impact of COVID-19 on the African continent are being explored [@doi:10.1126/science.369.6505.756], these reports present a stark contrast to the severity of COVID-19 in Americans and Europeans of African descent [@doi:10.1126/science.369.6505.756].
...
Therefore, the current evidence suggests that the apparent correlations between ancestry and health outcomes must be examined in the appropriate social context.

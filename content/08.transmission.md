...
The evidence clearly indicates that social evironmental factors are critical determinants of individuals' and communities' risks related to COVID-19.
...
The fact that differences in survival between Black and white patients were no longer significant after controlling for comorbidities and socioeconomic status (type of insurance, neighborhood deprivation score, and hospital where treatment was received) in addition to sex and age [@doi:10.1001/jamanetworkopen.2020.18039] suggests that these factors might be relevant to understanding mortality differences between racial and ethnic groups.
The importance of social and environmental factors is underscored by the fact that the Black patients were younger and more likely to be female than white patients, yet still had a higher mortality rate without correction for the other variables [@doi:10.1001/jamanetworkopen.2020.18039].
Here, we outline a few ways in which the COVID-19 pandemic is likely to be exacerabated in communities of color.
...
In U.S. counties with and without stay at home orders, smartphone tracking indicated a signficant decrease in the general population's mobility in April relative to February through March of 2020 (-52.3% and -60.8%, respectively) [@doi:10.1101/2020.05.03.20084624].
...
These counties were found to have much lower child poverty and household crowding and to be more racially segregated, and to have fewer youth and more elderly residents [@doi:10.1101/2020.05.03.20084624].
Similar associations between wealth and decreased mobility were oberved in cellphone GPS data from Colombia, Indonesia, and Mexico collected between January and May 2020 [@arXiv:2006.15195].
These disparities in changes in mobility are likely to be related to the role that essential workers have played during the pandemic.
...
In the United Kindgdom, (South) Asians are more likely than their white cohorts to be medical professionals [@url:https://www.ifs.org.uk/inequality/chapter/are-some-ethnic-groups-more-vulnerable-to-covid-19-than-others/], although BAME have still been overrepresented in the proportion of National Health Service staff deaths [@doi:https://www.hsj.co.uk/exclusive-deaths-of-nhs-staff-from-covid-19-analysed/7027471.article].
Furthermore, use of public transportation may also impact COVID-19 risk [@url:http://www.nber.org/papers/w27407].
...
Additionally, multi-generational households are less common among non-Hispanic white Americans than people of other racial and ethnic backgrounds [@doi:10.1111/j.1751-9020.2010.00306.x], .

#### Comorbidities and Other Health Challenges

...
Receiving care for COVID-19 can include receiving a positive test for the SARS-CoV-2 virus, but it is also common to see treatment for suspected cases (e.g., [@doi:10.1016/j.ajem.2020.03.036]).
Where a patient is diagnosed can depend on their access to testing, which can vary both between and within countries.
The concern has been raised that more economic privilege is likely to correspond to access to testing, at least in the United States [@doi:https://doi.org/10.1016/j.jaad.2020.04.046].
For example, African Americans may be more likely to be diagnosed in the hospital, while other groups were more likely to have been diagnosed in ambulatory settings in the community [@doi:10.1377/hlthaff.2020.00598].
However, it's not clear that the timing of diagnosis is necessarily tied to eventual outcomes for many cases, since suspected mild cases are typically advised to remain at home [@url:https://apps.who.int/iris/bitstream/handle/10665/331473/WHO-nCov-IPC-HomeCare-2020.3-eng.pdf].
Instead, the bigger question is whether patients with moderate to severe cases are able to access hospital facilities and treatments, to the extent that they have been identified. 
Early findings from China as of February 2020 suggested the COVID-19 mortality rate to be much lower in the most developed regions [@doi:10/ggqscd].
In the United States access to healthcare varies widely, with certain sectors of the workforce less likely to have health insurance; many essential workers in transportation, food service, and other frontline fields are among those likely to be uninsured or underinsured [@doi:https://doi.org/10.1016/j.jaad.2020.04.046].
...
A major concern in many countries has also been the potential saturation of their healthcare systems due to the volume of COVID-19 hospitalization (e.g., [@doi:10.1073/pnas.2004064117]).

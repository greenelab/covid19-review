...
A number of studies have identified correlations between racial and ethnic backgrounds and COVID-19 risk.
In particular, Black Americans are consistently identified as carrying a higher burden of COVID-19 than white Americans [@doi:10.1377/hlthaff.2020.00598; @doi:10.15585/mmwr.mm6925e1], and in particular kidney complications from COVID-19 [@doi:10.1016/j.kint.2020.05.006].
...
From a genetic standpoint, it is highly unlikely that ancestry itself predisposes indviduals to contracting COVID-19 or to experiencing severe COVID-19 outcomes.
...
Therefore, the idea that African ancestry might convey some sort of genetic risk for severe COVID-19 seems unlikely given what is known about worldwide human genetic diversity [@doi:10.1126/science.abd4842], with the possible exception that the prevalence of protective variants in the major histocompatability complex (MHC) could vary regionally [@doi:10.1016/j.ijid.2020.07.016].
Furthermore, reports from several sub-Saharan African countries have indicated that the effects of the COVID-19 pandemic have been less severe than expected based on the outbreaks in China and Italy.
...
While several possible hypotheses for the apparent reduced impact of COVID-19 on the African continent are being explored [@doi:10.1126/science.369.6505.756], these patterns lie in stark contrast to the increased severity of COVID-19 observed in Americans and Europeans of African descent [@doi:10.1126/science.369.6505.756].
Additionally, the groups in the United States and United Kingdom that have been identified as carrying elevated COVID-19 burden, namely Black American, indigenous American, and Black and South Asian British, are quite distinct in their position on the human ancestral tree; however, what these groups share is a history of disenfranchisement under colonialism and ongoing systematic racism. 
Therefore, the current evidence suggests that the apparent correlations between race or ancestry and health outcomes be examined in the appropriate social context.

, as some of the proximal causes of COVID-19 risk underscore known correlaries of inequality.
...
tudies of disparities and differences among groups in rates of hospitalization or death from COVID-19 are complicated by the fact that risk may be elevated in multiple ways.

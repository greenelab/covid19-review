...
This step in the infection process includes two possible scenarios: an individual is exposed to SARS-CoV-2 but does not become infected, and an individual is exposed to the virus and does become infected.
Among patients who are infected, the severity of outcomes can range from no symptoms to COVID-19-related death.
...
First of all, certain comorbid conditions are associated with poverty.

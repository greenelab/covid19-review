...
This step in the infection process encompasses two steps related to exposure and infection: an individual who is exposed to SARS-CoV-2 does or does not become infected, and among those who are infected, the severity may range from asymptomatic to COVID-19-related death.
Without aggressive universal testing and contact tracing, it is not possible to distinguish asymptomatic individuals from those who were not infected; therefore, these scenarios are considered together.
As discussed above, a number of patient characteristics are associated with the likelihood of severe COVID-19 symptoms.
In some cases, these trends run counter to those associated with exposure: for example, evidence suggests women are more likely to be exposed but that men are more likely to be hospitalized.
In the case of comorbid conditions and racial/ethnic demographics, however, social factors are highly likely to modulate or at least influence the apparent association between the patient trait and the increased risk from COVID-19.

Conditions associated with poverty are likely to confer additional risk for COVID-19.
...
Poverty exposes people to "obesogenic" conditions [@doi:10/gddg84] and is therefore unsurprisingly associated with higher incidence of obesity and associated disorders [@doi:10.5604/12321966.1120608].
Furthermore, cell phone GPS data suggests that lower socioeconomic status may also be associated with decreased access to healthy food choices during the COVID-19 pandemic [@doi:10.1002/oby.22940; @doi:10.1002/oby.22993], suggesting that health-related risk factors for COVID-19 may be exacerbated [@doi:10.1016/j.pcad.2020.07.002].
...
Environmental factors associated with poverty (e.g., [@doi:10.3390/ijerph15061114]) could also influence individuals' susceptibility to COVID-19: a preprint [@doi:10.1101/2020.04.05.20054502] provided observational evidence that geographical areas in the United States that suffer from worse air pollution by fine particulate matter have also suffered more COVID-19 deaths per capita, after adjusting for demographic covariates.
...
Exposure to air pollution is also associated with chronic inflammation [@doi:10.1016/j.neubiorev.2018.06.002].
Other environmental factors associated with inflammation, such as chronic stress and depression, are also elevated in conditions of poverty.
Therefore, it is likely that low-income workers who face greater exposure to SARS-CoV-2 due to their home or work conditions are also more likely to face environmental stressors associated with increased inflammation, and therefore with increased risk from COVID-19.
This problem also interfaces with structural racism to exacerbate risk for people from minoritized groups, as structural racism presents an increased risk of poverty, imprisonment, and food or housing instability, all of which correlate with chronic inflammation.
As a result, it is not surprising that people from minoritized backgrounds or with certain pre-existing conditions are more likely to suffer severe effects of COVID-19, but these "risk factors" are likely to be causally linked to poverty and other sources of chronic stress.

#### Access to Treatment

In the sample studied by [@doi:10.1377/hlthaff.2020.00598], African Americans were more likely to be diagnosed in hospital, while other groups were more likely to have been diagnosed in ambulatory settings in the community.

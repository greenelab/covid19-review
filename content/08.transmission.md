...
Viruses have several possible routes of person-to-person transmission.
...
Particles can enter the body if they then come in contact with mucus membranes, such as the oral, nasal, or eye mucus membranes [@doi:10.4415/ANN_13_02_03].
Droplet transmission occurs when a contagious individual sneezes, coughs, or exhales and produces large droplet particles containing a large number of viral particles [@doi:10.4415/ANN_13_02_03].
Contact with the droplets can be either direct, such as encountering droplets propelled by a sneeze, or indirect, such as when particles settle on a surface that is later touched [@doi:10.4415/ANN_13_02_03].
Aerosol or airborne transmission refers to much smaller particles also produced by sneezing, coughing, or exhaling [@doi:10.1097/QCO.0000000000000563; @doi:10.4415/ANN_13_02_03].
The small size of these particles allows them to remain suspended and potentially be moved by air currents [@doi:10.4415/ANN_13_02_03].
...
Regardless of its role in the spread of influenza A, however, aerosol transmission likely played a role in outbreaks such as the 1918's Spanish Influenza (H1N1) and 2009's "swine flu" (pH1N1) [@doi:10.1093/femsre/fuv039].
Contact, droplet, and aerosol transmission are therefore all worth evaluating when considering possible modes of transmission for a respiratory virus. 

All three of these mechanisms have been identified as playing a role in the transmission of HCoV [@doi:10.4415/ANN_13_02_03].
SARS transmission is thought to proceed primarily through droplet transmission, but aerosol transmission is also considered possible [@doi:10.4415/ANN_13_02_03].
Similarly, the primary mechanism of MERS tranasmission is thought to be droplets, but aerosolized MERS viral particles have been reported to persist much longer than influenza A.

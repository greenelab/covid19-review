...
Indirect estimates of infection rates are becoming more feasible as modeling improves, and direct estimates will be bolstered as serological testing becomes more common and available, but at present, most studies rely on observations of patients who are hospitalized.
Estimates of case fatality rate (CFR) have also been determined based on metanalysis.
CFR compares the number of COVID-19 deaths to the number of known COVID-19 cases without estimating  will be greater and vary a lot.
...
Two demographic factors that are consistently found to be associated with more severe COVID-19 outcomes are male sex and advanced age. 
A retrospective study of hospitalized Chinese patients [@doi:10/ggnxb3] found that a higher probability of mortality was associated with older age. 
In the United States, males and older indviduals diagnosed with COVID-19 were found to be more likely to require hospitalization [@doi:10.1377/hlthaff.2020.00598; @doi:10.15585/mmwr.mm6925e1].
Male sex has also been identified as a risk factor for increased COVID-19 severity [@doi:10.1136/bmj.m1985; @doi:10.1186/s13293-020-00304-9; @url:https://globalhealth5050.org/the-sex-gender-and-covid-19-project/].
Early reports from China and Europe indicated that even though the case rates were similar across males and females, males were at elevated risk for hospital admission, ICU admission, and death [@doi:10.1186/s13293-020-00304-9].
...
The biological basis for greater susceptibility with age 

Several hypotheses have been proposed that could account for differences in severity between males and females [@doi:10.1371/journal.ppat.1008570].
For example, two-times higher expression of ACE2 in the kidneys of male than female mice that was shown to be dependent on estradiol exposure [@doi:10.1186/2042-6410-1-6] indicates that the presence of estradiol is likely to impact COVID-19 susceptibility, at in the kidneys [@doi:10.1371/journal.ppat.1008570].
https://doi.org/10.1371/journal.ppat.1008570


<!--Why?--> 

Additionally, a number of pre-existing or comorbid conditions have repeatedly been identified as risk factors for more severe COVID-19 outcomes.
Higher Sequential Organ Failure Assessment scores are associated with a higher probability of mortality [@doi:10/ggnxb3].
and comorbid contitions associated with increased risk of hospitalization, including cardiovascular and lung disease and obesity, were also associated iwth an increased risk of death even when correcting for age and sex [@doi:10.1136/bmj.m1985].
...
Hospitalization rates vary and appear to be influenced by age and location, with several underlying health conditions including obesity, diabetes, hypertension, lung disesase, and cardiovascular disease being common among hospitalized patients [@doi:10.15585/mmwr.mm6915e3].

However, these factors are not necessarily independent.
...
#### Risk of Exposure
Healthcare workers --> higher case load in women? [@doi:10.1371/journal.ppat.1008570]

#### Systemic Racism and COVID-19

However, a number of studies in the United States and other countries have also identified correlations between racial and ethnic backgrounds and COVID-19 risk.
From a biological standpoint, it is highly unlikely that any particular ancestry predisposes an indvidual to COVID-19 or to severe COVID-19 outcomes.
For example, Black Americans are consistently identified as carrying a higher burden of COVID-19 [@doi:10.1377/hlthaff.2020.00598; @doi:10.15585/mmwr.mm6925e1], but the hierarchical structure of human genetic diversity combined with the diverse make-up of Black American communities means that the genetic diversity in this group is exceptionally high relative to the other groups used in these comparisons [citation].
Instead, it is imperative that apparent correlations between race or ancestry and health outcomes be examined in the appropriate social context. 

Additionally, some of the proximal causes of COVID-19 risk underscore known correlaries of inequality.
...
Evidence flagging systemic racism, rather than ancestral demographics themselves, as a potential COVID-19 risk factor is underscored by outcomes in other minoritized communities.
...
In Brazil, where the pandemic has also been severe, indigenous communities are likewise at increased risk [@doi:10.1126/science.abc0073].
In human evolutionary terms, indigenous American ancestry is closest to east Asian ancestry, so the paraphyletic distribution of risk suggests that ancestry or genetic risk factors are unlikely.  
In the United Kingdom, a country where South Asians are considered a minoritized group due to race-based discrimination, <!--[@doi:10.1038/s41586-020-2521-4] found that male sex, older age, economic deprivation, nonwhite ethnicity (principally Black or South Asian), obesity, diabetes,  asthma, and several other comorbid conditions were associated with a higher risk of death from COVID-19.
<!-- First Peoples?-->

In the United States, another notable factor potentially influencing undue disease burden in Black communities relates to economic inequality and incarceration.
...
<!-- Genetic factors unlikely to correlate with "Race"-->
While it remains possible that some genetic factors could influence COVID-19 outcomes, such as genetic factors may play a role in risk of respiratory failure for COVID-19 [@doi:10.1056/NEJMoa2020283; @doi:10.1093/gerona/glaa131; @doi:10.1101/2020.06.16.155101].

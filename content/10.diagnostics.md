...
Another analysis, which examined New York state, indicated that as of May 2020, approximately 300,000 cases had been reported in a total population ~20 million, corresponding to ~1.5% of the population, but up to ~20% of the population tested positive when evaluated with antibody tests [@url:ny.governor.gov/nyforwardbook].

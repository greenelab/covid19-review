...
<!--Moved sentence here: While serological tests may be of interest to individuals who wish to confirm they were infected with SARS-CoV-2 in the past, their potential for false positives means that they are not currently recommended for this use.-->
...
Diagnostic approaches that utilize a variety of methods are currently being or have been developed.
...
<!--Not sure why this text is here:
...
<!-- To Do: moved this text up, but need to flesh out this pharagraph with info about where SARS-CoV-2 infection exists in the body-->
...
<!-- To Do: Discuss risk of detecting other coronaviruses and which other coronaviruses can infect humans-->
<!-- To Do: Trade offs in cost vs precision (throughput)-->
<!-- To Do: Discuss viral load vs contagiousness vs symptoms -->
...
This study analyzd 196 samples, including 103 samples from suspected patients, 77 from contacts and close contacts, and 16 from suspected convalescents, using both RT-qPCR and RT-ddPCR.
...
For example, viral shedding kinetics are still not well understood, but are expected to inftroduce a significant effect of timing of sample collection on test results [@doi:10.1038/d41587-020-00002-2].
...
There are also significnat practical and logistical concerns.
...
Therefore, such tests must be used in combination with RNA detection tests if intended for diagnostic purposes.
...
In addition, as noted above, identifying and isolating mild or asymptomatic cases is critical to efforts to manage outbreaks.

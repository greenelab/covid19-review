...
Diagnostics is one area where biotechnology has been particularly important.
...
Within the remaining 29 samples from contacts, 12 tested positive, 1 negative, and 16 suspected with RT-qPCR.
...
All 16 patients identified as positive by RT-ddPCR were subsequently determined, both clinically and through repeated sampling, to be positive for SARS-CoV-2. <!-- What is this group of 16? Is this the convalescent group below? This paragraph is so detailed it is hard to follow all the numbers. -->
...
ELISA builds on the idea that antibodies and antigens bind together to form complexes [@pubmed:32310382], using enzymes that react with an antigen as reporter labels [@doi:10.1373/clinchem.2005.051532].

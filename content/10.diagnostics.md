...
One study assessed sustained immunity using blood samples from 188 COVID-19 positive patients at various time points between 6 and 240 days post-symptom onset, whereby some patients were also assessed longitudinally to determine [@doi:10.1126/science.abf4063]. 
After 1 month, 98% of patients were seropositive for spike IgG. 
Moreover, spike IgG titers were stable and heterogeneous among patients over a period of 6 to 8 months post-symptom onset, whereby 90% of subjects were seropositive at 6 months.
Similarly, at 6 to 8 months 88% of patients were seropositive for receptor binding domain (RBD) IgG and 90% were seropositive for SARS-C0V-2 neutralizing antibodies.

Memory B cells and memory T cells were also measured.
SARS-CoV-2 spike-specific memory B cell levels steadily rose over the first 120 days post-symptom onset. 
RBD-specific memory B cells were detected in COVID-19 patients 90 days post-symptom onset in previous studies [@doi:10.1016/j.cell.2020.11.029; @doi:10.1126/sciimmunol.abf8891], this study confirms these finding and shows that these cells steadily increase for over 4-5 months post-symptom onset [@doi:10.1126/science.abf4063].
...
There is concern that immunity may wane over time as there have been several reported cases of reinfection confirmed via genomic analysis of variants associated with infection in patients [@doi:10.1016/S1473-3099(20)30764-7; @doi:10.1093/cid/ciaa1451; @doi:10.1093/cid/ciaa1275].
Further research is required to determine the full extent of what level of sustained immunity can be achieved following SARS-CoV-2 infection
Furthermore, it is unclear what repercussions there may be in terms of disease severity for patients [@doi:10.1016/S1473-3099(20)30783-0] and what reinfection implies for vaccine development and long-term efficacy [@doi:10.1038/s41591-020-1121-z; @doi:10.3389/fimmu.2020.571481]. 

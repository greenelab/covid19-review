...
The second step involves the amplification of a region of interest in the cDNA using succesive cycles of heating and cooling.
...
In this manuscript we refer to quantiative real-time PCR as qPCR, following the recommendations of the MIQE guidelines [@doi:10.1373/clinchem.2008.112797]. 
...
The time resolution of qPCR is useful because the amount of fluorescence emitted by the sample is proportional to the amount of DNA amplified and it can be indirectly measured using the cycle threshold (Ct). 
For SARS-CoV-2, studies have considered that patients are infectious if the Ct is below 33 [@doi:10.1007/s10096-020-03913-9;@doi:10.1038/s41467-020-20568-4].

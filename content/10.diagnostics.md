...
However, there is some evidence suggesting that samples obtained from individuals that achieve Ct values >30 measured using RT-PCR tend to be less infective that those that record a Ct value <30 [@doi:10.1016/j.jiph.2021.08.013; @doi:10.1017/ice.2021.132; @doi:10.1093/cid/ciaa619], and so RT-LAMP is still a useful diagnostic tool. 

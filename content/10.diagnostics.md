...
Diagnostics is one area where biotechnology has been particularly important.<!--Alt: One important area of biotechnology research is diagnostics.-->
...
However, these tests offer different advantages, and a holistic view of the testing landscape is important to identify where each test offers information that can be used to address different questions.
...
Suo et al. [@doi:10.1080/22221751.2020.1772678] performed a double-blind evaluation of ddPCR for SARS-CoV-2 detection on 57 samples, 43 samples from suspected positive patients and 14 from supposed convalescent patients who had all tested negative for SARS-CoV-2 using qPCR.
Despite the initial negative results, 33 out of 35 (94.3%) patients were later clinically confirmed positive. <!-- Where did the 35 come from? -->
...
Using RT-qPCR, 29 (28%) were identified as positive, 25 (24%) as negative, and 49 (48%) as borderline, i.e., the C~t~ value was higher than the positive threshhold of 35 but lower than the negative thresshold of 40.
...
In contrast, the negative result and all but one of the borderline results were identified as positive by RT-ddPCR, and these patients were later determined to be SARS-CoV-2 positive based on clinical evaluation and repeated molecular sampling. <!--It is not entirely clear to me from the methods & supplement whether this resampling was done with RT-qPCR (section 3.5 in the reference). However, as noted above, they do specify the technique used for suspected cases (right about Fig 3 in the paper).-->
...
Conceptually, pooling could also be employed in analysis with RT-qPCR [@doi:10.1109/ICASSP39728.2021.9413685]. <!-- This looks like algorithmic work that doesn't have a proof of concept. Is my rephrasing okay? -->
...
In the meta-analysis of all 2,112 samples, the cumulative sensitivity of RT-LAMP was 95.5% (CI 97.5% = 90.8-97.9%) and the cumulative specificity was 99.5% (CI 97.5% = 97.7-99.9%). <!-- This is different confidence interval notation than we've used elsewhere -->
...
LFT strips are simple to use and read, but there are limitations in terms of availability and cost per test. <!-- Is SHERLOCK more available and less expensive than LFTs? This sentence feels out of place, or I'm missing the point. -->
...
The specificities of these tests were more homogeneous, spanning 92.4% (95% CI 87.5-95.5%) to 100.0% (95% CI 99.7-100.0%). <!-- Other CIs don't have the 95% -->
...
Tests that identify SARS-CoV-2 using nucleic-acid-based technologies will identify only individuals with current infections and are not appropriate for identifying individuals who have recovered from a previous infection. <!-- Isn't this also true for antigen-based tests discussed above? -->
Among molecular tests, different technologies have different sensitivities and specificities. <!-- Specificity and sensitivity are so central to the paper that it seems like the terms should be introduced early in the manuscript -->
...
After one month, 98% of patients were seropositive for IgG to the spike protein, S.
...
For instance, it was hoped that people who had recovered and developed antibodies might be able to return to work [@doi:10.1101/2020.04.14.20065771; @doi:10.1001/jamainternmed.2020.7986].
...
However, preliminary machine-learning results have shown far higher sensitivity and specificity from analyzing chest X-rays than was possible with clinical examination [@doi:10.1007/s13246-020-00865-4]. <!-- Do we take these results at face value? Studies like https://doi.org/10.1038/s42256-021-00307-0 have questioned whether ML models like this have any clinical value. I'm not sure whether the surveyed this particular paper we cite here, but some additional caveats or skepticism may be needed (in the next sentence too). -->

...
Dan et al. assessed sustained immunity using 245 blood samples from 188 COVID-19 positive patients [@doi:10.1126/science.abf4063]. 
...
The findings of Dan et al. are in accordance with Sherina et al. who examined 119 samples from 88 donors who had mild to severe COVID-19 [@doi:10.1016/j.medj.2021.02.001]. 
...
A study by Gaebler et al. has shown that titers of IgM and IgG antibodies against the RBD decrease from 1.3 to 6.2 months post infection in 87 individuals [@doi:10.1038/s41586-021-03207-w]. 
IgM seemed to show the greatest decrease of anti-RBD reactivity (53%), followed by IgG (32%), but a lower decline of IgA (15%) activity was observed. 
...
Moreover, plasma neutralizing activity decreased five-fold between 1.3 and 6.2 months in an assay of HIV-1 virus pseudotyped with SARS-CoV-2 S protein, and this neutralizing activity was directly correlated with IgG anti-RBD titres [@doi:10.1038/s41586-021-03207-w].
These findings are in accordance with other studies that show that the majority of seroconverters have detectable, albeit decreasing levels of neutralizing antibodies at least 3-6 months post infection  [@10.1126/science.abd7728; @doi:10.1038/s41564-020-00813-8; @doi:10.1038/s41467-021-21444-5].
...
Dan et al. showed that SARS-CoV-2 S-specific memory B cell levels steadily rose over the first 120 days following symptom onset [@doi:10.1126/science.abf4063].
RBD-specific memory B cells had been detected in COVID-19 patients 90 days post-symptom onset in previous studies [@doi:10.1016/j.cell.2020.11.029; @pmid:33443036], and this study confirms these finding and shows that these cells steadily increased over the 4-5 months post-symptom onset [@doi:10.1126/science.abf4063].
Gaebler et al. has shown that memory B cells specific to the RBD remain unaltered  and exhibit clonal turnover and antibody sequence evolution 6 months post infection indicative of prolonged germinal cell reactions  [@doi:10.1038/s41586-021-03207-w]. 
...
Indeed, Wheatley et al. showed that S-specific IgG^+^ memory B cells consistently increase over time and by 4 months they comprise approximately 0.8% of all IgG^+^ memory B cells, which may indicate cellular immune memory to even mild-moderate COVID-19 infection [@doi:10.1038/s41467-021-21444-5]. 
...
Indeed, the S-specific memory CD4^+^ T cells abundance over time were similar to the overall SARS-CoV-2-specific CD4^+^ T cells [@doi:10.1126/science.abf4063].

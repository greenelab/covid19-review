...
For instance, a recent study from the Imperial College estimates that in Italy the true number of infections is around 5.9 million (total population ~60 million) against the 70,000 detected as of March 28th [@doi:10.25561/77731]; another example about New York state mentions for May 2020 ~300,000 cases reported (total population ~20 million) or ~1.5% of the population while antibody tests show ~20% positive [@url:ny.governor.gov/nyforwardbook].

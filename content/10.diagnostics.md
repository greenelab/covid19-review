...
This particular example in the case of children illustrates that the multiple SARS-CoV-2 diagnostic tools we have presented in this paper lack any real benefit if they are difficult to obtain, or if their limited use results in biased data that would lead to ill-informed public health strategies. 

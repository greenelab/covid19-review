...
Once a sample from an appropriate source is acquired from a patient, molecular tests follow a number of different steps, described below, to analyze a sample and identify whether evidence of SARS-CoV-2 is present. There are two important categories of molecular tests: PCR-based tests and LFT-based tests. 
...
LFT methods rely on detection of the viral protein with an antibody. 

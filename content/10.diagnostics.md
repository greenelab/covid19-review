...
One of these assays used two monoclonal antibodies specific to the nucleocapsid of SARS-CoV-2 to evalaute the relationship between the effect of (estimated) viral load on the ability of the assay to detect the SARS-CoV-2 antigen [@doi;10.1080/14787210.2021.1976144].
...
In this context, serological tests are more informative.
Serological tests use the same technology as the immunoassays used to detect the presence of an antigen, but are instead used to evaluate the presence of antibodies against SARS-CoV-2 in a serum sample.
...
With immunoassays, it is also possible to detect antibodies produced by the immune system in response to viral threat.
...
The application of ELISA to serological testing is complementary to its use in molecular diagnostics.

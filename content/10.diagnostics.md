...
Serological tests, on the other hand, detect the presence of antibodies in blood plasma samples using enzyme-linked immunosorbent assay (ELISA), lateral flow immunoassay (LFIA), and chemiluminescence immunoassay (CLIA) [@DOI:10.3389/fmolb.2021.682405].
...
In general, SARS-CoV-2 infection is thought to cause the production of antibodies fairly quickly.

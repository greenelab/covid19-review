...
Diagnostics plays a vital role in managing a viral threat by facilitating the detection of infected and/or recovered individuals.
...
Here we review the categories of tests available for the detection of the SARS-CoV-2 virus or antibodies against SARS-CoV-2.
...
Another important consideration is the ease of use and ability to scale for each test, which determine how widely they can be deployed.
...
<!--Add immunoassays text from 1098 here-->
...
Viral evolution [@doi:10.1093/cid/ciab646].

Like molecular tests, serological immunoassays carry a number of limitations that influence their utility in different situations.
...
However, though its diagnostic applications may be limited, serological testing is valuable for public health monitoring at the population level.

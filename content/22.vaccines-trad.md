...
The efficacy and/or effectiveness of vaccines in the context of these variants is discussed where information is available.
...
Although IWV vaccine candidates were well-tolerated overall, both Sinovac's CoronaVac and Sinopharm's inactivated WIV04 vaccine trials were affected by concerns about AEs.
In CoronaVac’s trial of adults 18-59, 2% (n=7) of participants reported severe AEs [@doi:10/fx8z], causing the trial to be halted for investigation [@url:https://www.nytimes.com/interactive/2020/health/sinovac-covid-19-vaccine.html].
...
In this case study, the two male patients both presented with COVID-19 pneumonia following vaccination with CoronaVac [@doi:10.1155/2021/9673453].
This study identified the timeline of disease presentation, vaccination, and known COVID-19 exposure in the two patients and suggest that the inflammatory response induced by the vaccine could have caused an asymptomatic case of COVID-19 to present with symptoms [@doi:10.1155/2021/9673453].
However, no causal relationship between CoronaVac and COVID-19 symptom onset was evaluated by the study.

More concern has arisen around the issue of effectiveness.
...
Concern was raised about the effectiveness of CoronaVac following reports that over 350 doctors became ill with COVID-19 in Indonesia despite being immunized with CoronaVac [@url:https://www.nytimes.com/2021/06/22/business/economy/china-vaccines-covid-outbreak.html].
...
Nuvaxovid has since been authorized for use in several places, including the United Kingdom [@url:https://www.gov.uk/government/news/novavax-covid-19-vaccine-nuvaxovid-approved-by-mhra], the E.U. [@ema-nuvaxovid], and the U.S. [@url:https://www.fda.gov/news-events/press-announcements/coronavirus-covid-19-update-fda-authorizes-emergency-use-novavax-covid-19-vaccine-adjuvanted].
...
Given the apparent need for boosters, interest has also emerged in whether booster doses of Nuvavaxovid can be safetly administered along with annual flu vaccines.
...
While no change to the immune response was noted for the influenza vaccine, a notable reduction of the antibody response elicited by Nuvavaxovid  was reported, but efficacy was still high at 87.5% [@doi:10.1101/2021.06.09.21258556].
...
Concerned about vaccine access, especially given the U.S.'s long-standing embargo [@doi:10.1038/d41586-021-03470-x], health officials in this developing country made the decision in March 2020 to develop their own vaccine [@doi:10.37757/mr2022.v24.n3-4.13].
In fact, they developed three subunit vaccines that have been approved: Abdala, which was developed at the Cuban Genetic Engineering and Biotechnology Center and SOBERANA 02 and SOBERANA Plus, which were developed at Cuba’s Finlay Vaccine Institute (Instituto Finlay de Vacunas Cuba) [@doi:10.37757/mr2022.v24.n3-4.13].
While 
...
A sequence corresponding to the RBD of the Spike protein in the index strain of SARS-CoV-2 was codon optimized for expression in yeast, and the RBD proteins were then purified and used to innoculate mice, rats, and African green monkeys [@doi:10.1016/j.nbt.2022.08.002].
...
They compared the immunogenicity of the yeast-cultivated proteins to those cultivated in human embryonic kidney cells and found no significant difference in the immune response [@doi:10.1016/j.nbt.2022.08.002].
Based on promising results from the animal studies, Abdala moved to phase I/II trials in human subjects ages 19 to 80, recruiting participants between December 2020 and February 2021 [@doi:10.1016/j.eclinm.2022.101383].
...
In March 2021, phase III trials began [@url:http://www.xinhuanet.com/english/northamerica/2021-03/20/c_139823225.htm], and by June, officials were reporting the VE to be 92.28% effective [@url:https://www.reuters.com/business/healthcare-pharmaceuticals/cuba-says-abdala-vaccine-9228-effective-against-coronavirus-2021-06-21; @url:https://www.granma.cu/cuba/2021-06-21/abdala-con-tres-dosis-tiene-una-eficacia-de-9228-porciento-21-06-2021-21-06-01].
...
However, the trials were designed to enroll a large number of participants and were carried out during a wave of infections due to the D614G variant in Cuba, which would be expected to allow an expedited timeline for interim analysis [@url:https://oncubanews.com/en/cuba/how-was-the-efficacy-of-the-cuban-covid-19-vaccine-candidates-calculated].
...
The final results included 42 symptomatic cases of COVID-19 in the placebo condition compared to only 11 cases among participants who received the vaccine, yielding the reported VE of 92.28% [@doi:10.1101/2022.09.08.22279690].
...
Having developed a vaccine with an estimated VE paralleling that of vaccines developed using cutting-edge nucleic acid technologies (see [@individual-vaccines-novel]), Cuba has also vaccinated a high percentage of its population, with 87% of the population vaccinated by January 2022 and 90.3% by the end of December 2022 [@url:https://salud.msp.gob.cu/actualizacion-de-la-vacunacion-en-el-marco-de-los-estudios-de-los-candidatos-vacunales-cubanos-y-la-intervencion-sanitaria; @doi:10.37757/MR2022.V24.N1.11].
...
One consideration in interpreting this study is that the vaccination rate in Cuba is so high that the two cohorts might not be directly comparable.
...
Limited data has been published about the Abdala's vaccine's robustness to evolutionary change in SARS-CoV-2.
...
Instead, Cuba has prioritized boosters.
The Cuban government authorized boosters in January 2022 in an effort to mitigate the effects of the Omicron variant [@url:https://www.cnbc.com/2022/01/13/why-cubas-extraordinary-covid-vaccine-success-could-provide-the-best-hope-for-the-global-south.html].
...
As of December 2022, the vaccine had been authorized for distribution in five additional countries, including Mexico and Vietnam, although its evalutation for WHO approval was ongoing [@url:https://extranet.who.int/pqweb/sites/default/files/documents/Status_COVID_VAX_08November2022.pdf; @doi:10.1136/bmj.o230].

Cuba's SOBERANA 01/02/Plus vaccine development program has also met with great success.
...
Lots of protein subunit vaccines, developed around the world.
Two other VLPs in phase III trials: https://covid19.trackvaccines.org/vaccines/110 and https://covid19.trackvaccines.org/vaccines/163 and many others in phase II.

To date, data about the effect of viral evolution on the effectiveness of subunit vaccines has been limited.
Because these vaccines were developed using the Spike protein from the index strain [@doi:10.1038/s41467-020-20653-8; @doi:10.1056/NEJMoa2201300], a potential concern is that these vaccines could lose effectiveness against SARS-CoV-2 containing mutations in the Spike protein.
...
Therefore, the relative timing of studies relative to dominant VOC in the region where participants are recruited is important context for a complete picture of efficacy.
...
Additionally, there are many cohort- and population-level characteristics that can introduce bias to clinical trials [@doi:10.1016/j.vaccine.2021.05.099] and the extent to which these different factors are present may influence trial outcomes.

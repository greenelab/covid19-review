...
Technologies such as mRNA vaccines have received significant attention in the COVID-19 pandemic due to their novelty and successes.
However, more traditional vaccine development platforms have also been explored against SARS-CoV-2, yielding important tools in the worldwide fight against the virus.
...
As of {{csse_date_pretty}}, there have been over {{csse_cases}} SARS-CoV-2 cases, and it has taken the lives of at least {{csse_deaths}} people globally. <!-- Assuming reinfections become more common in year 2 of the pandemic so rephrased -->
...
In this review, we evaluate the efficacy of these vaccines as well as patterns in their distribution.
...
As of {{owid_most_recent_date}}, {{viper_vaccine_counts}} SARS-CoV-2 vaccines have been approved. 
Tracking the administration of {{owid_vaccine_counts}} vaccines throughout the world indicates that {{owid_total_vaccinations}} doses have been administered across {{owid_total_countries}} countries [@doi:10.1038/s41562-021-01122-8].
Of these, {{viper_num_approved_subunit}} were developed using subunit and {{viper_num_approved_whole_virus}} using whole-virus approaches, which do not require information about the viral genome. <!-- broken template -->
Many vaccines are available only in a subset of countries, and the types of vaccines available varies widely throughout the world, as the process of developing and deploying a vaccine is complex and often requires coordination between government, industry, academia, and philanthropic entities [@doi:10.1126/science.abc5312].

One of the metrics through which a vaccine's success is measured is efficacy.
The vaccine efficacy (VE) seeks to quantify the extent to which a vaccine protects against the virus during clinical trials [@url:https://www.who.int/news-room/feature-stories/detail/vaccine-efficacy-effectiveness-and-protection].
...
These programs have been undertaken worldwide, in complement to the more cutting-edge approaches in high-income economies like the United States, the European Union, the United Kingdom, and Russia [@individual-vaccines-novel].
...
Finally, Bacillus Calmette-Guerin (BCG) vaccines that use LAVs are being investigated for the prophylaxis of COVID-19 (see Appendix). <!-- What are we doing with the appendix? Are we submitting it with one of the vaccines manuscripts? Should we link the Manubot version? -->
...
This type of vaccines uses full virus particles generally produced via cell culture that have been rendered non-infectious by chemical (i.e., formaldehyde or &beta;-propiolactone [@doi:10.1080/14760584.2017.1357471]) or physical (i.e., heat or ultraviolet radiation) means.
...
The size of the virus particle makes it ideal for uptake by an antigen-presenting cell, which leads to the stimulation of helper T-cells [@doi:10.1038/nri2868].
...
Inactivated vaccines are generally considered the fastest to generate once the pathogenic virus has been isolated and can be passaged in cell culture [@doi:10.3389/fimmu.2020.602256], although this has not been the case for the COVID-19 pandemic. <!-- Why not? This is intereseting. Is it because mRNA is a faster platform now that it exists, or is it something special about SARS-CoV-2? -->
...
<!-- Need to refer to this table in the text somewhere. May make sense to add it to the sentence that refers to the figure to point out how many are distributed and that more are approved (if that is the correct interpretation). -->
...
Results from a two-dose phase III trial following a 14-day prime boost became available in late 2020 [@doi:10/gk898z], and an interim analysis identified specific IgG neutralizing antibodies against the S1 receptor binding domain (RBD) and a robust IFN-&gamma; secreting T cell response was induced via immunization with CoronaVac [@doi:10.1101/2021.03.31.21254494].
CoronaVac was approved for use in China and has been granted emergency use in XX countries, including Brazil, Cambodia, Chile, Colombia, Laos, Malaysia, Mexico, Turkey, Ukraine, and Uruguay [82].<!--Add template variable (still need this, and [82] is hard-coded) -->
...
One, known as BBIBP-CorV or Covilo, was developed in Beijing using the HB02 variant of SARS-CoV-2. <!-- We should make these easier to match to the rows in the table above. The name in the Vaccine column isn't similar to what we have in the text here, so we could add a cross-reference or synonym in the text. -->
...
Preclinical studies indicated that Covilo induced sufficient neutralizing antibody titers in mice, and a prime-boost immunization scheme of 2 &mu;g/dose was sufficient to protect rhesus macaques from disease [@doi:10.1016/j.cell.2020.06.008].
...
Another IWV vaccine comes from India, where Bharat Biotech International Ltd., which is the biggest producer of vaccines globally, collaborated with the Indian Council of Medical Research (ICMR) National Institute of Virology (NIV) to develop Covaxin, also referred to as BBV152.
...
For Covaxin, only mild to moderate side-effects reported upon immunization [@doi:10/gkrthh; @doi:10/gh7597], and in phase II trials, the Covilo vaccine appeared well-tolerated, with 23% of participants in the vaccine condition (482 total participants, 3:1, vaccine:placebo) reporting at least one adverse reaction characterized as mild to moderate [@doi:10/ghjkrf].

However, both CoronaVac and SinoPharm’s inactivated WIV04 vaccine trials were affected by concerns about adverse events.
...
Another preprint determined that sera from individuals immunized with Covaxin had effective neutralizing antibodies against the Delta variant and the so-called Delta plus variant (AY.1) [@doi:10.1101/2021.07.30.454511].
...
Notably, a preprint reported that antisera from 12 people immunized with Covilo exhibited neutralizing antibody capacity against the Beta variant (B.1.351), wild type SARS-CoV-2 (NB02), and one of the original variants of SARS-CoV-2 (D614G) [@doi:10.1101/2021.02.01.429069]. <!-- What is the difference between sera and antisera? -->
Another preprint including sera from 282 participants used a surrogate neutralizing assay, a test that generally correlates with neutralizing antibodies, to determine that Covilo appears to induce neutralizing antibodies against the binding of the RBD of wild type SARS-CoV-2 and the Alpha, Beta, and Delta variants to ACE2 [@doi:10.1101/2021.07.15.21260621].
...
A preprint study of healthcare workers in China has since indicated that a booster shot of Covilo elevates B cell and T cell responses and increases neutralizing antibody titers [@doi:10.1101/2021.09.12.21263373].
In May 2021, the UAE announced it would consider booster shots for all citizens who had been immunized with Covilo, which was shortly followed by a similar announcement in Bahrain, and by August 29^th^, 2021, the UAE mandated booster shots for all residents who had received Covilo [@url:https://www.nytimes.com/interactive/2020/science/coronavirus-vaccine-tracker.html].
...
This platform is also favored for its consistency in production and defined components designed for a highly targeted immune response to a specific pathogen using synthetic immunogenic particles that can be designed to avoid allergen and reactogenic sequences [@doi:10.3390/vaccines2030515]. <!-- It is a little confusing if we are talking about one platform (subunit) or two (subunit and VLP) -->
...
VLP vaccines have not progressed as rapidly: no data was available for worldwide distribution of VLP vaccines as of {{owid_most_recent_date}} [@doi:10.1038/s41562-021-01122-8].
...
In a phase III randomized, observer-blinded, placebo-controlled clinical trial in 14,039 participants, two 5-μg doses of NVX-CoV2373 or placebo were administered 21 days apart in a 1:1 ratio from late September to late November 2020 [@doi:10.1056/nejmoa2107659]. <!-- What was the efficacy or the trial outcome? Not very interesting to report details of the trial without the result. -->
Novavax has since been approved in several places, including the United Kingdom [@url:https://www.gov.uk/government/news/novavax-covid-19-vaccine-nuvaxovid-approved-by-mhra], the E.U. [@url:https://www.ema.europa.eu/en/news/ema-recommends-nuvaxovid-authorisation-eu], and the U.S.A [@url:https://www.fda.gov/news-events/press-announcements/coronavirus-covid-19-update-fda-authorizes-emergency-use-novavax-covid-19-vaccine-adjuvanted] <!-- Need to indicate it is EUA? What have we been doing elsewhere? Deleted the line below about the June FDA vote, the actual EUA didn't come until July. -->.
<!-- Is this still accurate? The URL below is no longer available. Delete? It does not seem essential. -->
...
Participants were recruited from North and South America, as well as the United Kingdom. <!-- Is this needed? We have more detail about this trial than others. -->
...
Additionally, they can be stored at 2 to 8&#176;C.
...
<!-- This figure seems out of place and inconsistent with the text in the Application to COVID-19 section. It should be located near that high-level summary of VLP vaccines, not in the Covifenz section. The text summary also says there is not data available for worldwide distribution, but the map shows the vaccine (Covifenz) in Canada. -->

#### Trial Safety and Efficacy
<!-- Why do we have a separate section on this and on each of the vaccines? This section made sense for the platforms when we didn't have sections on individual vaccines. Should we merge the Nuvaxovid and Covifenz sections into this one? Merge parts of this section into those sections? Keep it as is? I expected to find this information in the vaccine-specific sections above. -->
...
However, the adverse effects reported were generally mild to moderate.
Only three patients (two in the vaccine group) reported grade 4 events, all after the second dose.
The most common adverse effects were injection site pain, headache, myalgia, fatigue, and general discomfort.
...
In the second phase III trial [@doi:10.1101/2021.10.05.21264567], whole-genome sequencing was obtained from 61 of the 77 cases, and 79% of infections were identified as a VOC or VOI that had been characterized at the time of the study. <!-- Haven't defined VOI -->
...
The daily global vaccination rate at this time was {{owid_daily_rate}}. <!-- Check template variable -->
...
However, the initiative has been less successful than was initially hoped. <!-- In what way? The inequities described below? -->
...
As a result, there is a clear relationship between a country's gross domestic product (GDP) and its access to vaccines (Figure @fig:gdp-scatter).
...
See https://greenelab.github.io/covid19-review/ for the most recent version of this figure, which is updated every time the manuscript is regenerated. <!-- In some places we say daily. Should we be more vague? The reality is complex because the figure is daily but the HTML is less regular. -->
...
Still, many African nations are reliant on the COVAX Facility, who have promised 600 million doses to the continent [@url:https://www.bbc.com/news/56100076].
...
As a result, the greater accessibility and stability of these vaccines makes them still valuable at a global level.

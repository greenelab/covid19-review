## The Biological Basis of Social Factors Associated with COVID-19 Exposure and Outcomes
...
However, in understanding this disease, it is also necessary to consider how broader environmental factors can influence COVID-19 outcomes.

Social environmental factors are critical determinants of individual- and community-level risks related to COVID-19.
This is true for many diseases: poverty, racism, and other sources of chronic stress are known to influence a wide range of outcomes...
The concept of biological embodiment describes the way that non-biological social influences like these stressors can alter individuals' biology.
In the case of COVID-19, many of these social factors are also correlated with the likelihood that an individual will be exposed to SARS-CoV-2 in the first place.
As a result, no analysis of the impact or transmission of COVID-19 is complete without consideration of the social factors that shape such outcomes.

In this review, we seek to contextualize the biological implications of chronic social stress caused by poverty and racism and how this biology intersects with the pathogenesis of SARS-CoV-2.
First, we focus on "risk factors" that have been identified for COVID-19.
While the term risk factors implies that they themselves predispose an individual to more severe COVID-19 outcomes, we argue that this is a more nuanced question where the interrelatedness of these factors and their association with poverty and racism must also be considered.
Then, we discuss how the conditions presented by systematic discrimination may predispose some individuals both to exposure to SARS-CoV-2 and to more severe outcomes of the disease it causes.
COVID-19 is so closely linked to inflammation caused by immune stress, and it is absolutely critical to consider other factors that influence inflammation, especially social stressors.
Through this review, the goal is to provide context for interpreting the heterogeneous symptoms associated with COVID-19 (e.g., sepsis), provide insight into how some potential therapeutics (e.g., dexamethasone) might impact some communities differently than others, and persuade the reader that diversity in scientific research and scientific researchers is critical to developing robust strategy for mitigating the damage of COVID-19 in society as a whole. 

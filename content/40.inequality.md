...
The SARS-CoV-2 virus has presented a serious worldwide threat throughout 2020.
...
The biology of the SARS-CoV-2 virus provides critical insight into the spread of the COVID-19 pandemic and the disease's effect on the human body [cite pathogenesis].
However, a complete biological understanding of this disease requires consideration of the ways that environment shapes human biology.
It has become clear in the first year of the pandemic that environmental factors influence COVID-19 outcomes.
Here, we argue that differential exposure to chronic stress influences an individual's biology in ways that intersect with the pathology of COVID-19.
This is why social environmental factors have become critical determinants of individual- and community-level risks related to COVID-19 that must be included in any analysis of pathology or pathogenesis.

The idea that lived experience can shape biology is a principle known as embodiment [@doi:10.1136/jech.2004.024562].
This paradigm seeks to contextualize individual behaviors, environmental exposures, or other lifestyle factors in a broader social context [@doi:10.1136/jech.2004.024562].
...
In cases where ancestry is correlated with environmental exposures, for example, embodiment provides a framework to consider that the causal mechanism may be, in fact, racial discrimination due to social beliefs that are themselves correlated with ancestry [@doi:10.1136/jech.2004.024562].
For example, one analysis examined cardiac health in Puerto Rico in an embodiment framework by comparing social perceptions about skin color with the actual physical properties (i.e., reflectance spectrophotometry) of skin within different communities, revealing that it was the perception, not the physics, that was associated with blood pressure [@doi:10.2105/AJPH.2005.065615].
...
In fact, a basic understanding of human biology makes it clear that racism is far more likely than race to influence COVID-19 outcomes.
Other covariates of racial discrimination such as poverty, incarceration, and other sources of chronic stress are also likely to be relevant.
...
The health risks associated with allostatic load have been well-documented and are etiologically linked to the stress response itself via the limbic-hypothalamic-pituitary-adrenal axis.
...
These health disparities render chronic stress a risk factor on the biological level.
Additionally, they closely echo observations of comorbidities associated with more severe COVID-19 outcomes.

In this review, we seek to contextualize the social factors associated with more severe COVID-19 outcomes, and to explore how the biological implications of allostatic load caused by poverty and racism intersects with the pathogenesis of SARS-CoV-2.
First, we outline the "risk factors" that have been identified for COVID-19.
...
This review seeks to recontextualize the rest of this special issue within the context of embodiment and chronic stress.
...
Significant disparities in outcomes have led to interest in the demographic, biomedical, and social factors associated with increased COVID-19 severity.
...
Importantly, racial discrimination and other sources of social stratification are likely to vary geographically. 
...
The prevalence of these conditions is likely to be exacerbated by chronic stress over the lifetime [@doi:10.1176/appi.ajp.2009.09040461; @doi:10.1001/archinte.1997.00440400111013; @doi:10.1073/pnas.081072698].
Similarly, several hypotheses have been proposed to account for differences in severity between males and females.
...
However, it should be noted that both transgender men and women are suspected to be at heightened risk [@url:https://escholarship.org/uc/item/55t297mc].
Thus, both age and sex are thought to have some intrinsic relationship to risk, but also to be correlated with social factors contributing to risk.

...
It has been shown that as little as 0.1 g/d vitamin C can maintain a normal plasma levels of vitamin C in healthy individuals but that higher doses of at least 1-3 g/d are required for those who are critically ill in ICUs [@doi:10.3390/nu11040708].
...
There is also evidence that individuals are paying attention to their seasonal vitamin D levels, as a survey of polish consumers showed that 56% of respondents used vitamin D during the pandemic [@doi:10.3390/nu13010054].  
...
While there is plenty speculation surrounding the use of supplements by physicians and scientists, this has not stopped consumers from purchasing these products as one study in Poland has reported that searches for dietary supplements trended online at the start of the pandemic. 
Additionally, supplement usage increased between the first and second wave of the pandemic . 
Particpants reported various reasons for their use including to improve immunity (60%), to improve overall health (57%), and to fill nutrient gaps in their diet (53%). 

...
While traditional methods of vaccine development such as inactivated whole viruses are still used today <!--To Do: cite other ms-->, biomedical research in the 21^st^ century has been significantly influenced by the genomic revolution, and vaccine development is no exception.
...
The principle behind DNA vaccines (and all nucleic acid vaccines) is that they can deliver the information needed to construct the antigen to host cells.
Early attempts to develop these vaccines revealed issues with low immunogenicity [@doi:10/dn299p; @doi:10.1046/j.1365-2796.2003.01140.x; @doi:10.3390/ijms19113605; @doi:10.1046/j.1365-2796.2003.01140.x].
...
A number of developments during the 2010s led to greater efficacy of DNA vaccines [@doi:10.1038/nrg2432].
...
Because phase 3 data is not yet available for INO-4800, the VE is not yet know, although the efficacy of ZyCoV-D is estimated at 66.6% [@doi:10/hvqb].
...
While not all of these results were available at the time that vaccine development programs against SARS-CoV-2 began, at least three viral vector vaccines have also been developed against SARS-CoV-2.
...
The two vectors are administered intramuscularly and sequentially, following a prime-boost regimen.

...
This type of vaccine uses a "killed" full viral particle to prime the immune system.
The virus is killed using formaldehyde or &beta;-propiolactone [@doi:10.1080/14760584.2017.1357471].
...
The native conformation of the surface proteins, which is also important for eliciting an immune response, is preserved using this technique.
...
Overall, the vaccine is able to mimic the key properties of the virus that stimulate a robust immune response, but the risk of adverse reactions is reduced because the virus is dead.
Some common successful whole virus vaccine include targeting influenza viruses, poliovirus, and hepatits A virus.
...
Compared to the _inactivated whole virus vaccine_, these protein subunit vaccines isolate a single protein of the virus and use it to stimulate the immune system.
These proteins, also referred to as antigens, are usually those located on the surface of the viral particle and therefore key targets of the immune system.
These proteins are typically grown in yeast and then harvested.
Because the vaccine contains only the purified antigens, the vaccine can only stimulate an antibody response [@doi:10.1007/978-1-4615-1823-5].
The main advantage of this method is that they are considered very safe  since the anteigen alone cannot cause an infection, however the immune response is weaker and usually an adjuvant is needed to boost the response [@doi:10.1517/14712598.2011.573624].

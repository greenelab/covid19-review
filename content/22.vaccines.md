...
As of {{owid_most_recent_date}}, {{owid_inactivated_whole_virus_count}} vaccines developed with inactivated-whole virus technology are being distributed in {{owid_inactivated_whole_virus_countries}} countries (Figure @iwv-distrib).
...
As of {{owid_most_recent_date}}, {{owid_non_replicating_viral_vector_count}} viral-vectored vaccines are being distributed in {{owid_non_replicating_viral_vector_countries}} countries (Figure @fig:nrvv_distrib).

...
Live-attenuated vaccines (LAV) or replication-competent vaccines use a weakened living version of a disease-causing virus or a version of a virus that is similar to induce an immune response [@doi:10.1038/s41586-020-2798-3]. 
The virus can be attenuated by passinging it in a foreign host, until as a consequence of selection pressure the virus loses its efficacy in the original host. 
...
It is generally recognized that LAVs induce an immune response that is similar to natural infection and are favoured because they induce long-lasting and robust immunity that can protect from disease. 
This is in part as a result of the immune response to the range of viral antigens available that tend to be more immunogenic than those from non-replicating vaccines [@url:https://www.hhs.gov/immunization/basics/types/index.html; @doi:10.1016/j.virol.2015.03.032; @doi:10.3389/fimmu.2020.602256]. 
LAVs are also favoured because they tend to be restricted to viral replication in the tissues around the location of inoculation [@doi:10.1128/9781555818951] and some can be administered intranasally [@doi:10.1038/s41586-020-2798-3]. 

The first deliberate attempt to utilize an attenuated viral vaccine dates back to Louis Pasteur in 1885, despite not knowing that the disease-causing agent he was experimenting with was a virus. 
...
Previously, there have been numerous attempts to develop both SARS-CoV and MERS-CoV LAVs [@doi:10.3389/fimmu.2020.602256], but no vaccine has been approved for use in humans.
Nowadays, the manufacture of LAVs use safe and reliable methods to produce large quantities of vaccines once they have undergone rigorous pre-clinical studies and clinical trials to evaluate their safety and efficacy.
...
In april 2020, it was announced that the Indian Immunologicals Ltd. and Griffith University Australia had partnered to develop codon de-optimized LAV [@url:https://news.griffith.edu.au/2020/04/23/griffith-university-researchers-on-the-road-to-covid-19-vaccine/], however, there has been no updates on the findings of their preclinical testing. 
Another codon de-optimized LAV is being developed by Mehmet Ali Aydinlar University and Acibadem Labmed Health Services A.S., which also has yet to report the findings of its preclinical tests [@url:https://covid-19tracker.milkeninstitute.org/#vaccines_intro].
...
COVI-VAC entered phase I human trials and dosed its first participants in January 2021 [04619628][@url:https://covid-19tracker.milkeninstitute.org/#vaccines_intro].  
It is anticipated that the COVI-VAC phase I human trials will be complete by May 2022.
Similarly,  Meissa vaccines in Kansas in the U.S., who also develop vaccines for respiratory syncytial virus (RSV), began enrollment for its phase I human trials on its intranasal live-attenuated chimeric vaccine candidate in March 2021, but they are still recruiting participants [@clinicaltrials:NCT04798001][@url:https://covid-19tracker.milkeninstitute.org/#vaccines_intro].

Despite the long and trusted history of LAV development, this vaccine strategy does not appear to be favoured for vaccine development against COVID-19.
Modern technologies such as mRNA vaccines and vectored vaccines seem to have been favoured due to their expediency and safety versus the time consuming nature of developing LAVs using a novel virus.  

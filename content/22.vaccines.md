...
The past 150 years have seen a rapid diversification in the approaches available for the development of new vaccines [@doi:10.1073/pnas.1400472111].
...
Since the turn of the millenium, Severe acute respiratory syndrome (SARS), "swine flu" (H1N1), Middle East respiratory syndrome (MERS), and Ebola virus disease (EVD) have all underscored the importance of a rapid global response to a new infectious virus.
However, the vaccine development process has historically been slow, and because vaccines fail to provide immediate prophylactic protection or to treat ongoing infections, their application to most of these epidemics has been limited [@doi:10.3390/v10120680].
...
Another major development came in the 1980s as genetic research became increasingly feasible.
...
However, advances in genetic engineering and omics led to the emergence of vaccine development projects utilizing information available in the genome sequence of viral pathogens (Figure @fig:vaccines).
This paradigm has been termed reverse vaccinology because of the emphasis on a hypothesis-free, genome-mining approach to vaccine development [@doi:10.3389/fimmu.2019.02776].
The shift towards omics-based appraoches to vaccine development began to take hold with the development of the meningococcal type B vaccine using reverse vaccinology in the early 2010s [@doi:10.7774/cevr.2014.3.1.1; @doi:10.1111/j.1469-0691.2012.03939.x].
In this way, the Genomic Revolution catalyzed a fundamental shift in the development of vaccines.

The availability of genome sequencing information has shifted vaccine in other ways, as well.
Current methods in vaccine development can be framed in terms of the central dogma of genetics: instead of directly providing the proteins from the infectious agents, vaccines developers are exploring the potential for the delivery of DNA or RNA to induce the cell to produce proteins from the virus that in turn induce a host immune response.
...
The genome of a pathogen is screened to identify potential vaccine targets [@doi:10.1111/j.1469-0691.2012.03939.x], and pathogens of interest are then expressed _in vitro_ and tested in animal models to determine their immunogenicity [@doi:10.1111/j.1469-0691.2012.03939.x]. 
...
One way to achieve this is to deliver antigen information to host cells using DNA.
...
Initially, concerns were raised that DNA vaccines might bind to the host genome or induce autoimmune disease [@doi:10.1358/dot.2018.54.5.2807864; @doi:10.1038/nrg2432], but pre-clinical and clinical studies have consistently found DNA vaccines to be safe [@doi:10.3390/ijms19113605].
Despite major steps forward in the development of DNA vaccine technology, no DNA vaccines have been approved for use in humans [@doi:10.3390/ijms19113605; @doi:10.3390/pharmaceutics12010030], but veterinary DNA vaccines have been on the market since XXXX.

As of the 2010s, mRNA was still considered a promising technology for future advances in vaccine development [@doi:10.4161/rna.22269].
...
The development of a vaccine for the Zika virus demonstrated the potential for this technology to facilitate a response to emerging viral threats [@doi:10.1016/j.micinf.2018.03.001].

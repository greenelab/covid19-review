...
Technologies such as inactivated viruses and recombinant vector-based vaccines were explored for SARS [@doi:10.3201/eid1107.050219], although the epidemic was controlled before a vaccine became available.
A few years later, vaccine development against H1N1 influenza was accelerated because of the existing infrastructure, along with the fact that regulatory agencies had already decided that vaccines produced using egg- and cell-based platforms could be licensed under the regulations used for a strain change.

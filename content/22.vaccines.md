...
As of {{owid_most_recent_date}}, {{viper_vaccine_counts}} have been approved world wide and {{owid_vaccine_counts}} SARS-CoV-2 vaccines are being administered throughout the world, with {{owid_total_vaccinations}} doses administered across {{owid_total_countries}} countries.
...
As of {{owid_most_recent_date}}, {{owid_count}} vaccines developed with inactivated-whole virus technology are being distributed in {{owid_countries}} countries (Figure @fig:iwv-distrib).

...
Gamaleya is an organization with prior experience using the adenovirus platform for the development of vaccines for the Middle East respiratory system and Ebola virus, although neither of the previous vaccines were internationally licensed [@url:https://www.who.int/immunization/sage/meetings/2018/october/2_Ebola_SAGE2018Oct_BgDoc_20180919.pdf].
The development of Sputnik V was financed by the Russian Direct Investment Fund [@doi:ft7j; @doi:ghs3sn]. 
Sputnik V is a replication deficient recombinant adenovirus vaccine that combines two adenovirus vectors rAd26-S and rAd5-S that express the full-length SARS-CoV-2 spike glycoprotein. 
However, these vectors are intramuscularly administered individually using two separate vaccines in a prime-boost regimen. 
The rAd26-S is administered first, followed by rAd5-S 21 days later.
Both vaccines deliver 10^11^ viral particles per dose. 
This approach is designed to overcome any potential pre-existing immunity to adenovirus in the population [@doi:10.1016/S0140-6736(21)00191-4] as some individuals may possess immunity to Ad5 [@doi:10.1016/j.vaccine.2011.05.025].
Sputnik V is the only recombinant adenovirus vaccine to utilize two vectors, unlike other vaccines such as the Oxford-AstraZeneca vaccine, which utilizes the chimpanzee adenovirus vector (ChAdOx1 nCoV-19) for both doses [@doi:ghpghz].
The Sputnik V vaccines are available in both a lyophilized (Gam-COVID-Vac-Lyo) and frozen form (Gan-COVID-Vac), which are stored at 2-8°C and -18°C respectively [@doi:gg96hq]. 
...
In the race to develop vaccines against SARS-CoV-2, President Vladimir Putin of Russia announced the approval of the Sputnik V vaccines on August 11th 2020 in the absence of clinical evidence [@doi:ft7j]. 
Consequently, many international scientific agencies and public health bodies expressed concern because due diligence to the clinical trial process was subverted for the sake of expediency leading many to question the safety and efficacy of Sputnik V [@doi:10.1126/science.abe3147; @url:https://www.cnbc.com/2020/08/11/scientists-worry-whether-russias-sputnik-v-coronavirus-vaccine-is-safe-and-effective.html; @doi:ft7j].
Despite regulatory, safety, and efficacy concerns, pre-orders for 1 billion doses of the Sputnik V were reported within days of the vaccine's approval in Russia [@doi:ft7j].
Almost a month later, the phase I/II trial data was published [@doi:gg96hq].

In the phase I/II trial study conducted between late June and early August 2020, 76 participants (18-60 years old) were split into two groups of 38 participants, which were non-randomised in two hospitals in Russia. 
In phase I, 9 patients received rAd26 and 9 patients received rAd5-S to assess safety over 28 days. 
In phase II, at least 5 days post the completion of phase I, 20 patients received a prime-boost vaccination of rAd26-S on day 0 and rAd5-S on day 2, which was administered intramuscularly.
The phase I/II trial reported that both vaccines were deemed safe and well tolerated. 
The most common adverse events reported were mild with pain at the injection site (58%), hypothermia (50%), headaches (42%), fatigue (28%), and joint and muscle pain (24%). 
...
Receptor binding domain-specific IgG were high (14,703 and 11,143 respectively), indicating a sufficient immune response from both the frozen and lyophilized versions of the vaccine. 
...
These results indicated that both forms of Sputnik V appeared to be safe and induce a humoral and cellular response to the vaccines [@doi:gg96hq], which may be robust enough to subsist and not wane rapidly [@doi:ghx7xz]. 

A press release on November 11th reported positive results from an interim analysis of the phase III Sputnik V trials, which reported 92% efficacy in 16,000 volunteers [@doi:10.1126/science.abf6791].
However, this was only two days after both Pfizer and BioNTech reported that their vaccines had an efficacy over 90%, which led to significant speculation about the Russian findings for a myriad of reasons including the lack of a published protocol and the “reckless” approval of the vaccine in Russia months prior to the publication of the interim results of the phase III trial [@doi:10.1126/science.abf6791; @doi:10.1038/d41586-020-03209-0].
In February 2021, the interim results of the phase III randomized, double-blind, placebo-controlled trial were eventually published in the _Lancet_ [@doi:ghxj4g].
The multicenter trial enrolled 21,862 participants over the age of 18 years old in Moscow, Russia. 
The participants were randomly assigned to receive either a 0.5 mL/dose of vaccine or placebo (vaccine buffer composition) intramuscularly using the same prime-boost regimen as the phase I/II trials. 
From September 7th to Nov 24th, 19,866 completed the trial.
Of the 14,964 participants who received the vaccine, 16 (0.1%) were confirmed to have COVID-19.
Whereas 62 of the 4,902 participants (1.3%) in the placebo group were confirmed to have COVID-19. 
...
Therefore, asymptomatic infections were not detected, thus potentially inflating the efficacy data.
...
Hence, scientists are investigating a single dose regimen of the rAd26-S sputnik V vaccine [@doi:10.1136/bmj.n309].
...
Likewise, 4 deaths occurred during the trial period that were not related to the vaccine [@doi:ghxj4g].
The interim findings of the phase III trial indicates that the Sputnik V vaccine regimen appears to be safe with 91.6% efficacy.
Moving forward, Gambelaya intends to reach a total of 40,000 participants for the completion of their phase III trial.  
...
Preliminary results of a trial of Argentinian healthcare workers in Buenos Aires who were vaccinated with the Sputnik V rAd26-R vector-based vaccine seems to support the short term safety of the first vaccination [https://doi.org/10.1101/2021.02.03.21251071]. 
...
There may be some advantage to the Sputnik V approach including the favourable storage conditions afforded by choice between a frozen and lyophilized vaccine. 

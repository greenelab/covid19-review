...
Today, XX vaccines developed with inactivated-whole virus technology have been distributed in XX countries (Figure @iwv-distrib).
...
As of {{owid_most_recent_date}}, XX protein subunit vaccines are available in XX countries (Figure @fig:ps_distrib).
...
As of {{owid_most_recent_date}}, XX viral-vectored vaccines are available in XX countries (Figure @fig:nrvv_distrib).
...
As of {{owid_most_recent_date}}, XX mRNA vaccines are available in XX countries (Figure @fig:mRNA_distrib).

...
Thus, vaccines that use this prefusion stabilized conformation, including the Janssen viral-vector vaccine as well as the Moderna and Pfizer/BioNTech mRNA vaccines, are expected to not only offer improved immunogenicity, but also be more resilient to the accumulation of mutations in SARS-CoV-2.

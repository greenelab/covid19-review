...
Summary of preclinical trials using macaques: https://pubmed.ncbi.nlm.nih.gov/32376603/
Pre-clinical trials were performed using BALB/c mice and macaques in --> Date [@doi:10.1126/science.abc1932].
...
____ assay was used to assess the immunogenicity of the vaccine.
10 mice we injected with the vaccine on day 0 and day 7 with varying doses (0, 1.5, 3 or 6 micrograms).
How many replicates of the dose?
What is the control?
What is being measured? 
antibody binding to challenged virus using ELISA at 1 through 6 weeks after immunization

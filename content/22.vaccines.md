...
### Vaccines, Pathogenesis, and Public Health

The clinical trial data surrounding these vaccines conclusively demonstrates that they reduce the likelihood of contracting symptomatic COVID-19.
Therefore, the data clearly demonstrates an exceptional benefit to patients receiving the vaccine.
However, given that vaccination rates are not 100%, another concern is whether vaccinated individuals can still spread SARS-CoV-2 even if they do not develop symptoms of COVID-19.
Because many clinical trials assessed vaccine efficacy based on COVID-19 diagnosis, rather than routine PCR testing, the first component of this question is how likely vaccinated individuals are to contract asymptomatic COVID-19.<!-- To Do: Draw pyramid of risk with and without vaccines? possibly tag LDA to review due to her tweets about baserates-->
Routine testing of healthcare workers in California who had received an mRNA vaccine reported slightly higher rates of absolute risk for testing positive than those identified in the phase 3 trials, although the extent to which asymptomatic infection influenced these numbers was not assessed [@doi:10.1056/NEJMc2101927].
Another study analyzed the results of preprocedure COVID-19 screening tests administered to individuals prior to receiving certain medical services at the Mayo Clinic in several locations across the United States.
They found patients who had received two doses to be 73% less likely to have asymptomatic COVID-19 than patients who had recieved zero doses [@doi:10.1093/cid/ciab229/6167855].
Because this study began on December 17, 2020, a date selected to coincide with the first day vaccines were available at the Mayo Clinic, this number may be somewhat artifically low given that people eligible for early vaccination were at increased risk for exposure [@doi:10.1093/cid/ciab229/6167855].

An ongoing topic of concern is that evolution of SARS-CoV-2 can influence vaccine efficacy.
...
Among these participants, 3179 (80%) had received at least one dose of an mRNA vaccine and 2,686 (84%) were fully vaccinated.
...
Another is whether vaccinated individuals positive for SARS-CoV-2 carry a similar viral load to unvaccinated individuals.
The prospective cohort study that evaluated frontline workers in six U.S. states reported a 40% reduction in viral load even with just a single vaccine dose [@doi:10.1056/nejmoa2107058].
Additionally, the risk of having detectable levels of SARS-CoV-2 for more than one week was reduced by 66% in participants who had received at least one dose.

One preprint [@doi:10.1101/2021.07.28.21261295] reported analyzed a retrospective cohort of patients in Singapore who contracted COVID-19 in April to June of 2021, focusing on those who were confirmed or inferred to have been infected by the Delta variant of concern and aiming to analyze virological kinetics.
...
Unvaccinated patients were more likely to be symptomatic or to progress to severe COVID-19 and showwed more symptoms than vaccinated patient, despite higher age in the vaccinated cohort.
...
There was no significant difference in median C~t~ in the initial samples taken from fully vaccinated and unvaccinated patients, but C~t~ decreased more rapidly in fully vaccinated patients.
Becuase these samples were not cultured, conclusions cannot be drawn directly about contagiousness, but these findings suggest that vaccinated individuals may be able to clear the infection more quickly. 
Because of rigorous practices in Singapore for screening individuals with potential COVID-19 exposure, this study is likely to have evaluated a more accurate representation of all COVID-19 outcomes than studies in other countries.

While one of the limitations of the above study was the RT-PCR reactions were conducted in many different facilities, another study investigated viral load (as approximated by C~t~) for samples processed in a single laboratory.
This analysis was based in a county of Wisconsin, USA during summer 2021, when the Delta variant was known to be the dominant variant in the region [@doi:10.1101/2021.07.31.21261387].
According to Our World in Data, at the beginning of the study, 49.3% of residents of Dane County were fully vaccinated, with this number rising to 51.4% by the end of the study <!--To do: cite OWID-->, although the preprint reports the vaccination rate in Dane County as 67.4%.
...
Unlike the prior study, this study was not longitudinal, but the timing of testing relative to symptom onset between symptomatic vaccinated and unvaccinated patients.
...
Finally, the intersection between these two concerns raises the question of how vaccination status plays into community spread.
The viral kinetics of infection suggest that vaccinated individuals would be less likely to infect others over time because viral load decreases more rapidly than in unvaccinated individuals, although this study was not able to evaluate patterns in secondary transmission [@doi:10.1101/2021.07.28.21261295].
The potential for vaccinated individuals to spread SARS-CoV-2 was supported by a second study that cultured a subset of samples [@doi:10.1101/2021.07.31.21261387].
Thus, the virological evidence suggests that public health measures such as masking and distancing are important even in areas with high vaccination rates.

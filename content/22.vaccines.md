...
These diverse technology platforms use technology built on live-attenuated viruses, inactivated whole viruses, protein subunits, replicating and non-replicating viral vectors, and RNA <!--virus-like particle, recombinant protein--> approaches to inducing an immune response (Figure @fig:vaccines).
...
The types of vaccines and specific vaccine candidates are continuing to evolve.

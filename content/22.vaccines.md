...
Interest in the potential to develop vaccines based on DNA emerged in the early 1990s when studies found that animal models could be induced to construct antigens that would trigger an immune response [@doi:10/dn299p; @doi:10.1001/jama.1994.03510360055036].
...
However, early attempts to develop vaccines based on DNA revealed that they translated poorly to humans due to low immunogenicity [@doi:10/dn299p].
<!--Why did it take so long for mRNA vaccines?-->
As a result, these technologies were not used for 20^th^ century vaccines.
...
Building on the advances in vaccine development that came out of genetic engineering, several newer approaches to vaccine development today utilize information available in the genome sequence of viral pathogens (Figure @fig:vaccines).
Specifically, omics-based technologies represent a major shift in the development of vaccines.

The first advances made were in DNA vaccines with initial successes coming through the approach of reverse vaccinology [@doi:10.1111/j.1469-0691.2012.03939.x].
In reverse vaccinology, the genome of a pathogen is screened to identify potential vaccine targets [@doi:10.1111/j.1469-0691.2012.03939.x].
Next, pathogens of interest are expressed _in vitro_ and tested in animal models to determine their immunogenicity [@doi:10.1111/j.1469-0691.2012.03939.x]. 
The shift towards omics-based vaccine began to take hold with the development of the meningococcal type B vaccine using reverse vaccinology in the early 2010s [@doi:10.7774/cevr.2014.3.1.1; @doi:10.1111/j.1469-0691.2012.03939.x].
the sequence encoding the antigen(s) against which an immune response is sought can be cultivated in a plasmid and delivered directly to an appropriate tissue [@url:https://www.who.int/biologicals/areas/vaccines/dna/en/].
...
These two approaches are based on a similar underlying principle: utilizing a vector to deliver the information the host needs to produce an antigen, which in turn triggers an immune response to the antigen without introducing an infectious agent.
...
As of 2012, mRNA was still considered a promising but nascent vaccine technology [@doi:10.4161/rna.22269].

...
Possible public health intervention types for prevention and control in general include: diagnostics, data gathering, pharmaceutical treatment, pharmaceutical prophylaxis, vaccines, and non-pharmaceutical measures such as social distancing, hand hygiene, cough/sneeze hygiene or practices, contact tracing, isolation, for particularly severe pandemics sometimes the use of different types of facemasks as useful and sometimes measures for reduction of contacts, and personal protective equipment for health workers [@ISBN:978-92-4-156553-0].

...
Finally, Manubot and GitHub allowed for scripted updates to be run each time the manuscript was generated.
These scripts were used to check that the manuscript was built correctly, run spellchecking, and cross-reference manuscripts cited in this review, summarized in Appendix A, discussed in the project's issues and pull requests.

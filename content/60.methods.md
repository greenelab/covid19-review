...
The scientific community responded by turning significant attention and resources towards COVID-19 and the associated virus, SARS-CoV-2.
The result has been the release of data and publications at a rate and scale never previously seen for a single topic.
Over 20,000 articles about COVID-19 were released in the first four months of the pandemic [@doi:10.1053/j.ackd.2020.08.003], leading to an "infodemic" [@doi:10.1053/j.ackd.2020.08.003; @doi:10/ggpx67].
The COVID-19 Open Research Dataset (CORD-19) [@arxiv:2004.10706], which was developed in part with the goal of training machine learning algorithms on COVID-19-related text, illustrates the growth of scholarly literature related to the virus (Figure @fig:cord19-growth).
...
The number of articles has proliferated (left), with both traditionally published and preprint manuscripts in the corpus (right).
The first release, on March 16, 2020, contained 28,000 manuscripts [@arxiv:2004.10706].
...
With information being released rapidly by both traditional publishing venues and preprint servers, many papers have faced scrutiny after their initial release.
The number of COVID-19 papers being retracted may be higher, and potentially much higher, than is typical, although a thorough investigation of this question will not be possible until more time has elapsed [@doi:10.1080/08989621.2020.1782203; @doi:10.1080/08989621.2020.1793675].
Other papers are updated with corrections or expressions of concern^[See also https://retractionwatch.com/retracted-coronavirus-covid-19-papers] [@doi:10.1080/08989621.2020.1793675].
...
However, some traditional publishing venues have also fast-tracked COVID-19 through peer review, leading to questions about whether this research is being held to the usual standards [@doi:10.1111/bioe.12772].
Therefore, monitoring the COVID-19 literature requires not only digesting the information released but also critically evaluating it and monitoring subsequent changes.
...
Unlike prior collaborations built on Manubot, most contributors to the COVID-19 collaborative literature review came from biological science or medical backgrounds.
...
A preliminary requirement for this undertaking was to establish Manubot as a platform accessible to researchers with limited experience working with git given that version control is not typically emphasized in biology and medicine [@doi:10.1109/SE4Science.2017.11; @doi:10.1177/2515245918754826; @doi:10.1186/1751-0473-8-7].
...
This extension enables citing a trial as `@clinicaltrials:NCT04280705` instead of using the URL. 
...
The comment reported both unique misspelled words and all locations where the token was detected.
...
Though only a fraction of potential contributors ended up contributing to the text included in the manuscripts (Figure @fig:projectstats), many of these contributors remained engaged over the course of a full year (Figure @fig:projectdots).
...
The figure does not depict other types of author contributions such as literature summarization, pull request review, visualization, and software.
...
(Figure @fig:cord19-growth) dynamically integrates data directly from the CORD-19 dataset [@arxiv:2004.10706].
...
In the case of the seven manuscripts produced by the COVID-19 Review Consortium, Manubot will allow for continuous updating of the manuscripts as the pandemic enters its second year and the landscape shifts with the emergence of promising therapeutics and vaccines [@individual-pharmaceuticals].

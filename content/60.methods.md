...
Over 20,000 articles about COVID-19 were released in the first four months of the pandemic [@doi:10.1053/j.ackd.2020.08.003], leading to an associated "infodemic" [@doi:10.1053/j.ackd.2020.08.003; @doi:10/ggpx67].
...
The number of article has proliferated (left), with both traditionally published and preprint manuscripts in the corpus (right).
...
To address this concern, Manubot and GitHub's CI features were used to create figures that integrated online data sources to respond to changes in the COVID-19 pandemic over time (Figure @fig:manubot-workflow).

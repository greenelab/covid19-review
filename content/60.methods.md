## An Open-Publishing Response to an Infodemic
...
Therefore, this problem lends itself well to a crowd-sourced approach to writing through open collaboration.
While typically such efforts might rely on WYSIWYG tools such as Google Docs, recent advances in open publishing have created an infrastructure that facilitates distributed, version-controlled collaboration on manuscripts [@doi:10.1371/journal.pcbi.1007128].
...
This approach required three main tenets.
The first was community building across disciplines and across career stages.
...
<!--To Do: Add in description of efforts to develop 
...
The third was the use of continuous integration to create a codebase that was responsive to changes in the COVID-19 pandemic over time.
When scientific writers added text that was true as of a given date, we were often able to 
...
<!--To Do: Add a graph of unique contributors & commits over time-->

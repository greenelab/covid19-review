...
Using an approach that hinged on these tools is likely to have biased our contributors towards those who were interested in or experienced with computational tools.
...
Future work can continue to advance Manubot as an inclusive tool for open publishing projects.


However, while some of the challenges we encountered could be remedied by adding functionalities to Manubot, others are more general challenges of massively open online papers.

...
Other researchers has identified the same need [@url:https://forums.zotero.org/discussion/74933/import-from-clinical-trials-registry; @url:https://forums.zotero.org/discussion/77721/add-reference-from-clinical-trials-org].
...
<!-- To Do: Only say "we extended Manubot" if dhimmel is included as an author -->
...
Manubot users can write in the simple markdown format, render the manuscript in regularly-updated pdf or interactive HTML formats, and export the manuscript in docx or tex and BibTeX for submission to traditional publishers, taking full advantage of Pandoc's powerful document conversion capabilities.

...
The workflow uses the GitHub API to detect and save the latest commit of the external data sources that are GitHub repositories ([@url:https://github.com/owid/covid-19-data; https://github.com/ebmdatalab/covid_trials_tracker-covid; @url:https://github.com/CSSEGISandData/COVID-19]).

...
The scite badges were enabled in the HTML build of the document.
...
In this project, where we were disseminating rapidly evolving information of great consequence from over a thousand different sources, this feature offered the invaluable function of streamlining the identification of references that needed to be double checked as time passed from when they were added.

...
As of {{stats_clean_date}}, there were {{stats_num_authors}} authors (including consortia), {{stats_num_references}} references, and {{stats_num_words}} words in the documents that make up the project.
...
As of April 30, 2021, there were 1,428 references (Figure @fig:projectstats).<!--To Do: automate-->

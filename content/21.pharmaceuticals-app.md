...
However, this study was retracted in November 2021 due to concerns about the data.
A third trial of 60 patients reported a significant effect of favipiravir on viral clearance at four days (a secondary endpoint), but not at 10 days (the primary endpoint) [@doi:10.1093/cid/ciaa1176].
...
The double-blind placebo-controlled ACTT-1 trial [@doi:10.1056/NEJMoa2007764; @clinicaltrials:NCT04280705] recruited 1,062 patients and randomly assigned them to placebo treatment or treatment with remdesivir.
...
CQ and hydroxychloroquine (HCQ) increase cellular pH by accumulating in their protonated form inside lysosomes [@doi:10.1186/1743-422X-8-163; @doi:10.1111/j.1529-8019.2007.00131.x].
...
COVID-19-related mortality was not affected by HCQ in the RECOVERY trial (rate ratio, 1.09; 95% CI, 0.97 to 1.23; _p_ = 0.15), but cardiac events were increased in the HCQ arm (0.4 percentage points), as was the duration of hospitalization (rate ratio for discharge alive within 28 days: 0.90; 95% CI, 0.83 to 0.98) and likelihood of progression to mechanical ventilation or death (risk ratio 1.14; 95% CI, 1.03 to 1.27).

...
COVID-19 is associated with symptoms ranging from none (asymptomatic) to mild to severe, with approximately 2% of patients dying from COVID-19-related complications, such as acute respiratory disease syndrome (ARDS) <!--TO DO: cite pathogenesis preprint-->.
...
In fact, genome sequencing quickly reveleaed the virus causing COVID-19 to be a novel betacoronavirus closely related to SARS-CoV-1 @doi:10.46234/ccdcw2020.017].
...
SARS infection is severe, with an estimated death rate of 9.5% [@doi:10.1093/ajcp/aqaa029], while estimates of the death rate associated with COVID-19 are much lower, at approximately 2%<!-- TO DO: cite pathogenesis-->.
...
SARS-CoV-2 also appears to be spread primarily by droplet transmission [@doi:10.1001/jama.2020.12458; @doi:10/gg6br7], and most estimates of its R~0~ fall between 2.5 and 3<!--TO DO: cite pathogenesis-->.
...
In contrast, MERS is still circulating and remains a concern; however, although the fatality rate is very high at almost 35%, the disease is much less easily transmitted, as its R~0~ has been estimated to be 1 [@doi:10.1093/ajcp/aqaa029].
...
Additionally, a smaller analysis of 598 patients, of whom two-thirds were randomized to receive remdesivir for either 5 or 10 days, reported a small effect of treatment with remdesivir for five days relative to standard of care in patients with moderate COVID-19 [@doi:10.1001/jama.2020.16349]; these results therefore suggest that remdesivir could improve outcomes for patients with moderate COVID-19, but that additional information would be needed to understand the effects of different durations of treatment.
...
Additional research has emerged largely indentifying HCQ/CQ to be ineffective against COVID-19 while simultaneously revealing a number of significant side effects.
...
However, in line with the results from therapeutic studies, once again HCQ no evidence was found suggesting an effect of HCQ against COVID-19.

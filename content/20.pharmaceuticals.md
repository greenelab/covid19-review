...
|-----------|----------|-----------------|--------------------|-------------------------|
| Favipiravir | Small molecule, antiviral, nucleoside analog | None | RCT | Not supported | 
| Remdesivir | Small molecule, antiviral, adenosine analog | Approved (and EUA for combination with baricitinib) | RCT | Conflicting evidence from Solidarity vs other trials |
| N3 | Small molecule, protease inhibitor | None | Computational prediction | Unknown |
| ARBs & ACEIs | Small molecule, broad spectrum | None | RCT | Not supported |
| HCQ/CQ | Small molecule, broad spectrum | None | RCT  | Not supported, possibly harmful |
| Dexamethasone | Small molecule, broad spectrum | Used off-label | RCT | Supported |
| Tocilizumab | Biologic, monoclonal antibody | Approved for CRS | RCT | Supported |
...
| SNG001 | Biologic, interferon | None | RCT | Likely not supported |

Table: Summary table of candidate therapeutics examined in this manuscript. The FDA status is provided where available. The evidence available is based on the progression of the therapeutic through the pharmaceutical develoment pipeline, with randomized control trials (RCT) as the most informative source of evidence. The effectiveness is summarized based on the current available evidence; large trials such as RECOVERY and Solidarity are weighted heavily in this summary. {#tbl:summary-table}

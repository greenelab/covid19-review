...
Unlike in the current pandemic, both of these previous epidemics were controlled fairly rapidly through public health measures.
However, the body of research investigating severe acute respiratory syndrome (SARS) and Middle East respiratory syndrome (MERS) has proven valuable for identifying approaches to treating and preventing novel coronavirus disease 2019 (COVID-19).
...
As of {{csse_date_pretty}}, {{csse_deaths}} COVID-19 deaths had been reported worldwide since January 22, 2020 (Figure @fig:csse-deaths).
In contrast, a total of XX cases and XX deaths were reported for SARS from March 17, 2003 onwards.
...
In contrast, SARS-CoV-2 remains a significant global threat.
...
SARS-CoV-2 also appears to be spread by droplet transmission [@doi:10.1001/jama.2020.12458; @doi:10/gg6br7] and may be airborne [@doi:10/gjqmvq; @doi:10.1136/bmj.n913].
...
The goal of the former is to reduce the severity and risks of an active infection, while for the latter, it is to inhibit the replication of a virus once an individual is infected, potentially freezing disease progression.
...
Both approaches have proven to be important sources of information to the development of a rapid response to the COVID-19 crisis, but as the pandemic draws on and more results become available from randomized controlled trials, more definitive answers are becoming available about proposed therapeutics.
...
<!-- To Do: Increase size of figure in y direction and see if it makes y-axis more legible for panel D-->
![
...
### Clinical Response and Small Molecule Drug Repurposing
...
Therapeutics to treat severe cases of COVID-19 are urgently needed, and identifying strategies for treating patients is a priority for clinicians.
...
These on-the-ground treatment strategies could later be analyzed retrospectively in observational studies or investigated in an interventional paradigm through randomized control studies.
...
Such treatments do not specifically target a virus or particular host receptor, but rather induce broad shifts in host biology that are hypothesized to be potential inhibitors of the virus.
...
In addition to non-pharmaceutical interventions such as encouraging non-intubated patients to adopt a prone position [@doi:10.1001/jamainternmed.2020.3030], knowledge about interactions between HCoV and the human body, many of which emerged from SARS and MERS research over the past two decades, led to the suggestion that a number of common drugs might benefit COVID-19 patients.
...
#### Treatments Used for SARS and MERS

Care for SARS and MERS patients prioritized supportive care and symptom management [@doi:10.1093/ajcp/aqaa029], as interest in the possible utility of antivirals and monoclonal antibodies to reduce infection was never realized [@doi:10.1093/infdis/jiw080; @doi:10.1016/j.antiviral.2017.03.025].
...
However, a second strategy adopted from prior HCoV outbreaks is currently the best-known treatment for severe cases of COVID-19.
...
Guidelines were quickly updated to encourage the use of dexamethasone in severe cases [@doi:10.1001/jama.2020.16747], and this affordable and widely available treatment rapidly became a valuable tool against COVID-19, with demand surging within days of the preprint's release [@doi:10.1136/bmj.m2512].
In the months since, dexamethasone has become a valuable tool in the treatment of severe COVID-19 [@doi:10.1016/j.ejphar.2021.173854].

#### Treatments Identified from Clinical Practice

Some of the most widely publicized examples of efforts to repurpose drugs for COVID-19 are broad-spectrum, small-molecule drugs where the mechanism of action made it seem that the drug might target SARS-CoV-2.
...
### Small-Molecule Drugs Targeting Viral Structure
...
Though initial analyses of favipiravir in observational studies of its effects on COVID-19 patients were promising, recent results of two small randomized control trials suggest that it is unlikely to affect COVID-19 outcomes (Appendix A).

In contrast, another nucleoside analog, remdesivir, is one of the few treatments that has received FDA approval.
...
However, the relative successes of remdesivir and favipiravir underscores the fact that drugs with similar mechanisms will not always produce similar results in clinical trials.
...
This body of knowledge provides a theoretical basis for identifying candidate biologics.
...
This class includes significant medical breakthroughs such as insulin for the management of diabetes and the smallpox vaccine.
Biologics thereby offer an important avenue through which the pharmacological management of SARS-CoV-2 infection can be approached.
...
TCZ is a monoclonal receptor antibody that was developed to manage chronic inflammation caused by the continuous synthesis of the cytokine IL-6 [@doi:10.1101/cshperspect.a016295].
...
It wasn't until February 11, 2021 that a preprint describing preliminary results of the first randomized control trial of TCZ was released as part of the RECOVERY trial [@doi:10.1101/2021.02.11.21249258].
TCZ was found to reduce 28-day mortality from 33% in patients receiving SOC alone to 29% in those receiving TCZ.
Combined analysis of the RECOVERY trial data with data from smaller randomized control trials suggested a 13% reduction in 28-day mortalit [@doi:10.1101/2021.02.11.21249258].
While this initial report did not include the full results expected from the RECOVERY trial, this large-scale, randomized controlled trial therefore offers strong evidence that TCZ may offer benefits for COVID-19 patients.
...
mAbs are, once again, an example of how scientific advances during the SARS epidemic played a role in shaping the scientific response to COVID-19.
...
Thus, the development of mAbs against SARS-CoV-2 has made it clear that this technology is rapidly adaptable and offers great potential for the response to emerging viral threats.
...
All four utilize existing bodies of knowledge in different ways.
The first builds on clinical experience gained treating related diseases or related symptoms and allows for a rapid response aimed at saving the lives of patients already infected with a new disease.
...
Clinically identified compounds are often available for other purposes, allowing clinicians to administer them to patients quickly either with an EUA or off-label.
...
Over the last year, dexamethasone has emerged as the strongest treatment against severe COVID-19, but HCQ/CQ and ARBs/ACEis have not borne out early hope in their mechanistic relevance.
Although only limited testing of candidate therapies was possible during the SARS and MERS epidemics, the success of dexamethasone clearly illustrates how clinical context can be a valuable approach through which to identify candidate therapeutics.
...
Two approaches seek to identify candidate pharmaceuticals based on information gained in non-clinical research on HCoV.
The second approach reviewed above uses information about how related viruses function to identify possible ways to disrupt pathogenesis.
These compounds are also typically small-molecule drugs, but often includes boutique and experimental medications like remdesivir,
Remdesivir has shown promise as an antiviral therapeutic, although other antivirals did not receive the same support from clinical trials and even remdesivir was not found to reduce mortality in the worldwide WHO Solidarity trial.
The third approach hinges on an understanding of host-pathogen interactions.
Candidate drugs falling into this category are typically biologics, which imitate the function of endogenous compounds.
...
Finally, a fourth approach is more nascent but shows new potential in the age of big data.
...
Experience gained through prior outbreaks of HCoV combined with recent scientific advances in other fields has enabled the rapid assessment of candidate drugs using a number of different approaches.

...
Therapeutic interventions can utilize two approaches: they can either mitigate the effects of an infection that harm an infected person, or they can hinder the spread of infection within a host by disrupting the viral life cycle.
...
Alternatively, nucleotides and nucleosides are the natural building blocks for RNA synthesis, and nucleoside and nucleotide analogs have been explored in the past for their potential to inhibit viral replication.
...
The RECOVERY trial along with results from several other RCTs [@doi:10.1056/NEJMoa2028700; @doi:10.1056/NEJMoa2030340; @clinicaltrials:04409262; @clinicaltrials:04320615; @clinicaltrials:04372186] were cited as support for the EUA issued for TCZ in June 2021 [@url:https://www.fda.gov/media/150319/download].
...
Thus far, two antibody cocktails (REGN-COV2 and LY-CoV555/LY-COV016) and the mAb Sotrovimab on its own have been granted emergency use authorization by the FDA.
...
The range of approaches described here offer a range of advantages and limitations in responding to a novel viral threat and build on existing bodies of knowledge in different ways.
...
Other candidate drugs that intercept host-pathogen interactions can be biologics, which imitate the function of endogenous host compounds.
...
Finally, computational approaches are more nascent but have begun to show new potential in the age of big data.
...
The evidence available is based on the progression of the therapeutic through the pharmaceutical development pipeline, with randomized control trials (RCT) as the most informative source of evidence.

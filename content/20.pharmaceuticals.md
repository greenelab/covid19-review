...
Computational screens can then mine databases and other resources to identify potential PPIs among the host, the virus, and established and/or experimental drugs [@doi:10.1038/s41467-020-17189-2].
...
Sigma receptors are located in the endoplasmic reticulum of many cell types and type 1 and 2 Sigma receptors have overlapping but distinct affinities for ligands [@doi:10.1016/j.pharmthera.2009.07.001].
...
Another computational study, however, called into question whether the emphasis on drugs interacting with Sigma receptors might be based on a spurious association.
This study built on the prior work by examining whether antiviral activity among compounds correlated with their affinity for the Sigma receptors [@doi:10.1126/science.abi4708].
They further demonstrated that cationic amphiphilicity was a shared property among many of the candidate drugs identified through both computational and phenotypic screens, suggesting it as a potential cause of a compound's proposed antiviral activity [@doi:10.1126/science.abi4708].
...
However, phospholipidosis is known to translate poorly from _in vitro_ models to clinical applications.
Drug-induced phospholipidosis is a significant concern in the long-term use of such drugs [@doi:10.1515/hsz-2019-0270] and it was reported following only a 5-day course of HCQ in a case study of a deceased COVID-19 patient [@doi:10.1080/01913123.2020.1850966].
...
The authors further demonstrated that antiviral activity against SARS-CoV-2 _in vitro_ was correlated correlated with the induction of phospholipidosis for drugs with and without cationic amphiphilicity [@doi:10.1126/science.abi4708].
...
All the same, one drug that gained interest because of its affinity for Sigma receptors remains a candidate for the treatment of COVID-19.
Several psychotropic drugs target Sigma receptors in the central nervous system and attracted interest as potential COVID-19 therapeutics following the findings of the two Gordon et al. studies [@doi:10.1007/s00406-020-01231-x]. 

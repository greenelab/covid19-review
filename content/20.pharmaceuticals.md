...
Although both of these previous pandemics were controlled fairly quickly, no vaccines or robust therapeutic interventions were identified.
...
Here, we describe a range of approaches to the treatment and prevention of COVID-19 along with their proposed mechanism of action and the current status of clinical investigation into each candidate.
...
When the worldwide scientific community shifted to focus on the SARS-CoV-2 virus and the disease it causes, a large number of possible pharmaceutical approaches to treatment and prevention were proposed.
...
The emergence of _Severe acute respiratory syndrome-related coronavirus 2_ (SARS-CoV-2) at the end of 2019 was followed quickly by the worldwide spread of the disease caused by its infection, novel coronavirus disease 2019 (COVID-19).
COVID-19 is associated with symptoms ranging from asymptomatic to mild to severe, with approximately 2% of patients dying from COVID-19-related complicates such as acute respiratory disease syndrome (ARDS) [cite pathogenesis/transmission].
The virus is likely spread between people primarily by droplets, with the role of contact transmission still in question [@doi:10.1001/jama.2020.12458; @doi:10/gg6br7].
...
This continued threat in combination with the severity of the disease makes the identification and development of prophylactic and therapeutic interventions significant priorities.
Both approaches hold valuable potential for controlling the impact of the disease, as prophylactics can induce immunity to prevent an individual from contracting a disease and therapeutics provide mechanisms to treat a disease in infected individuals.
For highly infectious diseases such as COVID-19, vaccines hold particular value because they are expected to save a large number of lives by bolstering the immune response to the virus of the population broadly, thereby driving a lower rate of infection.
...
Fortunately, prior developments during other recent pandemics, especially those caused by HCoV, had provided a number of hypotheses for how biomedicine might appraoch the novel coronavirus infection.

>>>>>>> continue editing structure
...
In fact, the virus causing COVID-19 was quickly identified through gome sequencing as a novel betacoronavirus closely related to SARS-CoV-1 @doi:10.46234/ccdcw2020.017].
...
In this review, we describe some treatments and prophylatics that have been considered for COVID-19 and classify them according to their biological properties, specifically whether they are biologics (produced from components of organisms) or small molecules.
...
=======
#### Lessons from Prior HCoV

SARS-CoV-2 rapid ascent from an unknown virus to a significant worldwide threat closely parallels that of _Severe acute respiratory syndrome-related coronavirus_ (SARS-CoV-1).
COVID-19 emerged in Wuhan, China in November 2019 and then spread worldwide by early 2020, and the first case of SARS was reported in November 2002 in the Guangdong Province of China and over the following month spread more widely within China and then into several countries across multiple continents [@doi:10.1093/ajcp/aqaa029; @doi:10.1038/nrmicro.2016.81].
In fact, the virus causing COVID-19 was quickly identified as a novel betacoronavirus closely related to SARS-CoV-1 @doi:10.46234/ccdcw2020.017].
There are, however, some major differences between the affects of the two viruses on human hosts.
SARS infection was found to be severe, with an estimated death rate of 9.5% [@doi:10.1093/ajcp/aqaa029], while estimates of the death rate associated with COVID-19 converge at approximately 2% [cite pathogenesis/transmission section] .
SARS-CoV-1 is also highly contagious via droplet transmission, with a basic reproduction number (R~0~) of 4 (i.e., each person infected was estimated to infect four other people) [@doi:10.1093/ajcp/aqaa029].
While SARS-CoV-2 also appears to be spread parimarily by droplet transmission [@doi:10.1001/jama.2020.12458; @doi:10/gg6br7], most estimates of its R~0~ fall between 2.5 and 3 [cite transmission/pathogenesis].

Furthermore, the 17-year difference in the timing of these two outbreaks has led to some major differences in the organization of a response.
At the time that SARS-CoV-1 emerged, no new coronavirus capable of infecting humans, or human coronavirus (HCoV), had been identified in almost 40 years [@doi:10.1038/nrmicro.2016.81].
The identity of the virus underlying the SARS disease remained unknown until April of 2003, when the SARS-CoV-1 virus was characterized through a worldwide scientific effort spearheaded by the WHO [@doi:10.1038/nrmicro.2016.81].
In contrast, the SARS-CoV-2 genomic sequence was released on January 3, 2020 [@doi:10.46234/ccdcw2020.017], only days after the international community became aware of the novel pneumonia-like illness now known as COVID-19.
While SARS-CoV-1 belonged to a distinct lineage from the two other HCoV known at the time of its discovery [@doi:10.1093/ajcp/aqaa029], SARS-CoV-2 is closely related to SARS-CoV-1 and a more distant relative of another HCoV, _Middle East respiratory syndrome-related coronavirus_ [@doi:10/ggjr43].
Thus, these two viruses emerged under very different circumstances in terms of scientific knowledge about HCoV.

The trajectories of the pandemics associated with each of the viruses have also diverged significantly.
By July 2003, the SARS outbreak was officially determined to be under control, with the success credited to infection management practices such as mask wearing [@doi:10.1038/nrmicro.2016.81].
Though the fatality rate associated with MERS is much higher than for SARS, at almost 35%, the disease is much less easily transmitted, with an R~0~ of 1 [@doi:10.1093/ajcp/aqaa029], and although MERS is still circulating, its low reproduction number in combination with public health pracctices has allowed for its spread to be contained [@doi:10.1093/ajcp/aqaa029].
Neither of these trajectories emulate that seen in the 2020 pandemic, which is ongoing a full year after the emergence of the first cases of COVID-19.
Notably, vaccines were not used to control either virus, although vaccine development programs were established for SARS-CoV-1 [@doi:10.3390/v11010059], and care for SARS and MERS patients prioritized supportive care and symptom management [@doi:10.1093/ajcp/aqaa029].
To the extent that clinical treatments for SARS and MERS developed during the outbreaks generally do not have strong evidence supporting their use.
...
#### Therapeutic and Prophylatic Approaches
...
Many antivrial drugs are designed to inhibit the replication of viral genetic material during the biosynthesis step.
...
One of the two mRNA vaccines, Pfizer and BioNTech's BNT162b2, has been issued an EUA for patients as young as 16 [@url:https://www.pfizer.com/news/press-release/press-release-detail/pfizer-and-biontech-submit-emergency-use-authorization], while ModernTX has begun a clinical trial to assess its mRNA vaccine in adolescents ages 12 to 18 [@url:https://investors.modernatx.com/news-releases/news-release-details/moderna-announces-first-participants-dosed-phase-23-study-covid].
...
#### Conclusionss of the Present Analysis
...
At present, two pharmacuetical therapeutics and one vaccine have been authorized for the treatment and prevention, respectively, of COVID-19.
As the COVID-19 pandemic continues to be a topic of significant worldwide interest, more information is expected to become available about pharmacuetical mechanisms that can be used to combat this, and possibly other, HCoV.

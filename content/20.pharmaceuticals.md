...
Interventional trials are the most frequent type of trial and were analyzed in the figures depicting status, phase, and intervention.
The recruitment statuses and trial phases are shown only for interventional trials in which the status or phase is recorded.
...
They enrolled 152 patients at 20 hospitals across seven countries and randomized them into two arms, continution (n=75) and discontinuation (n=77).
...
In this study, the primary endpoint analyzed was the number of days that patients were a) alive and b) not hospitalized within 30 days of enrollment.

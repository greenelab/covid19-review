...
Hypothesis-driven screens test drugs against likely viral or host targets or drugs with desired clinical effects such as immunosuppressants.
...
For computational analyses, such approaches require identifying compounds that modulate pre-selected proteins in the virus or host.
...
These examples illustrate that HTS-based evaluations of drug repurposing can potentially provide some valuable insights, but there are significant limitations to these methods.

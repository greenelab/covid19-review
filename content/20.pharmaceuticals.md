...
However, the differing efficacies of remdesivir and favipiravir underscores the fact that drugs with similar mechanisms will not always produce similar results in clinical trials.
...
<!-- Should we move this figure up to appear after the first paragraph of "Approaches Targeting the Virus"? It includes remdesivir and favipiravir that are discussed in that section. Also, does that mean the scope is more general than "Host-Virus Interactions"?-->
...
Based on this data, the combination therapy received emergency use authorization for COVID-19 from the FDA in February 2021 [@url:https://www.fda.gov/media/145801/download].

...
]({{csse_deaths_figure}} "Global COVID-19 deaths"){#fig:csse-deaths secno=1} <!---Can Can we show the number of days on the x-axis in the 4 figures?-->
...
There is still some controversy whether SARS-CoV-2 is primarily spread by droplets or is primarily airborne [@doi:10.1001/jama.2020.12458; @doi:10/gg6br7; @doi:10/gjqmvq; @doi:10.1136/bmj.n913]. <!---I believe there is much more evidence towards the airborne route now. Also, I put all these references together because the fomite one, for example, actually talks of a low risk of fomites.-->
...
COVID-19 is characterized by two phases. <!---Which phase includes the ARDS-associated respiratory failure (mentioned above)?-->

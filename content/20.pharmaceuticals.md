...
The genomic identity between the RBD of SARS-CV-1 and SARS-CoV-2 is around 76%. 
...
While some antibodies developed against SARS-CoV-1 spike protein showed cross-neutralization activity with SARS-CoV-2 [@doi: 10.1016/j.tips.2020.07.004; @doi:10.1038/s41586-020-2349-y], others failed to bind to SARS-CoV-2 spike protein at relevant concentrations [@doi:10.1126/science.abb2507]. 
Cross-neutralizing activities were dependent on whether the epitope recognized by the antibodies were conserved between SARS-CV-1 and SARS-CoV-2 [@doi:10.1016/j.tips.2020.07.004].
...
The 47D11 antibody clone was able to cross-neutralize SARS-CoV-1 and SARS-CoV-2. This antibody (now ABVV-47D11) has recently entered clinical trials in collaboration with AbbVie. 
...
Bamlanivimab is a human monoclonal antibody that was derived from convalescent plasma of a recovered COVID-19 patient based on research from the National Institute for Allergy’s and Infectious Diseases (NIAID) and subsequently developed by AbCellera and Eli Lilly. 
The neutralizing activity of bamlanivimab was initially demonstrated in vivo using a nonhuman primate model [@doi: 10.1101/2020.09.30.318972]. 
...
The phase 1 trial which was conducted in hospitalized COVID-19 patients was completed in August 2020 (NCT04411628).

Estesevimab (LY-CoV016 or JS-016) is also a monoclonal neutralizing antibody against the spike protein of SARS-CoV-2. 
It was initially developed by Junshi Biosciences and later licensed and developed through Eli Lilly. A phase 1 clinical trial to assess the safety of etesevimab was completed in October 2020 (NCT04441931). 
...
To assess the efficacy and safety of bamlanivimab alone or in combination with etesevimab for the treatment of COVID-19, a phase 2/3 trial (BLAZE-1, NCT04427501) was initiated. 
The interim analysis of the phase 2 portion suggested that bamlanivimab alone was able to reduce accelerate the reduction in viral load [10.1056/NEJMoa2029849].
However, more recent data suggests that only the bamlanivimab/etesevimab combination therapy is able to reduce viral load in COVID-19 patients [@doi: doi:10.1001/jama.2021.0202]. 
Based on this data, the combination therapy has received emergency use authorization for COVID-19 by the FDA in February of 2021.
...
They were both developed by Regeneron in a parallel high-throughput screen to identify neutralizing antibodies from either humanized mice or patient-derived convalescent plasma [10.1126/science.abd0827].
In these efforts, multiple antibodies were characterized for their ability to bind and neutralize SARS-CoV-2 spike protein.
...
Based on this data, casirivimab and imdevimab were identified as the lead antibody pair, resulting in the initiation of two clinical trials (NCT04426695 and NCT04425629).
Data from this phase 1-3 trial published in the New England Journal of Medicine shows that the REGN-COV2 antibody cocktail reduced viral load, particularly in patients with high viral load or whose endogenous immune response has not been initiated yet [@doi: 10.1056/NEJMoa2035002].
...
Ongoing efforts are trying to evaluate the efficacy of REGN-COV2 to improve clinical outcomes in hospitalized patients (NCT04426695).

##### Viral Resistance to Neutralizing Antibodies

With the ongoing global spread of new SARS-CoV-2 variants, there is a growing concern that mutations in SARS-CoV-2 spike protein can escape antibody neutralization, thereby reducing the efficacy of monoclonal antibody therapeutics and vaccines.
...
This antibody targets a highly conserved epitope that overlaps the hACE2 receptor binding site of all clade 1 sarbecoviruses.
...
In just under a year since the first structure of the SARS-CoV-2 spike protein has been published, an impressive pipeline of monoclonal antibodies targeting SARS-CoV-2 has entered clinical trials with hundreds of more candidates in preclinical stages.
Technological advances in antibody drug design as well as in structural biology massively accelerated the discovery of novel antibody candidates and mechanism by which they interact with the target structure.

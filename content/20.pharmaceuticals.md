...
]({{csse_deaths_figure}} "Global COVID-19 deaths"){#fig:csse-deaths secno=1} <!---Can we show the number of days on the x-axis in the 4 figures?-->
...
However, the relative success, respectively lack of success, of remdesivir and favipiravir underscores the fact that drugs with similar mechanisms will not always produce similar results in clinical trials.

...
A large number of hypothesis-free computational screens were carried out early in the COVID-19 pandemic.
Such screens seek to advance drug repurposing efforts by mining databases and the resources to identify potential interactions PPIs among the host, the virus, and known drugs [@doi:10.1038/s41467-020-17189-2].
...
In the early months of the COVID-19 pandemic, the results of a PPI-network-based analysis were released [@doi:10.1038/s41586-020-2286-9].
This effort included cloning the proteins expressed by SARS-CoV-2 _in vitro_ and quantifying 332 viral-host PPI with affinity purification mass spectrometry [@doi:10.1038/s41586-020-2286-9].
One candidate interaction identified was the relationship between two SARS-CoV-2 proteins (Nsp6 and Orf9c) and host Sigma1 and Sigma2 receptors, with molecules interacting with the Sigma receptors found to have an effect on viral infectivity _in vitro_ [@doi:10.1038/s41586-020-2286-9].
Sigma receptors are located in the endoplasmic reticulum of many cell types and have overlapping but distinct affinities for ligands [@doi:10.1016/j.pharmthera.2009.07.001].
Because many known drugs interact with the Sigma receptors [@doi:10.1038/s41586-020-2286-9; @doi:10.2174/157015905774322516], they became a major focus of drug repurposing efforts.
Hydroxychloroquine is one such drug; however, it was already being explored as a candidate therapeutic for COVID-19 at the time that this discovery was made [@doi:10.1038/s41586-020-2286-9].
...
One established small-molecule drug that interacts with Sigma receptors is fluvoxamine.

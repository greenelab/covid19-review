...
Studies have shown that viral proteases play an important role in the life cycle of viruses, including coronaviruses, by modulating the cleavage of viral polyprotein precursors [@doi:10.2174/138161207780162971], and serine protease inhibitors were previously suggested as possible treatments for SARS and MERS [@doi:10.1016/j.antiviral.2015.01.011].
...
High-throughput screening was then used to identify compounds that might interfere with SARS-CoV-2 M^Pro^.
...
A number of hypothesis-free computational screens were carried out early in the COVID-19 pandemic, leading to the identification of candidate compounds such as remdesivir and chloroquine (reviewed in [@doi:10.1039/D0CS01065K]).
...
Models can prioritize molecular structure or molecular interactions in determining the potential of a compound [@doi:10.1039/D0CS01065K], and .
...
As illustrated by the difference in the current status of remdesivir and favipiravir as treatments for COVID-19, it can be difficult to identify whether a specific compound will produce a desired effect 

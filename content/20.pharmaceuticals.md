...
With computational studies, another level of abstraction is added: a compound that showing promise _in silico_ will not necessarily demonstrate the same potential _in vitro_ or _in vivo_.
This work therefore illustrates the importance of considering confounding variables in computational screens, a principle that is baked into more traditional approaches to drug development [@doi:10.1126/science.abj9488].

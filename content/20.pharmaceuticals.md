...
Additionally, the drug development process is slow and costly.
As a result, in recent years, efforts to screen existing compounds for alternative indications have become popular [@doi:10.1016/j.drudis.2019.06.014; @doi:10.1016/j.drudis.2019.06.014; @doi:10.1111/bph.13895].
...
A large number of 
These have been integrated into a resource known as the COVID-19 Drug and Gene Set Library, which at the time of its publication contained 1,620 drugs sourced from 173 experimental and computational drug sets and 18,676 human genes sourced from 444 gene sets [@doi:10.1016/j.patter.2020.100090].
This study found that several drugs had been identified across multiple analyses, including several that had received significant attention as candidates (e.g., CQ/HCQ and remdesivir) [@doi:18,676].
A second study expanded on these results by identifying that cationic amphiphilicity was a shared property among many candidates identified both in computational and phenotypic screens, suggesting it as a potential cause of antiviral activity [@doi:10.1101/2021.03.23.436648].
Cationic amphiphilic drugs are known to initiate phospholipidosis; indeed, one case study identified drug-induced phospholipidosis as the cause of death for a COVID-19 patient treated with HCQ [@doi:10.1080/01913123.2020.1850966].
Mechanistically, phospholipidosis could disrupt viral replication by inhibiting lipid processing [@doi:10.1080/01913123.2020.1850966].<!--To Do: check whether to reference HCQ section or HCQ appendix-->

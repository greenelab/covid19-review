...
Prior developments during other recent outbreaks of emerging diseaes, especially those caused by human coronaviruses (HCoV), have provided a number of hypotheses guiding a biomedical approach to the behavior and treatment of this novel coronavirus infection.
...
Therapeutics can either reduce the symptoms that are harmful to patients or hinder the spread of infection by targeting a virus directly.
...
Instead, randomized controlled trials are the gold-standard method for assessing the effects of a medication.

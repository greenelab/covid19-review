...
This information can provide insight into the relative success of various methods for identifying candidate theapeutics against an emerging disease.
...
As illustrated by the continued threat of viral epidemics during the current millenium, a rapid and strategic response to emerging viral threats can, has, and is likely to once again in the future save lives.
...
Therefore, SARS is thought to be a deadlier and more transmissible disease than COVID-19, yet the two viruses followed very different trajectories in their effects on a global scale.
...
Neither of these trajectories are comparable to that of SARS-CoV-2, which remains a serious threat worldwide over a year and a half after the first cases of COVID-19 emerged.
...
The second phase is typically characteristic of more severe cases.
Here, many patients experience a cytokine storm, whereby excessive production of cytokines floods into circulation leading to systemic inflammation, immune dysregulation, and multiorgan dysfunction that can cause multiorgan failure and death if untreated [@doi:10.1056/NEJMra2026131].
...
Prior analyses of the virological and pathogenic properties of SARS-CoV-1 and MERS-CoV have provided a strong foundation for the development of hypotheses about SARS-CoV-2 that offered insight into potential therapeutic approaches.
...
The first year of the COVID-19 pandemic demonstrated that there are several different trajectories that these clinically identified candidate treatments can follow when assessed against a widespread, novel viral threat.
...
However, a second treatment adapted from prior HCoV outbreaks is currently the best-known treatment for severe cases of COVID-19.
...
In the months since its release, dexamethasone has become a valuable tool in the treatment of severe COVID-19 [@doi:10.1016/j.ejphar.2021.173854].

#### Treatments Adapted from Clinical Practice
...
This feasibility presents a double-edged sword, because HCQ/CQ were incorporated into SOC in many countries before being removed once the evidence indicated its potential to harm COVID-19 patients [@url:https://www.fda.gov/media/138946/download; @url:https://www.ema.europa.eu/en/news/covid-19-chloroquine-hydroxychloroquine-only-be-used-clinical-trials-emergency-use-programmes].
...
Other drugs influencing inflammation are also being explored (Appendix A).

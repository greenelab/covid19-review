...
| Treatment | Category | Approval Status (US) | Approval Status (Elsewhere) | Evidence Available | Suggested Effectiveness |
|----------|----------|----------|----------|----------|----------|
| Favipiravir | Small molecule, antiviral, nucleoside/nucleotide analog | None | | RCT | Ineffective | 

Table: Caption for this example table. {#tbl:summary-table}

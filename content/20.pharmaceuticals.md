...
In the United States, for example, they are prescribed well over 100,000,000 times annually. <!--Should probably get a reference for this-->
...
An observational study of the association of exposure to ACEIs or ARBs with outcomes in COVID-19 was retracted from the _New England Journal of Medicine_ [@doi:10.1056/NEJMoa2007621]. <!--Do we know why?-->
Moreover, because observational studies are subject to confounding, randomized controlled trials are the standard means of assessing the effects of medications, and the findings of the various observational studies bearing on this topic cannot be interpreted as indicating a protective effect of the drug [@doi:10.1161/CIRCRESAHA.120.317205; @doi:10.2215/CJN.03530320]. <!--This is a more general issue, not specific to ACEis and ARBs or to COVID - may want to move this to the intro, possibly with more general references.-->
...
Both drugs increase cellular pH by accumulating in their protonated form inside lysosomes [@doi:10.1186/1743-422X-8-163; @doi:10.1111/j.1529-8019.2007.00131.x]. <!--Should have 1-2 sentences on what they’re approved for (malaria, lupus, rheumatoid arthritis) https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=34496b43-05a2-45fb-a769-52b12e099341 (look under “Indications and usage”) - descriptions of other treatments generally have this.-->
...
Additionally, HCQ has been found to be effective in treating HIV [@doi:10/cq2hx9] and chronic Hepatitis C [@doi:10.1002/jmv.24575]. <!--Is it approved for these though? The drug labels seems to only imply approval for malaria, lupus, RA https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=34496b43-05a2-45fb-a769-52b12e099341 (look under “Indications and usage”)-->
...
Furthermore, the trial arms were entirely confounded by hospital and there were false negative outcome measurements. <!--Not sure what "false negatives outcome measurements" refers to-->
...
SOC in this study included the use of antivirals (Lopinavir-Ritonavir, Arbidol, Oseltamivir, Virazole, Entecavir, Ganciclovir, and Interferon alfa), which appeared to introduce confounding effects. <!--How so?-->
...
Therefore, despite some potential areas of investigation identified in _post hoc_ analysis, this study cannot be interpreted as providing support for HCQ as a therapeutic against COVID-19. <!--I would think the main reason for this is that the negative seroconversion and the median time to symptom alleviation are very close between groups, so that alone - without the other issue - would be enough to lead to this interpretation.-->
...
It was first synthesized in the late 1950s as an anti-inflammatory and has been used to treat RA and other inflammatory conditions [@doi:10.1021/ja01545a061; @doi:10.1001/jama.1960.03030070009002]. <!--Should also mention allergies and asthma. It actually has a wide number of listed uses on the label at https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=537b424a-3e07-4c81-978c-1ad99014032a (Under Indications and usage)-->
...
Thus, it seems likely that dexamethasone is useful for treating inflammation associated with immunopathy or cytokine release syndrome (CRS). <!--Should have a brief description of CRS here and in the future, a reference to the pathogenesis paper-->
...
Often used to treat conditions such as RA [@doi:10.1101/cshperspect.a016295], TCZ has become a pharmaceutical of interest for the treatment of COVID-19 because of the role IL-6 plays in this disease. <!--Probably want to mention it’s also approved to treat CRS caused by CAR-T treatments https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=2e5365ff-cb2a-4b16-b2c7-e35c6bf2de13 (under Indications and usage)-->
...
Therefore, drugs inhibiting the binding of IL-6 to IL-6R&alpha; or sIL-6R&alpha; are of interest for combating the hyperactive inflammatory response characteristic of CRS and CSS. <!--Aren't these the same thing?-->
...
Other retrospective analyses have utilized a case-control design to match pairs of patients with similar baseline characteristics, only one of whom received TCZ for COVID-19. <!--Edited because case-control studies are a type of retrospective design.-->
...
These last findings highlight the need to search for a balance between impairing a harmful immune response, such as the one generated during CRS and CSS, and preventing the worsening of the clinical picture of the patients by potential new viral infections. <!--Aren't CRS and CSS the same thing?-->
...
In summary, approximately 25% of hospitalized coronavirus patients develop ARDS, which is caused by an excessive early response of the immune system which can be a component of CRS [@doi:10.1016/j.chest.2020.06.006] and CSS [@doi:10.1186/s12967-020-02339-3]. <!--Are CRS and CSS different from each other?--> <!--ARDS is only developed by 25% of *hospitalized* patients, not all patients. Should include a reference for that - I found this https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7441837/, which estimates this at 33%.--> 
...
In children, the SARS-CoV-2 virus can present as two distinct diseases, COVID-19 or MIS-C. <!--Should give brief explanation and reference for MIS-C.-->

...
Traditionally, these screens focused on phenotype and tested to see which compounds would induce a desired change in _in vitro_ or _in vivo_ models, focusing on empirical, function-focused exploration naïve to molecular mechanism [@doi:10.1126/scitranslmed.aab1201; @doi:10.1038/clpt.2012.236; @doi:10.1038/nrd4366].
...
In the age of biological big data, this has...
...
Despite the concerns it raises about HTS, it was a data-driven approach that allowed researchers to notice a shared property among many of the hits from computational screening analyses [@doi:10.1126/science.abi4708].
In combination, these findings suggest that data-driven research can be an important component of the drug repurposing ecosystem, but that drug repurposing efforts that proceed without a hypothesis, an emphasis on biological mechanisms, or an understanding of confounding effects may not produce valuable candidates.
...
The trends observed in drug repurposing and especially HTS may appear, at first, contradictory to those observed in drug discovery.
In 2011, a landmark study demonstrated that although more new drugs were discovered using target-based rather than phenotypic approaches, the majority of drugs with a novel molecular mechanism of action (MMOA) were identified in phenotypic screens [@doi:10.1038/nrd3480].
This pattern suggests that target-based drug discovery is more successful when building on a known MMOA, and that modulating a target is most valuable when the target is part of a valuable MMOA [@doi:10.1038/nrd4366].
...
Drugs like dexamethasone have a known effect on the human body, and in the case of COVID-19, this effect was found to be beneficial to patient outcomes, while attempts to target the virus or host-virus interactions have produced very mixed results.
...
At the outset of the COVID-19 pandemic, preclinical and limited clinical information was available from trials in models for and patients with Ebola virus disease, although promising preclinical results translated poorly to an initial RCT [@doi:10.7573/dic.2020-4-14].
One weakness in the hypothesis-free HTS approach may be that  host proteins, which are probably too essential to the host. Also, most antibiotics are against bacterial targets very different than anti-virals.

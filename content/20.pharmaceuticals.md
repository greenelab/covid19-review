...
A similar story has arisen with the broad-spectrum, small-molecule anthelmintic ivermectin.
Ivermectin is composed of avermectin, a bioactive compound produced by the microorganism _Streptomyces avermectinius_, also known as _Streptomyces avermitilis_ [@doi:10.1038/nrmicro1048; @doi:10.1128/AAC.15.3.361].
It blocks gutamate-gated chloride ion channels from closing, which serves to hyperpolarize neuronal membranes, disrupt neural transmission, and induce paralysis [@doi:10.2183/pjab.87.13; @doi:10.1038/nrmicro1048].
This effect is found only in species, such as helminths and arthropods, where these channels are located in the peripheral nervous system; it does not cross the blood-brain barrier [@doi:10.2183/pjab.87.13; @doi:10.1038/nrmicro1048; @doi:10.1038/ja.2017.11].
refs 13, 14, 15 for mechanism
Ultimately the drug likely functions by preventing parasites from evading the mammalian immune system [@doi:10.1038/ja.2017.11].
A potent antihelmintic, ivermectin has been used since the early 1980s to treat endo- and ecto-parasitic infections by helminths, insects, and arachnids in veterinary contexts [@doi:10.1038/nrmicro1048; @doi:10.1128/AAC.15.3.372].
Investigation into a possible clinical application towards treating onchocerciasis, which is caused by a nematode, began around the same time [@doi:10.1038/nrmicro1048], and large-scale administration of the human formulation of the drug began in 1988 [@doi:10.1038/nrmicro1048; @doi:10.2183/pjab.87.13].(21,22)
It has subsequently been used to treat lymphatic filariasis (elephantitis) and strongyloidiasis in addition to other diseases causes by nematodes [@doi:10.1038/nrmicro1048; @doi:10.2183/pjab.87.13].
Some research has also suggested that ivermectin might function as a broad-spectrum antiviral by distrupting the trafficking of viral proteins by RNA viruses [@doi:10.1038/ja.2017.11].

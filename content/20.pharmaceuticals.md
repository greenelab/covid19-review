...
Computer-aided drug development can utilize several strategies, including models that prioritize molecular structure or molecular interactions in determining the potential of a compound [@doi:10.1039/D0CS01065K].
For infectious viral diseases, there are several properties that might identify a compound as a candidate for an emerging viral disease [@doi:10.1016/j.tim.2018.04.004].
...
Selection of an appropriate target is fundamental to success in repurposing [@doi:10.1038/nrd.2018.168].
Preclinical and clinical follow-up studies are needed and ultimately reveal whether the intended effect is achieved _in vitro_ and _in vivo_.
...
A number of computational screens were carried out early in the COVID-19 pandemic, leading to the identification of candidate compounds such as remdesivir and chloroquine (reviewed in [@doi:10.1039/D0CS01065K]).
Here, we describe two examples of computational efforts to screen or produce compounds that have provided different insights into drug repurposing for COVID-19.

One example comes from research in protease inhibitors, which build on the same biological concepts underlying antivirals described above.
...
Serine protease inhibitors were previously suggested as possible treatments for SARS and MERS [@doi:10.1016/j.antiviral.2015.01.011].
...
Computer-aided design then allowed for the development of a Michael acceptor inhibitor, now known as N3, to target M^Pro^, which is a protease critical to SARS-CoV-2 replication [@doi:10.1038/s41586-020-2223-y].
...
This processing is usually conducted by M^Pro^, a 33.8-kDa SARS-CoV-2 protease that is therefore fundamental to viral replication and transcription.
N3 was designed computationally [@doi:10.1371/journal.pbio.0030324] to bind in the substrate binding pocket of the M^Pro^ protease of SARS-like coronaviruses [@doi:10.1007/s13238-013-2841-3], therefore inhibiting proteolytic processing.
Subsequently, the structure of N3-bound SARS-CoV-2 M^Pro^ was solved [@doi:10.1038/s41586-020-2223-y], confirming the computational prediction.
...
After the design and confirmation of N3 as a highly potent Michael acceptor inhibitor and the identification of M^Pro^'s structure [@doi:10.1038/s41586-020-2223-y; @doi:10.1126/science.abb3405], 10,000 compounds were screened for their _in vitro_ anti-M^Pro^ activity.
...
Molecular dynamic analysis has further demonstrate the potential for ebselen to bind to M^Pro^ and disrupt the protease's enzymatic functions [@doi:10.1126/sciadv.abd0345]. 
...
Pending the results of clincial trials, ebselen remains a computationally interesting compound whose benefits may or may not translate to the clinic.
...
Other computational work in drug repurposing has taken a broad-lens approach to the computational prediction of candidate drugs against COVID-19.
...
Cationic amphiphilicity is associated with the induction of phospholipidosis, which is when phospholipids accumulate in the lysosome [@doi:10.1515/hsz-2019-0270], and antiviral activity against SARS-CoV-2 _in vitro_ was correlated found to be correlated with phospholipidosis for drugs with and without cationic amphiphilicity, supporting the idea that the property of catioinic amphicility was a proxy for a shared effect [@doi:10.1126/science.abi4708].
...
However, drug-induced phospholipidosis is a significant concern in the long-term use of such drugs [@doi:10.1515/hsz-2019-0270] and it was reported following a 5-day course of HCQ in a case study of a deceased COVID-19 patient [@doi:10.1080/01913123.2020.1850966].
Phospholipidosis-inducing drugs were also not effective at preventing viral propagation _in vivo_ in a murine model of COVID-19 [@doi:10.1126/science.abi4708].
...
While these two stories indicate two different ways that computational research in drug repurposing can provide valuable insights, there are limitations to these methods.
...
High-throughput drug screens also are subject to the same limitations inherent to drug discovery and repurposing efforts broadly, where the potential that a compound shows in the lab will not necessarily translate to the clinic.
With computational studies, another level of abstraction is added: a compound that showing promise _in silico_ will not necessarily demonstrate the same potential _in vitro_.

All the same, the stories of ebselen and phospholipidosis do illustrate that computational analyses can provide novel insights.
M^Pro^ inhibitors remain promising candidates [@doi:10.1039/D0CS01065K], although the clinical trial data is not yet available.
Alternatively, in the case of phospholipidosis, a data-driven approach allowed for researchers to notice a shared property among many of the hits from computational screening analyses [@doi:10.1126/science.abi4708].
Given that phospholipidosis is known to translate poorly from _in vitro_ to _in vivo_ research [@doi:10.1126/science.abi4708], this insight is fundamental to interpreting the results of computational screens.
Thiw work therefore illustrates the importance of considering confounding variables in computational screens, a principle that is baked into more traditional approaches to drug development [@doi:10.1126/science.abj9488].
Thus, computer-aided drug design and other computational analyses may provide value as a component of the broader drug discovery ecosystem when applied appropriately.

### Considerations in Balancing Different Approaches

In the case of ebselen, a potentially mechanistically relevant drug must still go through a long validation process before its clinical relevance can be known, and in light of the fact that so many initially promising therapies have been found to have no significant effect once investigated in well-powerered studies, the small sample size of the ongoing clinical trials is likely to mean that convincing evidence is likely a long way off.

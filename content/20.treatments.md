...
Remdesivir (GS-5734) was developed by Gilead Sciences to treat Ebola and was briefly tested in the clinic.
...
Remdesivir (Gilead) is an adenosine analogue that, once incorporated into the nascent viral chain, causes premature termination of transcription [@doi:10.1038/s41422-020-0282-0].

### Anticipated Mechanism
Remdesivir is metabolized to GS-441524, an adenosine analog that inhibits a broad range of polymerases and then evades exonuclease repair causing chain termination [@doi:10.1074/jbc.AC120.013056; @doi:10.1128/mBio.00221-18].
...
### Current Evidence
Previous work has shown Remdesivir to be an effective treatment for viral pathogens such as SARS-CoV and MERS-CoV in cultured cells and animal models, and a recent study found that administration of Remdesivir to non-human primate models resulted in 100% protection against infection by the Ebola virus.
...
Note that the HIV and Herpes polymerases are a reverse transcriptase and a DNA polymerase respectively, whereas Covid-19 encodes an RNA dependent RNA polymerase, so most of the commonly used polymerase inhibitors are not likely to be active against Covid-19.

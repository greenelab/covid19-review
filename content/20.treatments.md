...
SPM potentially function through various mechanisms, which includes preventing the release of pro-inflammatory cytokines and chemokines and phagocytosing of cellular debris by macrophages [@doi: 10.1038/nature13479].  
...
The effectiveness of n-3 PUFA against infections is dependent on the dosage, timing, and the specific pathogens responsible [@doi:10.1016/j.jinf.2016.10.001].

One pathological aspect of COVID-19 infection that was late to be recognised  was the increased risk of thrombotic complications [@doi:10.1016/j.thromres.2020.04.013]. 
...
This may be particularly important since patients receiving pharmaceutical antiplatelet therapies may become infected.
Consequently, there may be issues with dosing, drug choice, and drug-drug interactions [@doi:10.1016/j.jacc.2020.04.031], whereby dietary sources of n-3 fatty acids may be beneficial and warrant further investigation.
Finally, while there are studies investigating the therapeutic value of n-3 fatty acids against ARDS in humans, there is still limited evidence of their effectiveness [@doi:10.3390/ijms21093104].
...
As the pandemic evolves, research has started to interrogate many of the potential links identified in the Grant et al. review [@doi:10.3390/nu12040988] between vitamin D and COVID-19 in terms of its prophylactic and therapeutic value. 
A study in Switzerland demonstrated that 27 SARS-CoV-2 positive patients exhibited 25-hydroxyvitamin D plasma concentrations that were significantly lower (11.1 ng/ml) than that of SARS-CoV-2 negative patients (24.6 ng/ml; p = 0.004), which was also confirmed when stratifying for patients greater than 70 years old [@doi:10.3390/nu12051359]. 
These findings seem to be supported by another observational study of 186 SARS-CoV-2 positive patients exhibiting symptoms of pneumonia in Belgium, whereby 25-hydroxyvitamin D plasma concentrations were measured and a CT scan of the lungs was obtained upon hospitalisation [@doi:10.1101/2020.05.01.20079376]. 
A significant difference of 25-hydroxyvitamin D levels was observed between the SARS-CoV-2 patients and 2,717 season-matched diseased controls.
...
Evidence of sexual dimorphism was reported as female patients had equivalent levels of 23-hydroxyvitamin D to the control group, whereas male patients were particularly deficient in 25-hydroxyvitamin D versus the controls (67% versus 49%; p = 0.0006). 
...
One trial is currently investigating the utility of vitamin D as an immune modulating agent by monitoring  if there is an improvement of health status in non-severe symptomatic patients infected with COVID-19 as well as determining if vitamin D prevents patient deterioration [@url: https://clinicaltrials.gov/ct2/show/NCT04334005].

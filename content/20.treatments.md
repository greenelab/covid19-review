...
One of the limitations of the study was that the cohort mostly consisted of patients with mild/moderate disease symptoms, and the average patient in the analysis was 46.
This may not be representative of COVID-19 patients broadly because older age groups are known to be at higher risk.
...
In this trial, the samples used to test for presence of the SARS-CoV-2 virus were collected from the upper respiratory tract, and the authors indicated that the use of upper respiratory samples may have introduced false negatives; thus, biomarkers for the disease are needed. 
Future studies to unravel serum, urinary, and bronchoalveolar lavage (BAL) markers for the disease would be valuable.

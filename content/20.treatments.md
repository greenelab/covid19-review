...
Given the rapid predicted spread of COVID-19, the development of therapeutics will be critical to mitigating its effect on health and the mortality rate.
We differentiate between therapeutics --- which are meant to treat an already existing disease --- and prophylactics --- which are meant to prevent a disease from occurring.
...
Unlike a DNA virus, which can use the host enzymes to propagate itself, RNA viruses depends on their own polymerase, the RNA-dependent RNA polymerase (RdRP), to replicate [@doi:10.1007/978-1-4939-2438-7; @doi:10.1002/jmv.25761].

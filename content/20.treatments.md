...
A randomized, open label, non-placebo, trial of 150 COVID-19 patients was conducted parallelly in 16 government designated COVID-19 centers in China to study safety and efficacy of HCQ[@doi.org/10.1101/2020.04.10.20060558].
The trial studied efficacy of HCQ in conjunction with standard of care (SOC) vs only SOC in 150 infected patients assigned randomly to two respective groups (75 each group). 
Most of the SARS-CoV-2 cases (98%) in this cohort were mild to moderate with average age of patients being 46 years.
The primary end point of the study was the negative conversion rate of SARS-CoV-2 in 28 days and the investigators found no difference in this parameter between the groups. 
The secondary end points were amelioration of the symptoms of the disease such as axillary temperature ≤36.6°C,SpO2 >94% on room air,and disappearance of symptoms like shortnes of breath, cough, sore throat.
The median time of symptoms alleviation in both cases was similar (19 days in HCQ+SOC vs 21 days in SOC). 
However, an interesting aspect of the analyses by the investigators showed that, HCQ was efficacious in alleviation of symptoms in patients receiving no antiviral treatment in post hoc analysis. 
Additionally, there was an increase in lymphocytes in SOC+HCQ group as opposed to only SOC group at a borderline p value (p=0.57). Following this, the authors hypothesized that addition of HCQ to the current SOC could decrease inflammatory response and subsequently prevent multiorgan failure and death. 
Additionally, one of the key results of this trial was that the 30% of the patients that received SOC+ HCQ had adverse outcomes as opposed to 8.8% in only SOC. The most adverse outcomes being diarrhea in SOC+HCQ group(10%). 
The study has few limitations. One of the limitations of the study was that the cohort mostly consisted of patients with mild/moderate disease symptoms with an average age group 46 and did not include aged group known to be at high risk category of the disease. 
Although, authors claimed that HCQ could have beneficial effect hindering disease progression, multiorgan failure and death in COVID-19, that is yet to be tested for severe cases.
Indeed, larger population needs to be tested to validate the increase of lymphocytes in SOC+HCQ as although, the result was promising, it lacked statistical significance.  Additionally, SOC used in this study included the use of antivirals (Lopinavir-Ritonavir, Arbidol, Oseltamivir, Virazole, Entecavir, Ganciclovir and/or Interferon-alpha) which could provide confounding effects. Thus, to better understand the drug effects of HCQ, a better study design needs to be outlined, where SOC should not involve the use of anti-virals. 
In this trial, the samples collected from the upper respiratory tract introduced false negatives and thus finding biomarker for the disease is incumbent. Future studies to unravel serum/ urinary/ Bronchoalveolar lavage (BAL) markers for the disease is  warranted.
Another limitation of the study was that the HCQ treatment was provided at 16 day delay from the symptom onset.  A quicker treatment regimen with HCQ needs to be investigated for early disease management. Overall, the study holds promising data albeit needs validation in independent population cohort. Also from safety point of view, the adverse effect in manageable.
##### Summary

...
It was recently discussed (@doi:10.1093/jac/dkaa114) that since EC90 of CQ in Vero E6 cells (6.90 μM) could be reached and well endured in rheumatoid arthritis patients, it could be as well be administered to COVID-19 patients.
Additionally, it was proven to be effective against HIV (@doi:10.1016/0149-2918(95)80039-5) and chronic Hepatitis C infection (@doi:10.1002/jmv.24575).
Therefore, initially it was thought that it would be effective towards SARS-COV-2.
Further, HCQ was hypothesized to be safer as compared to CQ based on three reasons as depicted in the literature (@doi:10.1093/jac/dkaa114). The hypotheses were : HCQ could alleviate the development of COVID-19 through mitigation of CD154 in T cells;  HCQ could supposedly have same  effect as an antiviral like CQ pre and post infection and lastly it is cheaper and have less side effects as opposed CQ. 
HCQ is safer to pregnant women with autoimmune disease. 
This could possibly be the reason behind HCQ being predominantly used in clinical trial as opposed to CQ.
Furthermore, a separate study(@doi:10.1101/2020.04.08.20054551) investigated the safety associated with the use of this drug in SARS-COVID-19. 
The study involved 900,000 cases with HCQ and 300,000 cases with HCQ+AZ. 
The results showed that short term use of the drug was associated with no risk while the long-term use was associated with 65% increase in cardiovascular morbidity. 
Also, HCQ+AZ was associated with an enhanced risk of cardiovascular complications (15-20% increased risk of chest pain) and two-fold increased risk of mortality.
Multiple clinical studies have already been carried out to assess this possibility of HCQ to be a therapeutic agent for COID-19.
...
Further investigation of HCQ in large, rigorous, multi-center clinical trials encompassing different sex, age is required.

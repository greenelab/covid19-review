...
RNA vaccines are nucleic-acid based modalities that code for viral antigens against which our body elicits a humoral and cellular immune response. 
The mRNA technology is transcribed in vitro and delivered to cells via lipid nanoparticles (LNP). 
They are recognized by ribosomes in vivo and then translated and modified into functional proteins [@https://doi.org/10.3389/fimmu.2019.00594]. 
The resulting intracellular viral proteins are displayed on surface MHC I proteins, provoking a strong CD8+ T cell response as well as a CD4+ T cell and B cell-associated antibody responses [@doi: 10.3389/fimmu.2019.00594]. 
...
Furthermore, purifying out dsRNA and immature RNA with FPLC (fast performance liquid chromatography) and HPLC (high performance liquid chromatography) technology will improve translation of the mRNA in the cell [@https://doi.org/10.3389/fimmu.2019.00594; @https://doi.org/10.1080/14760584.2017.1355245].


mRNA vaccines confer many advantages over traditional viral vectored vaccines and DNA vaccines. 
In comparison to live attenuated viruses, mRNA vaccines are non-infectious and can be synthetically produced in an egg-free, cell-free environment, and thereby reduce the risk of a detrimental immune response in the host[@doi: 10.1016/j.immuni.2020.03.007]. 
Unlike DNA vaccines, mRNA technologies are naturally degradable, non-integrating, and do not need to cross the nuclear membrane in addition to the plasma membrane to see their effects [@https://doi.org/10.3389/fimmu.2019.00594].  
Furthermore, mRNA viruses are easily, affordably, and rapidly scalable

mRNA vaccines have been developed for therapeutic and prophylactic purposes. 
mRNA vaccines have not been licensed or commercialized, however, several agents for cancer and infectious diseases, including rabies, coronavirus, influenza, rabies, and CMV, have shown promising immunization in animal models and are currently in clinical trials [@url: https://clinicaltrials.gov/ct2/show/NCT01669096?term=mRNA+vaccine&draw=7]. 
Preclinical data from Pardi et al. identified effective antibody generation against full length FPLC-purified influenza hemagglutinin stalk-encoding mRNA in mice, rabbits, and ferrets [@doi: https://doi.org/10.1038/s41467-018-05482-0]. 
Similar immunological responses for mRNA vaccines were observed in humans in Curevac and Moderna operated Phase I and II clinical trials for rabies, flu, and zika [@https://doi.org/10.1080/14760584.2017.1355245]. 
...
LNPs can be coated with modalities recognized and engulfed by specific celltypes. 
LNPs 150nm or less effectively enter into lymphatic vessels. 

There are three types of RNA vaccines: non-replicating, in vivo self-replicating, and in vitro dendritic cell non-replicating [@url: https://www.phgfoundation.org/briefing/rna-vaccines].  
...
In vivo self-replicating vaccines encode a modified viral genome derived from single-stranded, positive sense RNA alphaviruses [@https://doi.org/10.3389/fimmu.2019.00594; @https://doi.org/10.1080/14760584.2017.1355245]. 
The RNA genome encodes the viral antigen along with proteins of the genome replication machinery, including an RNA polymerase. Structural proteins required for viral assembly are not included in the engineered genome [@https://doi.org/10.3389/fimmu.2019.00594]. 
...
Dendritic cells are potent antigen presenting immune cells that easily take up mRNA and present it to other cells, including B-cells which generate antibodies against the protein. 
These cells are isolated from the patient, grown and transfected ex vivo, and re-introduced to the patient [@url:https://doi.org/10.1038/nrd.2017.243].

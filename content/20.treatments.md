...
For the general public in particular, whether nutraceuticals can provide any prophylactic or therapeutic benefit has been a topic of interest.
...
Indeed, serum concentrations of less above 30 ng/ml seem to be associated with a reduction in serum C-reative protein (CRP), an inflammatory marker, along with increased lymphocyte levels, which suggests that vitamin D levels may modulate the immune response by reducing risk for cytokine storm in response to SARS-CoV-2 infection. 
...
However, this study did not standardize for late winter when the COVID-19 outbreak began in the UK [@doi:10.1111/cen.14276].
...
Whether or not vitamin D status is linked to COVID-19 outcomes, even spuriously, thus remains open for debate.
...
As of April 8, 2020, there were already 115 vaccine candidates against prevent SARS-CoV-2, of which 78 were under active development.

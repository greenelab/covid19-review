...
Conversely, zinc deficiency is associated with increased susceptibility to infection in the elderly, which can be prevented when zinc supplements are administered [@doi:10.1093/ajcn/85.3.837].
...
Despite the fact that it is well documented that regular vitamin C supplementation can reduce the duration of the common cold, vitamin C (> 200 mg) fails to reduce the incidence of the common cold [@doi:10.1002/14651858.CD000980.pub4].
...
Certainly, supplementation and maintaining a healthy diet for optimum vitamin D status warrants further investigation. 

...
Nevertheless, a randomized placebo-controlled trial registered with clincialtrials.gov (Identifier:NCT04264533), has begun in Wuhan China to investigate the intravenous infusion of vitamin C to treat pneumonia in 140 severe COVID-19 infected patients. 
As summarized by Carr [@doi:10.1186/s13054-020-02851-4] the trial will not be completed until September 2020.
Another trial in Italy registered with clincialtrials.gov (Identifier: NCT04323514) intends to deliver a 10 g infusion of vitamin C to 500 severe COVID-19 patients with pneumonia to assess in-hospital mortality over a 72 hr period as the primary outcome. 
The trial is currently recruiting and is due to run until March 2021.
Unfortunately, it will not be known how effective vitamin C is as a thereapeutic for quite some time due to the length of both trials.
However, the trials will provide crucial evidence on the efficacy of vitamin C as a therapeutic for COVID-19 infection. 
...
This is yet to be determined for COVID-19 infections. 
The ongoing trials in China and Italy along with with other potential trials intended in the United States and beyond will provide crucial inforamtion on the therapeutic value of vitamin C supplementation for COVID-19 infections.  

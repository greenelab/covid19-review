...
It also inhibits SARS-CoV-2, showing synergy with chloroquine in vitro [@doi:10.1038/s41422-020-0282-0].
...
Indeed, the New England Medical Journal published a Gilead Sciences sponsored trial that administered 200mg of Remdesivir intravenously on day 1 followed by a further 100mg/day for 9 days on compassionate-use basis to 61 patients hospitalized with confirmed COVID-19 [@doi:10.1056/NEJMoa2007016].
Following treatment, data from 53 patients were analyzed and a clinical improvement was observed in 68% (36/53) of patients.
While that result might seem promising, there were significant issues with the study design that undermine the seemingly positive outcome.
These included the fact that the trial did not include a randomized control group, some patients only required low doses of oxygen, others required ventilation, patients analyzed had mixed demographics as it was a multisite trial, there was a short follow-up period of investigation, some patients worsened, some patients died, and lastly 8 patients were excluded from the analysis mainly due to missing post-baseline information, thus their health is unaccounted for.
As a result of these confounding issues, it is difficult to determine if there was any treatment effect or would these outcomes have occurred regardess of treatment.
Therefore, no conclusive deductions can be made at this time until  randomised controlled trials are completed.

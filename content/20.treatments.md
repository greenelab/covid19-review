...
It was first synthesized in the late 1950s as an anti-inflammatory and has been used to treat rheumatoid arthritis and other inflammatory conditions.
Steroids such as dexamethasone are widely available and affordable, and a clinical trial that began in 2012 found dexamethasone to improve outcomes for patients with ARDS [@doi:10/ggpxzc].
Dexamethasone works as an anti-inflammatory by binding to glucocorticoid receptors with higher affinity than glucocorticoid itself.
...
Due to communication between the immune system and the central nervous system, macrophages can respond to and produce catecholamines [@doi:10.1016/j.cyto.2015.01.008].
...
Dexamethasone was evaluated as part of the multi-site RECOVERY trial in the United Kingdom [@doi:10.1101/2020.06.22.20137273].
Over 6000 hospitalized COVID-19 patients were assigned into standard care or treatment (dexamethasone) arms of the trial following a 2:1 ratio.
...
The primary end-point was outcome at 28-days post-randomization (mortality, discharge, or continued hospitalization), and secondary outcomes analyzed included the progression to invasive mechanical ventilation over the same period.
...
However, this finding was driven by differences in mortality among patients who were ventilated or on supplementary oxygen at the start of the study.
...
Although one possible confounder is that patients receiving mechanical ventilation tended to be younger than patients who were not receiving respiratory support (by 10 years on average) and to have had symptoms for a longer period.
...
Thus, this large, randomized, although not placebo-controlled study suggests that administration of dexamethasone to patients who are unable to breathe independently may significantly improve survival outcomes.
...
However, there was initially some concern about using dexamethasone to treat COVID-19 because of side effects that include the exacerbation of diabetes and sepsis [@doi:10/ggpxzc].

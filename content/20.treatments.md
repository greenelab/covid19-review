...
]({{images/N002-Vaccines.png}} "Summary of vaccine development strategies"){#fig:vaccines secno=1}
...
]({{images/N001-LifeCyclePlusDrugs.png}} "Potential COVID-19 therapeutics"){#fig:therapeutics secno=1}

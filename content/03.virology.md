...
Early sequencing of the virus causing COVID-19 provided early insights into its phylogenetic position and genomic structure.
As discussed above, the virus clusters with known coronaviruses (order *Nidovirales*, family *Coronaviridae*, subfamily *Orthocoronavirinae*) infecting humans and animals.
Because many SARS-CoV-2 virus and the mechanisms that allow it to enter cells and replicate can provide useful information for predicting pathogenesis and transmission.
